...
public class fzg extends fzf {
   ...
   private void a(fxb $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$1, $$2, $$3 - d($$4), c($$4));
   }

   private void a(fxb $$0, int $$1, int $$2, int $$3, String $$4) {
      this.a($$0, $$4, $$1 + 1, $$3 + 1);
      $$0.a($$1, $$1 + $$2 - 1, $$3, -1);
   }
   ...
   private static String c(double $$0) {
      if ($$0 >= 1048576.0) {
         ...
         return $$0 >= 1024.0 ? String.format(Locale.ROOT, "%.1f KiB/s", $$0 / 1024.0) : String.format(Locale.ROOT, "%d B/s", bcb.a($$0));
      }
   }
   ...
   protected int a(long $$0) {
      return this.a(e($$0), 0.0, -16711681, 8192.0, -6250241, 1.048576E7, -65536);
   }
