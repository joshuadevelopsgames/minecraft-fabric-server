...
public class gfb {
   private static final ame a = ame.b("advancements/title_box");
   ...
   private final ak r;
   private final av s;
   private final List<bbm> t;
   private final int u;
   private final List<bbm> v;
   private final fue w;
   @Nullable
   private gfb x;
   private final List<gfb> y = Lists.newArrayList();
   @Nullable
   private al z;
   private final int A;
   private final int B;

   public gfb(gez $$0, fue $$1, ak $$2, av $$3) {
      this.q = $$0;
      this.r = $$2;
      this.s = $$3;
      this.w = $$1;
      this.t = $$1.h.c($$3.a(), 163);
      this.A = bcb.d($$3.f() * 28.0F);
      this.B = bcb.d($$3.g() * 27.0F);
      int $$4 = Math.max(this.t.stream().mapToInt($$1.h::a).max().orElse(0), 80);
      int $$5 = this.e();
      int $$6 = 29 + $$4 + $$5;
      this.v = ud.a().a(this.a(xr.a($$3.b().f(), yl.a.a($$3.e().a())), $$6));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         xo $$2 = xo.a("advancements.progress", $$0, $$0);
         return this.w.h.a($$2) + 8;
      }
   }

   private static float a(fuo $$0, List<xt> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<xt> a(xo $$0, int $$1) {
      fuo $$2 = this.w.h.b();
      List<xt> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : p) {
         List<xt> $$6 = $$2.b($$0, $$1 - $$5, yl.a);
         float $$7 = Math.abs(a($$2, $$6) - $$1);
         if ($$7 <= 10.0F) {
            return $$6;
         }
   ...
   public void a(fxb $$0, int $$1, int $$2) {
      if (!this.s.j() || this.z != null && this.z.a()) {
         ...
         $$0.a(gxx.ar, $$4.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
   ...
   public void a(fxb $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      fwz $$6 = this.w.h;
      ...
      int $$11 = 6 + $$10;
      boolean $$12 = $$4 + $$1 + this.A + this.u + 26 >= this.q.f().o;
      xo $$13 = this.z == null ? null : this.z.d();
      int $$14 = $$13 == null ? 0 : $$6.a($$13);
      boolean $$15 = $$9 + $$11 >= 113;
      float $$16 = this.z == null ? 0.0F : this.z.c();
      int $$17 = bcb.d($$16 * this.u);
      gfc $$18;
      gfc $$19;
      gfc $$20;
      if ($$16 >= 1.0F) {
      ...
      if (!this.v.isEmpty()) {
         if ($$15) {
            $$0.a(gxx.ar, a, $$31, $$9 - $$33, this.u, $$33);
         } else {
            $$0.a(gxx.ar, a, $$31, $$8, this.u, $$33);
         }
      }

      if ($$18 != $$19) {
         $$0.a(gxx.ar, $$18.a(), 200, $$7, 0, 0, $$31, $$8, $$17, $$7);
         $$0.a(gxx.ar, $$19.a(), 200, $$7, 200 - $$30, 0, $$31 + $$17, $$8, $$30, $$7);
      } else {
         $$0.a(gxx.ar, $$18.a(), $$31, $$8, this.u, $$7);
      }

      $$0.a(gxx.ar, $$20.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
      int $$34 = $$31 + 5;
      if ($$12) {
   ...
   private void a(fxb $$0, List<bbm> $$1, int $$2, int $$3, int $$4) {
      fwz $$5 = this.w.h;
