...
public interface bda {
   ...
   static <E extends Enum<E> & bda> bda.a<E> a(Supplier<E[]> $$0) {
      return a($$0, $$0x -> $$0x);
   }

   static <E extends Enum<E> & bda> bda.a<E> a(Supplier<E[]> $$0, Function<String, String> $$1) {
      E[] $$2 = (E[])$$0.get();
      Function<String, E> $$3 = a($$2, $$1);
      return new bda.a<>($$2, $$3);
   }

   static <T extends bda> Codec<T> b(Supplier<T[]> $$0) {
      T[] $$1 = (T[])$$0.get();
      Function<String, T> $$2 = a($$1, $$0x -> $$0x);
      ToIntFunction<T> $$3 = ag.g(Arrays.asList($$1));
      return new bda.b<>($$1, $$2, $$3);
   }

   static <T extends bda> Function<String, T> a(T[] $$0, Function<String, String> $$1) {
      if ($$0.length > 16) {
         Map<String, T> $$2 = Arrays.<bda>stream($$0).collect(Collectors.toMap($$1x -> $$1.apply($$1x.c()), $$0x -> (T)$$0x));
   ...
   static Keyable a(final bda[] $$0) {
      return new Keyable() {
         public <T> Stream<T> keys(DynamicOps<T> $$0x) {
            return Arrays.stream($$0).map(bda::c).map($$0::createString);
         }
      };
   }

   public static class a<E extends Enum<E> & bda> extends bda.b<E> {
   ...
   public static class b<S extends bda> implements Codec<S> {
      private final Codec<S> a;

      public b(S[] $$0, Function<String, S> $$1, ToIntFunction<S> $$2) {
         this.a = bbi.a(Codec.stringResolver(bda::c, $$1), bbi.a($$2, $$1x -> $$1x >= 0 && $$1x < $$0.length ? $$0[$$1x] : null, -1));
      }
