...
public class bua implements bub {
   ...
   private static final bua k = new bua();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(btz $$0) {
      URL $$1 = bua.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, btz $$1) {
      if (this.c()) {
         ...
         try {
            ...
            this.l = ag.a(new Recording($$2), $$2x -> {
               h.forEach($$2x::enable);
               $$2x.setDumpOnExit(true);
               $$2x.setToDisk(true);
               $$2x.setName(String.format(Locale.ROOT, "%s-%s-%s", $$1.a(), ac.b().c(), $$3));
            });
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bud a = new bud(() -> bua.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bua.this.l && $$0.getState() == RecordingState.STOPPED) {
