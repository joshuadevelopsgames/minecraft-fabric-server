...
public class fna {
   ...
   public static final fna.a bv;

   public static fna.a a(int $$0, int $$1) {
      return $$0 == -1 ? fna.b.b.a($$1) : fna.b.a.a($$0);
   }

   public static fna.a a(String $$0) {
      if (fna.a.e.containsKey($$0)) {
         return fna.a.e.get($$0);
      } else {
         for (fna.b $$1 : fna.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fna.b b;
      private final int c;
      private final bbv<xo> d;
      static final Map<String, fna.a> e = Maps.newHashMap();

      a(String $$0, fna.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new bbv<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xo.b($$2.toUpperCase(Locale.ROOT)) : xo.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xo.b($$2) : xo.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ud.a().b($$1) ? xo.c($$1) : xo.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fna.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xo> g;

      private static void a(fna.b $$0, String $$1, int $$2) {
         fna.a $$3 = new fna.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xo> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fna.a a(int $$0) {
         return (fna.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
