...
public class bkm extends DataFix {
   public bkm(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   protected TypeRewriteRule makeRule() {
      CompoundListType<String, ?> $$0 = DSL.compoundList(DSL.string(), this.getInputSchema().getType(blp.J));
   ...
   private <SF> TypeRewriteRule a(CompoundListType<String, SF> $$0) {
      ...
      Type<?> $$2 = this.getInputSchema().getType(blp.J);
      ...
      return TypeRewriteRule.seq(
                     ...
                     .update(
                        ...
                        $$0xxxx -> $$0xxxx.update(
                           ...
                           $$0xxxxx -> {
                              ...
                              return ((Dynamic)DataFixUtils.orElse($$1xxxx.map($$1xxxxx -> $$0xxxxx.remove("New_Village").set("Village", $$1xxxxx)), $$0xxxxx))
                                 .remove("Village");
                           }
                        )
                     )
         ...
         this.fixTypeEverywhereTyped(
            ...
            $$0x -> $$0x.update(
               DSL.remainderFinder(),
               $$0xx -> $$0xx.update(
                  "id", $$0xxx -> Objects.equals(bnm.a($$0xxx.asString("")), "minecraft:new_village") ? $$0xxx.createString("minecraft:village") : $$0xxx
               )
            )
         )
      );
