...
public class dtl extends dou {
   public static final MapCodec<dtl> c = b(dtl::new);
   ...
   public void a(eeb $$0, dmu $$1, jb $$2, bck $$3) {
      if ($$0.c(b)) {
         ...
         double $$6 = $$2.w() + 0.5;
         if ($$3.j() < 0.1) {
            $$1.a($$4, $$5, $$6, ayz.kL, aza.e, 1.0F, 1.0F, false);
         }
         ...
         $$1.a(me.F, $$4 + $$11, $$5 + $$12, $$6 + $$13, 0.0, 0.0, 0.0);
      }
   }
}
