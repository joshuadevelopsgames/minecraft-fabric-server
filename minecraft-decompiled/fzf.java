public abstract class fzf {
   ...
   protected final fwz d;
   protected final bry e;

   protected fzf(fwz $$0, bry $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public void a(fxb $$0, int $$1, int $$2) {
      ...
      if ($$8 > 0) {
         ...
         String $$14 = this.a((double)$$4 / $$8) + " avg";
         String $$15 = this.a((double)$$6) + " max";
         $$0.b(this.d, $$13, $$1 + 2, $$3 - 60 - 9, -2039584);
         $$0.a(this.d, $$14, $$1 + $$2 / 2, $$3 - 60 - 9, -2039584);
         $$0.b(this.d, $$15, $$1 + $$2 - this.d.b($$15) - 2, $$3 - 60 - 9, -2039584);
      }
   ...
   protected void b(fxb $$0, int $$1, int $$2, int $$3) {
      long $$4 = this.e.a($$3);
   ...
   protected void c(fxb $$0, int $$1, int $$2, int $$3) {
   }
   ...
   protected void d(fxb $$0, int $$1, int $$2, int $$3) {
   }

   protected void a(fxb $$0, String $$1, int $$2, int $$3) {
      $$0.a($$2, $$3, $$2 + this.d.b($$1) + 1, $$3 + 9, -1873784752);
      $$0.a(this.d, $$1, $$2 + 1, $$3 + 1, -2039584, false);
   }
   ...
   protected int a(double $$0, double $$1, int $$2, double $$3, int $$4, double $$5, int $$6) {
      $$0 = bcb.a($$0, $$1, $$5);
      return $$0 < $$3 ? baj.a((float)(($$0 - $$1) / ($$3 - $$1)), $$2, $$4) : baj.a((float)(($$0 - $$3) / ($$5 - $$3)), $$4, $$6);
   }
}
