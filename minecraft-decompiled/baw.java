...
public class baw<K> implements jq<K> {
   ...
   private baw(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> baw<A> c(int $$0) {
      return new baw((int)($$0 / 0.8F));
   }
   ...
   private int e(@Nullable K $$0) {
      return (bcb.h(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public baw<K> b() {
      return new baw<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
