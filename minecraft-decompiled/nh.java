...
public class nh implements mt {
   private final mv d;
   private final CompletableFuture<jn.a> e;

   public nh(mv $$0, CompletableFuture<jn.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public CompletableFuture<?> a(mr $$0) {
      Path $$1 = this.d.a(mv.b.c).resolve("blocks.json");
      return this.e
         .thenCompose(
            $$2 -> {
               ...
               $$2.e(mn.i)
                  ...
                  .forEach(
                     $$2x -> {
                        ...
                        $$3x.add("states", $$9);
                        String $$14 = $$2x.g();
                        JsonElement $$15 = (JsonElement)dqa.a
                           .codec()
                           .encodeStart($$4, (dpz)$$2x.a())
