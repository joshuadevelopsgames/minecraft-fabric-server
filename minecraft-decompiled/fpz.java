...
public class fpz extends fqq {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fue.R().an();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fsq.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fue.R().b($$4)) {
               try {
