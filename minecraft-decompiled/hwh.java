...
public class hwh {
   ...
   public static class a extends Thread {
      private final hwh.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hwh.b $$0) throws IOException {
         super("LanServerDetector #" + hwh.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new s(hwh.b));
   ...
   public static class b {
      private final List<hwg> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hwg> a() {
         if (this.b) {
            List<hwg> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
