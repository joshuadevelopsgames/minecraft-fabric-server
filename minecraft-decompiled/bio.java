...
public class bio extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(blp.M));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(blp.t, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(blp.t, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(blp.t, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(blp.t, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(blp.t, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(blp.t, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(blp.t);
      Type<?> $$9 = this.getOutputSchema().getType(blp.t);
