...
public class cu extends dl<cu.a> {
   ...
   public void a(auc $$0, cal $$1, List<bzm> $$2) {
      List<fdj> $$3 = $$2.stream().map($$1x -> bz.b($$0, $$1x)).collect(Collectors.toList());
      fdj $$4 = bz.b($$0, $$1);
      this.a($$0, $$2x -> $$2x.a($$4, $$3));
   }

   public record a(Optional<bj> b, Optional<bj> c, Optional<bj> d) implements dl.a {
      ...
      public static ar<cu.a> a(Optional<bz> $$0, Optional<bz> $$1) {
         return aq.W.a(new cu.a(Optional.empty(), bz.a($$0), bz.a($$1)));
      }

      public boolean a(fdj $$0, List<fdj> $$1) {
