...
public class bgf extends DataFix {
   ...
   public bgf(Schema $$0, String $$1, String $$2, UnaryOperator<String> $$3) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(this.a, this.getInputSchema().getType(blp.q), $$0 -> $$0.update(DSL.remainderFinder(), this::a));
   }
