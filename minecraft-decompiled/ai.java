...
public record ai(Optional<ame> c, Optional<av> d, an e, Map<String, ar<?>> f, am g, boolean h, Optional<xo> i) {
   ...
   public static final Codec<ai> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
               ame.a.optionalFieldOf("parent").forGetter(ai::b),
      ...
      .validate(ai::a);
   public static final zm<wx, ai> b = zm.a(ai::a, ai::b);

   public ai(Optional<ame> $$0, Optional<av> $$1, an $$2, Map<String, ar<?>> $$3, am $$4, boolean $$5) {
   ...
   private static xo a(av $$0) {
      xo $$1 = $$0.a();
      o $$2 = $$0.e().a();
      xo $$3 = xr.a($$1.f(), yl.a.a($$2)).f("\n").b($$0.b());
      xo $$4 = $$1.f().a($$1x -> $$1x.a(new xu.e($$3)));
      return xr.a($$4).a($$2);
   }

   public static xo a(aj $$0) {
      return $$0.b().h().orElseGet(() -> xo.b($$0.a().toString()));
   }

   private void a(wx $$0) {
      $$0.a(this.c, wg::a);
      av.b.a(zk::a).encode($$0, this.d);
      this.g.a($$0);
      $$0.a(this.h);
   }

   private static ai b(wx $$0) {
      return new ai($$0.b(wg::q), (Optional<av>)av.b.a(zk::a).decode($$0), an.b, Map.of(), new am($$0), $$0.readBoolean());
   }
   ...
   public void a(bci $$0, jm.a $$1) {
      this.f.forEach(($$2, $$3) -> {
         bk $$4 = new bk($$0.a(new bci.i($$2)), $$1);
         $$3.b().a($$4);
      });
   }
   ...
   public static class a {
      private Optional<ame> a = Optional.empty();
      ...
      public ai.a a(dcv $$0, xo $$1, xo $$2, @Nullable ame $$3, ap $$4, boolean $$5, boolean $$6, boolean $$7) {
         return this.a(new av($$0, $$1, $$2, Optional.ofNullable($$3).map(jc::new), $$4, $$5, $$6, $$7));
      }

      public ai.a a(dmt $$0, xo $$1, xo $$2, @Nullable ame $$3, ap $$4, boolean $$5, boolean $$6, boolean $$7) {
         return this.a(new av(new dcv($$0.h()), $$1, $$2, Optional.ofNullable($$3).map(jc::new), $$4, $$5, $$6, $$7));
      }
