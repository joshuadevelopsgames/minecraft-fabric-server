...
public class bft extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkHeightAndBiomeFix", $$0, $$4, $$4x -> $$4x.updateTyped($$1, $$5, $$3xx -> {
         ...
         MutableObject<Supplier<bfw.a>> $$14 = new MutableObject((Supplier<bfw.a>)() -> null);
         ...
         return $$3xx.update(DSL.remainderFinder(), $$5xx -> {
            ...
            return a($$5xx, $$8, $$9.booleanValue(), "minecraft:noise".equals($$7), (Supplier<bfw.a>)$$14.getValue());
         });
      }));
   }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0, boolean $$1, boolean $$2, boolean $$3, Supplier<bfw.a> $$4) {
      $$0 = $$0.remove("Biomes");
      if (!$$1) {
         return a($$0, 16, 0);
      } else if ($$2) {
   ...
   public static int a(int $$0) {
      return $$0 == 0 ? 0 : (int)Math.ceil(Math.log($$0) / Math.log(2.0));
   }
