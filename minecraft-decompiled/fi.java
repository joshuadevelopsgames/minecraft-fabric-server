...
public class fi implements ArgumentType<fi.a> {
   ...
   public static fi.a a(CommandContext<ek> $$0, String $$1) {
   ...
   private static fi.a a(String $$0) throws CommandSyntaxException {
      return (fi.a)($$0.equals("><") ? ($$0x, $$1) -> {
         int $$2 = $$0x.a();
         $$0x.a($$1.a());
         $$1.a($$2);
      } : b($$0));
   ...
   private static fi.b b(String $$0) throws CommandSyntaxException {
      return switch ($$0) {
         case "=" -> ($$0x, $$1) -> $$1;
         case "+=" -> Integer::sum;
         case "-=" -> ($$0x, $$1) -> $$0x - $$1;
   ...
   @FunctionalInterface
   public interface a {
      void apply(fjv var1, fjv var2) throws CommandSyntaxException;
   }

   @FunctionalInterface
   interface b extends fi.a {
      int apply(int var1, int var2) throws CommandSyntaxException;

      @Override
      default void apply(fjv $$0, fjv $$1) throws CommandSyntaxException {
