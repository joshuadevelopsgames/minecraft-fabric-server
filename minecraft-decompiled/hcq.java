...
public class hcq implements hbz.a {
   private final List<jb> a = Lists.newArrayList();
   ...
   public void a(jb $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      this.a.add($$0);
      this.b.add($$1);
      this.c.add($$5);
      this.d.add($$2);
