...
public final class fnf implements AutoCloseable {
   ...
   public fnf(int $$0, int $$1, boolean $$2) {
      this(fnf.a.a, $$0, $$1, $$2);
   }

   public fnf(fnf.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public fnf(fnf.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static fnf a(InputStream $$0) throws IOException {
      return a(fnf.a.a, $$0);
   }

   public static fnf a(@Nullable fnf.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static fnf a(ByteBuffer $$0) throws IOException {
      return a(fnf.a.a, $$0);
   }

   public static fnf a(byte[] $$0) throws IOException {
   ...
   private static fnf a(ByteBuffer $$0, byte[] $$1) throws IOException {
      $$0.put($$1);
      $$0.rewind();
      return a($$0);
   }

   public static fnf a(@Nullable fnf.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.t()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new fnf($$0 == null ? fnf.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
         } catch (Throwable var11) {
            if ($$2 != null) {
               try {
                  $$2.close();
   ...
   private int d(int $$0, int $$1) {
      if (this.d != fnf.a.a) {
         ...
         this.i();
         long $$2 = ($$0 + (long)$$1 * this.e) * 4L;
         return MemoryUtil.memGetInt(this.h + $$2);
      }
   }

   public int a(int $$0, int $$1) {
      return baj.n(this.d($$0, $$1));
   }
   ...
   public fnf a(IntUnaryOperator $$0) {
      if (this.d != fnf.a.a) {
         ...
         this.i();
         fnf $$1 = new fnf(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public byte b(int $$0, int $$1) {
      if (!this.d.o()) {
         ...
         return MemoryUtil.memGetByte(this.h + $$2);
      }
   }
   ...
   public boolean a(FT_Face $$0, int $$1) {
      if (this.d.a() != 1) {
      ...
      } else if (gay.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
         ...
         if ($$3.pixel_mode() != 2) {
            ...
            MemoryUtil.memCopy(MemoryUtil.memAddress($$5), this.h, $$4);
            return true;
         } else {
      ...
      if ($$0.c() != this.d) {
         ...
         if (this.e == $$0.e) {
            ...
            for (int $$4 = 0; $$4 < $$3; $$4++) {
               int $$5 = $$4 * $$0.a() * $$1;
               int $$6 = $$4 * this.a() * $$1;
               MemoryUtil.memCopy($$0.h + $$5, this.h + $$6, $$2);
            }
         }
      }
   }
   ...
   public void a(fnf $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, fnf $$4) {
      this.i();
      if ($$4.c() != this.d) {
         throw new UnsupportedOperationException("resizeSubRectTo only works for images of the same format.");
      } else {
         int $$5 = this.d.a();
         STBImageResize.nstbir_resize_uint8(this.h + ($$0 + $$1 * this.a()) * $$5, $$2, $$3, this.a() * $$5, $$4.h, $$4.a(), $$4.b(), 0, $$5);
      }
   }
