...
public class bjv extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.a(this.getInputSchema().getTypeRaw(blp.A), $$0);
   }
   ...
   private <C, H extends Pair<String, ?>> TypeRewriteRule a(Type<C> $$0, Type<H> $$1) {
      ...
      if (!$$2.equals(this.getInputSchema().getType(blp.A))) {
         throw new IllegalStateException("Text component type did not match, expected " + $$2 + " but got " + this.getInputSchema().getType(blp.A));
      } else {
   ...
   private static <H> H b(Type<H> $$0, Dynamic<?> $$1) {
      ...
      Dynamic<?> $$3 = new Dynamic(
         JavaOps.INSTANCE, Map.of("action", "show_text", "contents", Map.<String, String>of("text", "Legacy hoverEvent: " + bbq.e($$2)))
      );
