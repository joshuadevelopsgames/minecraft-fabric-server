...
public class bdp {
   ...
   public <T> T a(bdn<T> $$0, @Nullable T $$1) {
   ...
   public static class a {
      ...
      public <T> bdp.a a(bdn<T> $$0, T $$1) {
         this.a.put($$0, $$1);
         return this;
      }

      public <T> bdp.a b(bdn<T> $$0, @Nullable T $$1) {
         if ($$1 == null) {
            this.a.remove($$0);
         } else {
            this.a.put($$0, $$1);
      ...
      public bdp a(bdo $$0) {
         Set<bdn<?>> $$1 = Sets.difference(this.a.keySet(), $$0.b());
         if (!$$1.isEmpty()) {
            throw new IllegalArgumentException("Parameters not allowed in this parameter set: " + $$1);
         } else {
            Set<bdn<?>> $$2 = Sets.difference($$0.a(), this.a.keySet());
            if (!$$2.isEmpty()) {
