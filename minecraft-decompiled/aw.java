...
public class aw {
   ...
   public aw(ak $$0, @Nullable aw $$1, @Nullable aw $$2, int $$3, int $$4) {
      if ($$0.a().c().isEmpty()) {
   ...
   @Nullable
   private aw a(ak $$0, @Nullable aw $$1) {
      if ($$0.a().c().isPresent()) {
         $$1 = new aw($$0, this, $$1, this.e.size() + 1, this.h + 1);
         this.e.add($$1);
      } else {
         for (ak $$2 : $$0.e()) {
            $$1 = this.a($$2, $$1);
   ...
   private aw a(aw $$0, aw $$1) {
      return this.f != null && $$0.b.e.contains(this.f) ? this.f : $$1;
   }

   private void e() {
      this.a.a().c().ifPresent($$0x -> $$0x.a(this.h, this.i));
      if (!this.e.isEmpty()) {
         for (aw $$0 : this.e) {
            $$0.e();
         }
   ...
   public static void a(ak $$0) {
      if ($$0.a().c().isEmpty()) {
         throw new IllegalArgumentException("Can't position children of an invisible root!");
      } else {
         aw $$1 = new aw($$0, null, null, 1, 0);
         $$1.a();
