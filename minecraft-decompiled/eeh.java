...
public class eeh {
   ...
   private final Map<Character, Predicate<eef>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public eeh a(char $$0, Predicate<eef> $$1) {
      this.c.put($$0, $$1);
      return this;
   }
   ...
   private Predicate<eef>[][][] c() {
      this.d();
      Predicate<eef>[][][] $$0 = (Predicate<eef>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<eef>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
