...
public class hrl {
   ...
   public static CompletableFuture<ame> a(ame $$0, Path $$1, String $$2, boolean $$3) {
      return CompletableFuture.<fnf>supplyAsync(() -> {
         fnf $$3x;
         try {
            $$3x = a($$1, $$2);
   ...
   private static fnf a(Path $$0, String $$1) throws IOException {
      if (Files.isRegularFile($$0)) {
         ...
         fnf $$7;
         try {
            $$3 = (HttpURLConnection)$$4.toURL().openConnection(fue.R().aa());
            $$3.setDoInput(true);
            $$3.setDoOutput(false);
            $$3.connect();
   ...
   private static CompletableFuture<ame> a(ame $$0, fnf $$1) {
      fue $$2 = fue.R();
      return CompletableFuture.supplyAsync(() -> {
         hrf $$3 = new hrf($$0::toString, $$1);
         $$2.ab().a($$0, $$3);
         return $$0;
      }, $$2);
   }

   private static fnf a(fnf $$0, String $$1) {
      int $$2 = $$0.b();
      int $$3 = $$0.a();
      if ($$3 == 64 && ($$2 == 32 || $$2 == 64)) {
         boolean $$4 = $$2 == 32;
         if ($$4) {
            fnf $$5 = new fnf(64, 64, true);
            $$5.a($$0);
            $$0.close();
            $$0 = $$5;
            $$5.a(0, 32, 64, 32, 0);
   ...
   private static void a(fnf $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            int $$7 = $$0.a($$5, $$6);
            if (baj.a($$7) < 128) {
   ...
   private static void b(fnf $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            $$0.b($$5, $$6, baj.f($$0.a($$5, $$6)));
         }
      }
   }
}
