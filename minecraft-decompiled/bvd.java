...
public class bvd {
   ...
   protected bvd(String $$0, bvc $$1, DoubleSupplier $$2, @Nullable Runnable $$3, @Nullable bvd.c $$4) {
      this.b = $$0;
      this.c = $$1;
      this.h = $$3;
      this.d = $$2;
   ...
   public static bvd a(String $$0, bvc $$1, DoubleSupplier $$2) {
      return new bvd($$0, $$1, $$2, null, null);
   }

   public static <T> bvd a(String $$0, bvc $$1, T $$2, ToDoubleFunction<T> $$3) {
      return a($$0, $$1, $$3, $$2).a();
   }

   public static <T> bvd.a<T> a(String $$0, bvc $$1, ToDoubleFunction<T> $$2, T $$3) {
      return new bvd.a<>($$0, $$1, $$2, $$3);
   }
   ...
   public static class a<T> {
      ...
      public a(String $$0, bvc $$1, ToDoubleFunction<T> $$2, T $$3) {
         this.a = $$0;
         this.b = $$1;
      ...
      public bvd.a<T> a(Consumer<T> $$0) {
         this.e = () -> $$0.accept(this.d);
         return this;
      }

      public bvd.a<T> a(bvd.c $$0) {
         this.f = $$0;
         return this;
      }

      public bvd a() {
         return new bvd(this.a, this.b, this.c, this.e, this.f);
      }
   }
   ...
   public static class d implements bvd.c {
