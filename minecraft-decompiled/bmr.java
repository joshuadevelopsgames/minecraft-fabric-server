...
public class bmr extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(blp.x);
      Type<?> $$1 = this.getOutputSchema().getType(blp.x);
   ...
   private static Typed<?> a(Typed<?> $$0, OpticFinder<?> $$1, OpticFinder<?> $$2, Type<?> $$3, Type<?> $$4) {
      ...
      return $$0.update(
         ...
         $$1x -> {
            ...
            $$1x = a($$1x, "minecraft:jukebox_playable", "song", $$5);
