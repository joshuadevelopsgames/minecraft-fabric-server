...
public class bbr implements DynamicOps<HashCode> {
   ...
   public static final bbr c = new bbr(Hashing.crc32c());
   ...
   class a extends bal<HashCode, Hasher> {
      public a() {
         super(bbr.this);
      }

      protected Hasher b() {
         return bbr.this.D.newHasher().putByte((byte)4);
      }
   ...
   final class b extends AbstractUniversalBuilder<HashCode, List<Pair<HashCode, HashCode>>> {
      ...
      protected DataResult<HashCode> a(List<Pair<HashCode, HashCode>> $$0, HashCode $$1) {
         assert $$1.equals(bbr.this.a());

         return DataResult.success(bbr.a(bbr.this.D.newHasher(), $$0.stream()).hash());
      }
   }
}
