...
public class bbq {
   ...
   public static jl<dcr> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return mm.g.c(ame.a($$2)).orElseThrow(() -> new JsonSyntaxException("Expected " + $$1 + " to be an item, was unknown string '" + $$2 + "'"));
      } else {
         throw new JsonSyntaxException("Expected " + $$1 + " to be an item, was " + d($$0));
      }
   }

   public static jl<dcr> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jl<dcr> a(JsonObject $$0, String $$1, @Nullable jl<dcr> $$2) {
   ...
   public static <T> T b(Gson $$0, Reader $$1, TypeToken<T> $$2) {
      T $$3 = a($$0, $$1, $$2);
      if ($$3 == null) {
         throw new JsonParseException("JSON data was null or empty");
      } else {
   ...
   public static boolean a(JsonElement $$0, int $$1) {
      try {
         Streams.write($$0, new JsonWriter(Streams.writerForAppendable(new bbq.a($$1))));
         return false;
