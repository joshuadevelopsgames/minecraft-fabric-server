...
public class bwt extends bwm {
   public static final MapCodec<bwt> a = RecordCodecBuilder.mapCodec(
   ...
   private bwt(float $$0, float $$1) {
      this.b = $$0;
      this.d = $$1;
   }

   public static bwt b(float $$0, float $$1) {
      if ($$1 <= $$0) {
