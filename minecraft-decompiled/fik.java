...
public class fik implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<fik.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public fik(List<fik.a> $$0) {
      this.c = $$0;
   }
   ...
   public static fik a(BufferedReader $$0) {
      return new fik($$0.lines().flatMap($$0x -> fik.a.a($$0x).stream()).toList());
   }

   public record a(fik.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<fik.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new fik.a(fik.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new fik.a(fik.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new fik.a(fik.b.b, $$3));
      ...
      static fik.a b(String $$0) {
         return new fik.a(fik.b.a, "glob:" + $$0);
      }

      static fik.a c(String $$0) {
         return new fik.a(fik.b.a, "regex:" + $$0);
      }

      static fik.a d(String $$0) {
         return new fik.a(fik.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      fik.b a = FileSystem::getPathMatcher;
      fik.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
