...
public class asx extends JComponent {
   ...
   public static asx a(final ari $$0) {
      try {
   ...
   public void a(JTextArea $$0, JScrollPane $$1, String $$2) {
      if (!SwingUtilities.isEventDispatchThread()) {
         ...
         if ($$1.getViewport().getView() == $$0) {
            $$5 = $$4.getValue() + $$4.getSize().getHeight() + a.getSize() * 4 > $$4.getMaximum();
         }
