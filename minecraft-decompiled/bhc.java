...
public class bhc extends bkj {
   public bhc(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", blp.E, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(blp.G.typeName(), bnm.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(blp.u);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(blp.G.typeName(), "minecraft:saddle"));
