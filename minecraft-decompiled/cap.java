...
public enum cap implements bda {
   ...
   public static final Codec<cap> i = bda.a(cap::values);
   private final int j;
   ...
   private cap(final String $$0, final int $$1, final boolean $$2, final boolean $$3, final int $$4) {
      this.m = $$0;
      this.j = $$1;
      this.k = $$2;
      this.l = $$3;
