...
public class ezp {
   ...
   @Deprecated
   public static ezp a(bck $$0, IntStream $$1) {
      return new ezp($$0, a(new IntRBTreeSet($$1.boxed().collect(ImmutableList.toImmutableList()))), false);
   }

   @Deprecated
   public static ezp a(bck $$0, int $$1, DoubleList $$2) {
      return new ezp($$0, Pair.of($$1, $$2), false);
   }

   public static ezp b(bck $$0, IntStream $$1) {
      return a($$0, $$1.boxed().collect(ImmutableList.toImmutableList()));
   }

   public static ezp a(bck $$0, List<Integer> $$1) {
      return new ezp($$0, a(new IntRBTreeSet($$1)), true);
   }

   public static ezp a(bck $$0, int $$1, double $$2, double... $$3) {
      DoubleArrayList $$4 = new DoubleArrayList($$3);
      $$4.add(0, $$2);
      return new ezp($$0, Pair.of($$1, $$4), true);
   }

   public static ezp b(bck $$0, int $$1, DoubleList $$2) {
      return new ezp($$0, Pair.of($$1, $$2), true);
   }
   ...
   protected ezp(bck $$0, Pair<Integer, DoubleList> $$1, boolean $$2) {
      ...
      if ($$2) {
         ...
         for (int $$6 = 0; $$6 < $$3; $$6++) {
            if (this.d.getDouble($$6) != 0.0) {
               int $$7 = this.c + $$6;
               this.b[$$6] = new ezm($$5.a("octave_" + $$7));
            }
         }
      } else {
         ezm $$8 = new ezm($$0);
   ...
   public static double b(double $$0) {
      return $$0 - bcb.b($$0 / 3.3554432E7 + 0.5) * 3.3554432E7;
   }
