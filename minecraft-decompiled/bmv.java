...
public class bmv extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, String>> $$0 = this.getInputSchema().getType(blp.A);
      Type<?> $$1 = this.getOutputSchema().getType(blp.A);
      return this.a($$0, $$1);
   }
