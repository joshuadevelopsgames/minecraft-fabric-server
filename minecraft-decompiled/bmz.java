...
public class bmz extends DataFix {
   private static final int a = 2;
   private static final int[] b = new int[]{0, 10, 50, 100, 150};

   public static int a(int $$0) {
      return b[bcb.a($$0 - 1, 0, b.length - 1)];
   }

   public bmz(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(blp.E, "minecraft:villager");
      ...
      return this.fixTypeEverywhereTyped("Villager level and xp rebuild", this.getInputSchema().getType(blp.E), $$5x -> $$5x.updateTyped($$1, $$0, $$3xx -> {
