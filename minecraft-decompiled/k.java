...
public final class k {
   ...
   public static final Codec<k> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            bbi.e.fieldOf("translation").forGetter($$0x -> $$0x.e),
            bbi.j.fieldOf("left_rotation").forGetter($$0x -> $$0x.f),
            bbi.e.fieldOf("scale").forGetter($$0x -> $$0x.g),
            bbi.j.fieldOf("right_rotation").forGetter($$0x -> $$0x.h)
         )
         .apply($$0, k::new)
   );
   public static final Codec<k> b = Codec.withAlternative(a, bbi.k.xmap(k::new, k::c));
   private boolean d;
   @Nullable
   private Vector3f e;
   @Nullable
