...
public class bd extends dl<bd.a> {
   ...
   public void a(auc $$0, Collection<? extends bzm> $$1) {
      List<fdj> $$2 = $$1.stream().map($$1x -> bz.b($$0, $$1x)).collect(Collectors.toList());
      this.a($$0, $$1x -> $$1x.a($$2));
   }

   public record a(Optional<bj> b, List<bj> c) implements dl.a {
      ...
      public boolean a(Collection<? extends fdj> $$0) {
         for (bj $$1 : this.c) {
            boolean $$2 = false;
