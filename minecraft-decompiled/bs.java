...
public class bs extends dl<bs.a> {
   ...
   public void a(auc $$0, @Nullable bzm $$1) {
      fdj $$2 = $$1 != null ? bz.b($$0, $$1) : null;
      this.a($$0, $$2x -> $$2x.a($$0, $$2));
   }

   public record a(Optional<bj> b, Optional<cy> c, Optional<bj> d) implements dl.a {
      ...
      public boolean a(auc $$0, @Nullable fdj $$1) {
         return this.c.isPresent() && !this.c.get().a((cam)$$0) ? false : !this.d.isPresent() || $$1 != null && this.d.get().a($$1);
      }
