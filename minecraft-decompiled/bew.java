...
public class bew extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(blp.u);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(blp.t);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(blp.t);
