...
public class bbf implements AutoCloseable {
   ...
   private bbf(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static bbf.a a(Path $$0) {
         return new bbf.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
