...
public record bn(List<du<byd>> b, Optional<bz> c, Optional<bz> d, Optional<Boolean> e) {
   public static final Codec<bn> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            du.a(mn.aR).listOf().optionalFieldOf("tags", List.of()).forGetter(bn::a),
   ...
   public boolean a(auc $$0, byb $$1) {
      return this.a($$0.y(), $$0.dv(), $$1);
   }

   public boolean a(aub $$0, fis $$1, byb $$2) {
      for (du<byd> $$3 : this.b) {
         if (!$$3.a($$2.l())) {
            return false;
         }
   ...
   public static class a {
      private final Builder<du<byd>> a = ImmutableList.builder();
