...
public interface gsk {
   static gsk a(gsq $$0, UserApiService $$1) {
      return new gsk.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, gss var2, AbuseReport var3);
   ...
   public record b(gsq a, UserApiService b) implements gsk {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, gss $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               xo $$5 = this.a(var7);
               throw new CompletionException(new gsk.a($$5, var7));
            } catch (MinecraftClientException var8) {
               xo $$7 = this.a(var8);
               throw new CompletionException(new gsk.a($$7, var8));
            }
         }, ag.i());
      }
