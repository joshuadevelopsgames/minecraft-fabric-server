...
public class aq {
   public static final Codec<at<?>> a = mm.ak.q();
   ...
   public static final dd U = a("player_sheared_equipment", new dd());
   public static final dr V = a("started_riding", new dr());
   public static final cu W = a("lightning_strike", new cu());
   public static final ea X = a("using_item", new ea());
   public static final br Y = a("fall_from_height", new br());
   public static final br Z = a("ride_entity_in_lava", new br());
   public static final cq aa = a("kill_mob_near_sculk_catalyst", new cq());
   public static final co ab = a("allay_drop_item_on_block", new co());
   public static final df ac = a("avoid_vibration", new df());
   public static final dh ad = a("recipe_crafted", new dh());
   public static final dh ae = a("crafter_recipe_crafted", new dh());
   public static final cd af = a("fall_after_explosion", new cd());

   private static <T extends at<?>> T a(String $$0, T $$1) {
      return jy.a(mm.ak, $$0, $$1);
   }

   public static at<?> a(jy<at<?>> $$0) {
      return b;
   }
}
