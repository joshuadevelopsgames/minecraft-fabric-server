...
public abstract class fou<T extends fou<T>> {
   ...
   public fou(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fos.a();
         if ($$3 != null) {
         ...
         throw new fqw(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fqw(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fqw(var2.getMessage(), var2);
      }
   }
   ...
   public static fou<?> a(String $$0) {
      return new fou.b($$0, 5000, 60000);
   }

   public static fou<?> a(String $$0, int $$1, int $$2) {
      return new fou.b($$0, $$1, $$2);
   }

   public static fou<?> b(String $$0, String $$1) {
      return new fou.c($$0, $$1, 5000, 60000);
   }

   public static fou<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fou.c($$0, $$1, $$2, $$3);
   }

   public static fou<?> b(String $$0) {
      return new fou.a($$0, 5000, 60000);
   }

   public static fou<?> c(String $$0, String $$1) {
      return new fou.d($$0, $$1, 5000, 60000);
   }

   public static fou<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fou.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fou<fou.a> {
   ...
   public static class b extends fou<fou.b> {
   ...
   public static class c extends fou<fou.c> {
      ...
      public fou.c f() {
         try {
            ...
            throw new fqw(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fou<fou.d> {
      private final String c;
