...
public abstract class fnl {
   ...
   private List<String> a(String $$0, fnl.a $$1, String $$2) {
      int $$3 = $$1.b;
      int $$4 = 0;
      String $$5 = "";
         ...
         if (!a($$0, $$7, $$4)) {
            ...
            if ($$8 != null) {
               ...
               if (!Strings.isNullOrEmpty($$12)) {
                  ...
                  $$1.b++;
                  int $$13 = $$1.b;
                  List<String> $$14 = this.a($$12, $$1, $$9 ? w.c($$11) : "");
               ...
               int $$16 = bdb.c($$0.substring(0, $$7.end(1)));
   ...
   private String a(String $$0, fnl.a $$1) {
   ...
   public static String a(String $$0, gyf $$1) {
      if ($$1.c()) {
         return $$0;
      } else {
         int $$2 = $$0.indexOf(10);
