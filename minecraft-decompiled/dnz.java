...
public class dnz {
   public static final int a = jw.a(8);
   ...
   public dnz a(dnz.a $$0) {
      return new dnz($$0, this.f);
   }

   public jl<dnx> a(jb $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public jl<dnx> a(double $$0, double $$1, double $$2) {
      int $$3 = jw.a(bcb.a($$0));
      int $$4 = jw.a(bcb.a($$1));
      int $$5 = jw.a(bcb.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = bbx.a($$7, $$0);
      double $$10 = b($$7);
      return bcb.k($$6 + $$10) + bcb.k($$5 + $$9) + bcb.k($$4 + $$8);
   }
   ...
   public interface a {
      jl<dnx> getNoiseBiome(int var1, int var2, int var3);
   }
}
