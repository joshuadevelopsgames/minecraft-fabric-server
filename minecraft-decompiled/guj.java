public class guj extends gur {
   private final double a;
   private final int b;

   guj(grk $$0, double $$1, double $$2, double $$3, double $$4, int $$5, int $$6) {
   ...
   public void a() {
      if (this.s % (this.b + 1) == 0) {
         for (int $$0 = 0; $$0 < 3; $$0++) {
            ...
            this.c.a(me.x, $$1, $$2, $$3, (float)this.s / this.t, 0.0, 0.0);
         }
      }
   ...
   public static class a implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new guj($$1, $$2, $$3, $$4, this.a, this.b, this.c);
      }
   }
}
