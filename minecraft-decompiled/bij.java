...
public class bij extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bdt.a(this.a("minecraft:trident", bij::c), this.a("minecraft:arrow", bij::a), this.a("minecraft:spectral_arrow", bij::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bij.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(blp.E, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(blp.E, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bij.a<?> $$1, Type<?> $$2, Type<T> $$3) {
