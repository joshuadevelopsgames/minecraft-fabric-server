...
public class bep extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, Dynamic<?>>> $$6 = DSL.named(blp.v.typeName(), DSL.remainderType());
      OpticFinder<List<Pair<String, Dynamic<?>>>> $$7 = DSL.fieldFinder("Palette", DSL.list($$6));
      return this.fixTypeEverywhereTyped(
         "BitStorageAlignFix", $$0, this.getOutputSchema().getType(blp.d), $$4x -> $$4x.updateTyped($$2, $$3xx -> this.a(a($$3, $$5, $$7, $$3xx)))
      );
   }
