...
public class gua extends gvt {
   private final float a;
   private final gvo b;

   gua(grk $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gvo $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
      ...
      this.t = (int)Math.max($$9 * 0.9F, 1.0F);
      this.b($$7);
   ...
   public static class a implements guw<lw> {
      ...
      public gut a(lw $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.l() && $$8.o() == dwn.a) {
            ...
            jb $$9 = jb.a($$2, $$3, $$4);
            int $$10 = fue.R().az().a($$8, $$1, $$9);
            if ($$8.b() instanceof dsy) {
               $$10 = ((dsy)$$8.b()).b($$8, $$1, $$9);
            }

            float $$11 = ($$10 >> 16 & 0xFF) / 255.0F;
            float $$12 = ($$10 >> 8 & 0xFF) / 255.0F;
            float $$13 = ($$10 & 0xFF) / 255.0F;
            return new gua($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
