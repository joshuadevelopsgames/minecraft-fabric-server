...
public class bly extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = this.getInputSchema().getType(blp.E);
      Type<?> $$3 = this.getOutputSchema().getType(blp.E);
      Type<?> $$4 = bdt.a($$2, $$2, $$3);
      return this.fixTypeEverywhereTyped("SaddleEquipmentSlotFix", $$2, $$3, $$3x -> {
         String $$4x = $$3x.getOptional($$1).<String>map(Pair::getFirst).map(bnm::a).orElse("");
         Typed<?> $$5 = bdt.a($$4, $$3x);
         if (a.contains($$4x)) {
            return ag.a($$5, $$3, bly::a);
         } else {
            return b.contains($$4x) ? ag.a($$5, $$3, bly::b) : bdt.a($$3, $$3x);
         }
      });
   }
