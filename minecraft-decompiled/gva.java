public class gva extends guz {
   gva(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.D *= 1.5F;
   ...
   public float b(float $$0) {
      float $$1 = 1.0F - (this.s + $$0) / (this.t * 1.5F);
      return this.D * $$1;
   }
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         this.g = this.g + this.j * $$0;
         this.h = this.h + this.k * $$0;
         this.i = this.i + this.l * $$0;
      }
   }
