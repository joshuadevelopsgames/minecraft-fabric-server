public class bzl {
   ...
   public void a() {
      ...
      if (this.i.fQ()) {
         ...
         $$3 = bcb.h($$0, (float) (Math.PI / 12), (float) (Math.PI / 9));
         $$4 = bcb.h($$0, (float) (-Math.PI / 12), (float) (-Math.PI / 2));
         $$5 = 0.0F;
      } else if (this.i.cl()) {
   ...
   public float a(float $$0) {
      return bcb.h($$0, this.f, this.c);
   }

   public float b(float $$0) {
      return bcb.h($$0, this.g, this.d);
   }

   public float c(float $$0) {
      return bcb.h($$0, this.h, this.e);
   }
}
