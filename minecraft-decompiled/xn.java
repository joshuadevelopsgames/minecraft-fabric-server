...
public class xn {
   ...
   public static final xo q = xo.c("menu.returnToMenu");
   public static final xo r = xo.c("connect.failed.transfer");
   public static final xo s = xo.c("connect.failed");
   public static final xo t = xo.b("\n");
   public static final xo u = xo.b(". ");
   public static final xo v = xo.b("...");
   public static final xo w = a();
