public class gnq extends gnh<hla> {
   public static final gqw a = gqw.scaling(2.35F);
   ...
   private final gqn m;
   private final gqn n;
   private final gqn[] o = new gqn[12];
   private final gqn[] p;
   ...
   public static gqt a() {
      ...
      gqs $$3 = gqs.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, gqp.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", gqs.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), gqp.a(0.0F, 0.0F, -8.25F));
      gqx $$11 = $$2.a("tail0", gqs.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), gqp.a);
      gqx $$12 = $$11.a("tail1", gqs.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), gqp.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", gqs.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), gqp.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(hla $$0) {
      ...
      if ($$0.e != null && $$0.d != null) {
         ...
         fis $$3 = $$0.d;
         $$3 = new fis($$3.d, 0.0, $$3.f);
         fis $$4 = new fis($$0.c.d - $$0.e.d, 0.0, $$0.c.f - $$0.e.f).d().b((float) (Math.PI / 2));
         double $$5 = $$3.b($$4);
         this.n.b = bcb.c((float)Math.abs($$5)) * 2.0F * (float)Math.signum($$5);
      }

      this.n.k = true;
      float $$6 = $$0.b;
      this.p[0].f = bcb.a($$6) * (float) Math.PI * 0.05F;
      this.p[1].f = bcb.a($$6) * (float) Math.PI * 0.1F;
      this.p[2].f = bcb.a($$6) * (float) Math.PI * 0.15F;
   }
   ...
   private static float a(int $$0, float $$1, float $$2) {
      return 1.0F + bcb.b($$1 * 1.5F + $$0) * 0.01F - $$2;
   }
