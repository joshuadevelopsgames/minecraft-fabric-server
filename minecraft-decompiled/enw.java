...
@Deprecated
public class enw extends enh<enw.a> {
   private static final eeb a = dqb.nJ.m();

   public enw(Codec<enw.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(enj<enw.a> $$0) {
      jb $$1 = $$0.e();
      dnt $$2 = $$0.b();
      bck $$3 = $$0.d();
      enw.a $$4 = $$0.f();
         ...
         if ($$21.y().a(azu.a)) {
            for (int $$39 = 0; $$39 < 16; $$39++) {
               for (int $$40 = 0; $$40 < 16; $$40++) {
                  int $$41 = 4;
                  jb $$42 = $$1.b($$39, 4, $$40);
                  if ($$2.v($$42).a().a($$2, $$42, false) && this.c($$2.a_($$42))) {
                     $$2.a($$42, dqb.ee.m(), 2);
                  }
               }
            }
   ...
   public record a(ern b, ern c) implements epm {
      public static final Codec<enw.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(ern.a.fieldOf("fluid").forGetter(enw.a::a), ern.a.fieldOf("barrier").forGetter(enw.a::b)).apply($$0, enw.a::new)
      );
