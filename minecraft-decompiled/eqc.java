...
public class eqc implements epm {
   public static final Codec<eqc> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            euc.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
            ...
            bae.b(mn.i).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
            ern.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
            ...
            ern.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
            ...
            elh.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
         )
         .apply($$0, eqc::new)
   );
   ...
   public eqc(jl<euc> $$0, int $$1, int $$2, bae<dpz> $$3, ern $$4, int $$5, int $$6, int $$7, int $$8, ern $$9, int $$10, int $$11, elh $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
