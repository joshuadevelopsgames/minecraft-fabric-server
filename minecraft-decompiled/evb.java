...
public class evb extends fbx {
   ...
   public static final Codec<evb> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(d.fieldOf("All").forGetter($$0x -> $$0x.b), d.fieldOf("Remaining").forGetter($$0x -> $$0x.c)).apply($$0, evb::new)
   );

   public static fby<evb> a(String $$0) {
      return new fby<>($$0, evb::new, a, bdr.p);
   }

   private evb(LongSet $$0, LongSet $$1) {
      this.b = $$0;
      this.c = $$1;
   }
