...
public class bht extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(blp.G.typeName(), bnm.a()));
      ...
      return this.fixTypeEverywhereTyped("ItemStack bucket_entity_data variants to separate components", $$0, $$2x -> {
         ...
         return switch ($$3) {
            case "minecraft:salmon_bucket" -> $$2x.updateTyped($$2, bht::c);
            case "minecraft:axolotl_bucket" -> $$2x.updateTyped($$2, bht::b);
            case "minecraft:tropical_fish_bucket" -> $$2x.updateTyped($$2, bht::a);
            case "minecraft:painting" -> $$2x.updateTyped($$2, $$0xx -> ag.a($$0xx, $$0xx.getType(), bht::a));
            default -> $$2x;
         };
      });
   }
   ...
   private static String a(int $$0) {
      return bdt.a($$0 >> 16 & 0xFF);
   }

   private static String b(int $$0) {
      return bdt.a($$0 >> 24 & 0xFF);
   }
