...
public class dlq {
   public static final Codec<dlq> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            dlo.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
            dlo.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
            dcv.b.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   private dlq(dlo $$0, Optional<dlo> $$1, dcv $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dlq(dlo $$0, dcv $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dlq(dlo $$0, Optional<dlo> $$1, dcv $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dlq(dlo $$0, Optional<dlo> $$1, dcv $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dlq(dlo $$0, Optional<dlo> $$1, dcv $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   private int a(dlo $$0) {
      int $$1 = $$0.b();
      int $$2 = Math.max(0, bcb.d($$1 * this.j * this.k));
      return bcb.a($$1 + $$2 + this.i, 1, $$0.d().k());
   }

   public dcv c() {
      return this.d.map(dlo::d).orElse(dcv.l);
   }
   ...
   private static void a(wx $$0, dlq $$1) {
      dlo.b.encode($$0, $$1.d());
      dcv.j.encode($$0, $$1.f());
      dlo.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dlq a(wx $$0) {
      dlo $$1 = dlo.b.decode($$0);
      dcv $$2 = dcv.j.decode($$0);
      Optional<dlo> $$3 = dlo.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dlq $$11 = new dlq($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
