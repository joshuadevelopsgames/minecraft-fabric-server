...
public class blc extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(blp.z);
      Type<?> $$1 = this.getOutputSchema().getType(blp.z);
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         ...
         Dynamic<T> $$4 = a($$0.getOps(), $$1.substring($$2));
         if ($$4 != null) {
            $$3 = $$3.set("tag", $$4);
         }
      }
   ...
   private static <T> Dynamic<T> a(DynamicOps<T> $$0, String $$1) {
      try {
         return new Dynamic($$0, vj.a($$0).b($$1));
      } catch (Exception var3) {
         a.warn("Failed to parse tag: {}", $$1, var3);
         return null;
      }
   }
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(bnm.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(bnm.a($$1.substring(0, $$2))));
   ...
   private <T> Dynamic<T> g(Dynamic<T> $$0, String $$1) {
      try {
         ...
         $$2.expect(' ');
         int $$6 = $$2.readInt();
         Dynamic<T> $$7 = $$0.createIntList(IntStream.of(bcb.d($$3), bcb.d($$4), bcb.d($$5)));
