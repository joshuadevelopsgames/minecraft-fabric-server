...
public class hu<T extends em<T>> {
   @VisibleForTesting
   ...
   public static class a<T extends em<T>> extends hu<T> implements hn<T> {
      private final hj b;
      private final T c;
   ...
   public static class b<T extends em<T>> extends hu<T> implements hn<T> {
      private final T b;
   ...
   public static class c<T extends em<T>> extends hu<T> implements hs<T> {
