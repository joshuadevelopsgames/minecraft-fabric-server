...
public class bbi {
   ...
   public static final Codec<vi> c = a(uw.a);
   public static final Codec<Vector2f> d = Codec.FLOAT
      .listOf()
      .comapFlatMap($$0 -> ag.a($$0, 2).map($$0x -> new Vector2f((Float)$$0x.get(0), (Float)$$0x.get(1))), $$0 -> List.of($$0.x(), $$0.y()));
   public static final Codec<Vector3f> e = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ag.a($$0, 3).map($$0x -> new Vector3f((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2))), $$0 -> List.of($$0.x(), $$0.y(), $$0.z())
      );
   public static final Codec<Vector3i> f = Codec.INT
      .listOf()
      .comapFlatMap(
         $$0 -> ag.a($$0, 3).map($$0x -> new Vector3i((Integer)$$0x.get(0), (Integer)$$0x.get(1), (Integer)$$0x.get(2))),
         $$0 -> List.of($$0.x(), $$0.y(), $$0.z())
      );
   public static final Codec<Vector4f> g = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ag.a($$0, 4).map($$0x -> new Vector4f((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3))),
         $$0 -> List.of($$0.x(), $$0.y(), $$0.z(), $$0.w())
      );
   public static final Codec<Quaternionf> h = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ag.a($$0, 4).map($$0x -> new Quaternionf((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3)).normalize()),
         $$0 -> List.of($$0.x, $$0.y, $$0.z, $$0.w)
      );
   public static final Codec<AxisAngle4f> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(Codec.FLOAT.fieldOf("angle").forGetter($$0x -> $$0x.angle), e.fieldOf("axis").forGetter($$0x -> new Vector3f($$0x.x, $$0x.y, $$0x.z)))
         .apply($$0, AxisAngle4f::new)
   );
   public static final Codec<Quaternionf> j = Codec.withAlternative(h, i.xmap(Quaternionf::new, AxisAngle4f::new));
   public static final Codec<Matrix4fc> k = Codec.FLOAT.listOf().comapFlatMap($$0 -> ag.a($$0, 16).map($$0x -> {
   ...
   public static final Codec<Integer> l = Codec.withAlternative(Codec.INT, e, $$0 -> baj.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> m = Codec.withAlternative(Codec.INT, g, $$0 -> baj.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> n = Codec.BYTE
      .flatComapMap(
         UnsignedBytes::toInt,
         $$0 -> $$0 > 255 ? DataResult.error(() -> "Unsigned byte was too large: " + $$0 + " > 255") : DataResult.success($$0.byteValue())
      );
   public static final Codec<Integer> o = a(0, Integer.MAX_VALUE, $$0 -> "Value must be non-negative: " + $$0);
   public static final Codec<Integer> p = a(1, Integer.MAX_VALUE, $$0 -> "Value must be positive: " + $$0);
   public static final Codec<Float> q = a(0.0F, Float.MAX_VALUE, $$0 -> "Value must be non-negative: " + $$0);
   public static final Codec<Float> r = b(0.0F, Float.MAX_VALUE, $$0 -> "Value must be positive: " + $$0);
   public static final Codec<Pattern> s = Codec.STRING.comapFlatMap($$0 -> {
      try {
   ...
   public static final Codec<Instant> t = a(DateTimeFormatter.ISO_INSTANT).xmap(Instant::from, Function.identity());
   public static final Codec<byte[]> u = Codec.STRING.comapFlatMap($$0 -> {
      try {
   ...
   public static final Codec<String> v = Codec.STRING
      .comapFlatMap($$0 -> DataResult.success(StringEscapeUtils.unescapeJava($$0)), StringEscapeUtils::escapeJava);
   public static final Codec<bbi.d> w = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ame.d($$0.substring(1)).map($$0x -> new bbi.d($$0x, true)) : ame.d($$0).map($$0x -> new bbi.d($$0x, false)), bbi.d::c
      );
   public static final Function<Optional<Long>, OptionalLong> x = $$0 -> $$0.map(OptionalLong::of).orElseGet(OptionalLong::empty);
   public static final Function<OptionalLong, Optional<Long>> y = $$0 -> $$0.isPresent() ? Optional.of($$0.getAsLong()) : Optional.empty();
   public static final Codec<BitSet> z = Codec.LONG_STREAM.xmap($$0 -> BitSet.valueOf($$0.toArray()), $$0 -> Arrays.stream($$0.toLongArray()));
   private static final Codec<Property> I = RecordCodecBuilder.create(
      $$0 -> $$0.group(
   ...
   public static final Codec<PropertyMap> A = Codec.either(Codec.unboundedMap(Codec.STRING, Codec.STRING.listOf()), I.listOf()).xmap($$0 -> {
   ...
   public static final Codec<String> B = Codec.string(0, 16)
      .validate($$0 -> bdb.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> J = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kf.e.fieldOf("id").forGetter(GameProfile::getId), B.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   public static final Codec<GameProfile> C = RecordCodecBuilder.create(
      $$0 -> $$0.group(J.forGetter(Function.identity()), A.lenientOptionalFieldOf("properties", new PropertyMap()).forGetter(GameProfile::getProperties))
         .apply($$0, ($$0x, $$1) -> {
            $$1.forEach(($$1x, $$2) -> $$0x.getProperties().put($$1x, $$2));
            return $$0x;
         })
   );
   public static final Codec<String> D = Codec.STRING
      .validate($$0 -> $$0.isEmpty() ? DataResult.error(() -> "Expected non-empty string") : DataResult.success($$0));
   public static final Codec<Integer> E = Codec.STRING.comapFlatMap($$0 -> {
      int[] $$1 = $$0.codePoints().toArray();
      return $$1.length != 1 ? DataResult.error(() -> "Expected one codepoint, got: " + $$0) : DataResult.success($$1[0]);
   }, Character::toString);
   public static final Codec<String> F = Codec.STRING
      .validate($$0 -> !ame.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   public static final Codec<URI> G = Codec.STRING.comapFlatMap($$0 -> {
      try {
   ...
   public static final Codec<String> H = Codec.STRING.validate($$0 -> {
   ...
   public static <K, V> bbi.c<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new bbi.c<>($$0, $$1);
   }
   ...
   public static <T> Codec<jp<T>> c(Codec<jp<T>> $$0) {
      return $$0.validate(
   ...
   public static <K, V> MapCodec<V> a(
      ...
      return new MapCodec<V>() {
         ...
         public <T> RecordBuilder<T> encode(V $$0x, DynamicOps<T> $$1x, RecordBuilder<T> $$2x) {
            ...
            DataResult<T> $$4x = this.a($$4.apply($$3x), $$0, $$1);
   ...
   public static class b<I, V> {
      ...
      public Codec<V> a(Codec<I> $$0) {
         ...
         return bbi.a($$0, this.a::get, $$1::get);
      }

      public bbi.b<I, V> a(I $$0, V $$1) {
   ...
   public record c<K, V>(Codec<K> a, Codec<V> b) implements Codec<Map<K, V>>, BaseMapCodec<K, V> {
   ...
   public record d(ame a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
