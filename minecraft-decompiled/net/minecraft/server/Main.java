...
public class Main {
   ...
   public static void main(String[] $$0) {
      ...
      try {
         ...
         and $$43;
         try {
            anc.c $$42 = a($$21.a(), $$39, $$40, $$41);
            $$43 = ag.<and>c($$6x -> anc.a($$42, $$5xx -> {
               jy<ehz> $$6xx = $$5xx.d().f(mn.bv);
               if ($$39 != null) {
                  fcp $$7x = fcs.a($$39, $$5xx.b(), $$6xx, $$5xx.c());
                  return new anc.b<>($$7x.a(), $$7x.b().b());
               } else {
                  ...
                  if ($$18.has($$4)) {
                     ...
                     arj $$11x = $$21.a();
                     $$8x = new dmy($$11x.l, $$11x.k, $$11x.t, $$11x.j, false, new dmq($$5xx.b().b()), $$5xx.b());
                  ...
                  return new anc.b<>(new fcw($$8x, $$9x, $$15x.d(), $$16x), $$15x.b());
               }
            }, and::new, ag.h(), $$6x)).get();
         ...
         boolean $$48 = $$18.has($$8);
         if ($$18.has($$6) || $$48) {
            a($$28, $$47, bds.a(), $$18.has($$7), () -> true, $$46, $$48);
         }

         $$28.a($$46, $$47);
         final ari $$49 = MinecraftServer.a((Function<Thread, ari>)($$11x -> {
            ari $$12x = new ari($$11x, $$28, $$41, $$43, $$21, bds.a(), $$25, aun::b);
   ...
   private static void a(fcs.c $$0, fdd $$1, DataFixer $$2, boolean $$3, BooleanSupplier $$4, jz $$5, boolean $$6) {
      ...
      try (bwx $$7 = new bwx($$0, $$2, $$1, $$5, $$3, $$6)) {
         ...
         while (!$$7.b()) {
            ...
            if ($$10 > 0) {
               int $$11 = $$7.f() + $$7.g();
               a.info("{}% completed ({} / {} chunks)...", new Object[]{bcb.d((float)$$11 / $$10 * 100.0F), $$11, $$10});
            }
