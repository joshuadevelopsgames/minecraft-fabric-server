...
public class cl extends dl<cl.a> {
   ...
   public void a(auc $$0, cus $$1, dcv $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(auc $$0, cus $$1, dcv $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$5x -> $$5x.a($$1, $$2, $$3, $$4, $$5));
   }

   public record a(Optional<bj> b, cl.a.a c, List<cn> d) implements dl.a {
      ...
      public static ar<cl.a> a(dmt... $$0) {
         cn[] $$1 = new cn[$$0.length];

         for (int $$2 = 0; $$2 < $$0.length; $$2++) {
            $$1[$$2] = new cn(Optional.of(jp.a($$0[$$2].h().e())), cx.d.c, bo.a);
         }

         return a($$1);
      }

      public boolean a(cus $$0, dcv $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
      ...
      public record a(cx.d c, cx.d d, cx.d e) {
