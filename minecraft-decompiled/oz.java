...
public class oz implements mt {
   private final mv d;
   private final CompletableFuture<jn.a> e;

   public oz(mv $$0, CompletableFuture<jn.a> $$1) {
      this.e = $$1;
      this.d = $$0;
   }
   ...
   public CompletableFuture<?> a(mr $$0) {
      return this.e.thenCompose($$1 -> {
         ...
         return CompletableFuture.allOf(alz.a.stream().flatMap($$3 -> this.a($$0, $$1, $$2, (alz.d<?>)$$3).stream()).toArray(CompletableFuture[]::new));
      });
   }

   private <T> Optional<CompletableFuture<?>> a(mr $$0, jn.a $$1, DynamicOps<JsonElement> $$2, alz.d<T> $$3) {
      amd<? extends jy<T>> $$4 = $$3.a();
      return $$1.a($$4).map($$4x -> {
         mv.a $$5 = this.d.a($$4);
