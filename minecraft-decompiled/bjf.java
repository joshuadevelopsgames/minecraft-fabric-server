...
public class bjf extends DataFix {
   ...
   private static void a(bjf.a $$0, Dynamic<?> $$1) {
      ...
      $$0.a("BlockEntityTag", false, $$1x -> {
         String $$2x = bnm.a($$1x.get("id").asString(""));
         $$1x = a($$0, $$1x, $$2x);
   ...
   private static Dynamic<?> a(bjf.a $$0, Dynamic<?> $$1, int $$2) {
      ...
      if ($$6.isPresent()) {
         $$0.a("minecraft:item_name", bdu.b($$1.getOps(), $$6.get()));
      }
   ...
   private static <T> Dynamic<T> a(bjf.a $$0, Dynamic<T> $$1, String $$2) {
      ...
      return switch ($$2) {
         ...
         case "minecraft:banner" -> {
            ...
            if ($$7.isPresent()) {
               $$0.a("minecraft:base_color", $$1.createString(bdt.a($$7.get().intValue())));
            }
   ...
   private static void a(bjf.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static Optional<Pair<String, Integer>> c(Dynamic<?> $$0) {
      return $$0.get("id").asString().apply2stable(($$0x, $$1) -> Pair.of($$0x, bcb.a($$1.intValue(), 0, 255)), $$0.get("lvl").asNumber()).result();
   }

   private static void b(bjf.a $$0, Dynamic<?> $$1, int $$2) {
      b($$0, $$1, "CanDestroy", "minecraft:can_break", ($$2 & 8) != 0);
      b($$0, $$1, "CanPlaceOn", "minecraft:can_place_on", ($$2 & 16) != 0);
   }

   private static void b(bjf.a $$0, Dynamic<?> $$1, String $$2, String $$3, boolean $$4) {
   ...
   private static void c(bjf.a $$0, Dynamic<?> $$1, int $$2) {
      OptionalDynamic<?> $$3 = $$0.a("AttributeModifiers");
      if (!$$3.result().isEmpty()) {
         boolean $$4 = ($$2 & 2) != 0;
         List<? extends Dynamic<?>> $$5 = $$3.asList(bjf::d);
   ...
   private static void b(bjf.a $$0, Dynamic<?> $$1) {
   ...
   private static void c(bjf.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
      if ($$2 != null) {
   ...
   private static void d(bjf.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = e($$0, $$1);
   ...
   @Nullable
   private static Dynamic<?> e(bjf.a $$0, Dynamic<?> $$1) {
   ...
   private static void f(bjf.a $$0, Dynamic<?> $$1) {
      Dynamic<?> $$2 = $$1.emptyMap();
   ...
   private static void g(bjf.a $$0, Dynamic<?> $$1) {
   ...
   private static void b(bjf.a $$0) {
      $$0.a("Fireworks", true, $$1 -> {
         Stream<? extends Dynamic<?>> $$2 = $$1.get("Explosions").asStream().map(bjf::f);
   ...
   protected TypeRewriteRule makeRule() {
      return this.writeFixAndRead("ItemStack componentization", this.getInputSchema().getType(blp.u), this.getOutputSchema().getType(blp.u), $$0 -> {
         Optional<? extends Dynamic<?>> $$1 = bjf.a.a($$0).map($$0x -> {
            a($$0x, $$0x.e);
            return $$0x.a();
         });
   ...
   static class a {
      ...
      public static Optional<bjf.a> a(Dynamic<?> $$0) {
         return $$0.get("id")
            .asString()
            .apply2stable(($$1, $$2) -> new bjf.a($$1, $$2.intValue(), $$0.remove("id").remove("Count")), $$0.get("Count").asNumber())
            .result();
      }
