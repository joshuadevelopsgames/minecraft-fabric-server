...
public class bmh extends DataFix {
   ...
   @Nullable
   private static bmh.a a(String $$0) {
      if (b.contains($$0)) {
         return null;
      } else {
         String $$1 = c.get($$0);
         if ($$1 != null) {
            return new bmh.a("minecraft:custom", $$1);
         } else {
            ...
            if ($$2 < 0) {
               ...
               if ("stat.mineBlock".equals($$3)) {
                  ...
                  return new bmh.a("minecraft:mined", $$4);
               } else {
                  String $$5 = f.get($$3);
                  if ($$5 != null) {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getInputSchema().getType(blp.h);
      Type<?> $$1 = this.getOutputSchema().getType(blp.h);
      return this.fixTypeEverywhereTyped("StatsCounterFix", $$0, $$1, $$1x -> {
         ...
         return ag.a($$1, $$2.emptyMap().set("stats", $$2.createMap($$3)));
      });
   }

   private TypeRewriteRule b() {
      Type<?> $$0 = this.getInputSchema().getType(blp.K);
      Type<?> $$1 = this.getOutputSchema().getType(blp.K);
      return this.fixTypeEverywhereTyped("ObjectiveStatFix", $$0, $$1, $$1x -> {
         ...
         Dynamic<?> $$3 = $$2.update("CriteriaName", $$0xx -> (Dynamic)DataFixUtils.orElse($$0xx.asString().result().map($$0xxx -> {
            if (a.contains($$0xxx)) {
               ...
               bmh.a $$1xx = a($$0xxx);
               return $$1xx == null ? "dummy" : bob.b($$1xx.a) + ":" + bob.b($$1xx.b);
            }
