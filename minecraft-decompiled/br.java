...
public class br extends dl<br.a> {
   ...
   public void a(auc $$0, fis $$1) {
      fis $$2 = $$0.dv();
      this.a($$0, $$3 -> $$3.a($$0.y(), $$1, $$2));
   }

   public record a(Optional<bj> b, Optional<cv> c, Optional<bq> d) implements dl.a {
      ...
      public static ar<br.a> a(bz.a $$0, bq $$1, cv.a $$2) {
         return aq.Y.a(new br.a(Optional.of(bz.a($$0)), Optional.of($$2.b()), Optional.of($$1)));
      }

      public static ar<br.a> a(bz.a $$0, bq $$1) {
         return aq.Z.a(new br.a(Optional.of(bz.a($$0)), Optional.empty(), Optional.of($$1)));
      }
      ...
      public boolean a(aub $$0, fis $$1, fis $$2) {
