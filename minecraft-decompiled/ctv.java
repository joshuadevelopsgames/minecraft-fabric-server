...
public class ctv {
   ...
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kf.a.fieldOf("uuid").forGetter(Pair::getFirst), bbi.o.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bzm> j;
   @VisibleForTesting
   protected final ArrayList<bzm> c;
   private final ctv.a k;
   @VisibleForTesting
   protected final Object2IntMap<bzm> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<ctv> a(Predicate<bzm> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(ctv::b)).apply($$1, $$1x -> new ctv($$0, $$1x))
      );
   }

   public ctv(Predicate<bzm> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new ctv.a(this);
   ...
   private List<Pair<UUID, Integer>> b() {
      return Streams.concat(
            new Stream[]{
               this.c.stream().map($$0 -> Pair.of($$0.cK(), this.d.getInt($$0))),
   ...
   public void a(aub $$0, Predicate<bzm> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bzm>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bzm> $$6 = (Entry<bzm>)$$5.next();
         int $$7 = $$6.getIntValue();
         bzm $$8 = (bzm)$$6.getKey();
         bzm.e $$9 = $$8.dV();
   ...
   public int b(@Nullable bzm $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<cam> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof cam).map($$0 -> (cam)$$0);
   }

   @VisibleForTesting
   protected record a(ctv a) implements Comparator<bzm> {
      public int a(bzm $$0, bzm $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cut;
               boolean $$7 = $$1 instanceof cut;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
