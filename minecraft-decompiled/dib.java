...
public final class dib {
   ...
   public static final MapCodec<dib> b = dib.a.a
      .flatXmap(dib::a, $$0 -> $$0.h.<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final zm<wx, dib> c = zm.a(zk.h, $$0 -> $$0.e, zk.h, $$0 -> $$0.f, dhi.b.a(zk.a()), $$0 -> $$0.g, dib::a);
   private final int e;
   private final int f;
   private final List<Optional<dhi>> g;
   private final Optional<dib.a> h;
   private final int i;
   private final boolean j;

   public dib(int $$0, int $$1, List<Optional<dhi>> $$2, Optional<dib.a> $$3) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   private static dib a(Integer $$0, Integer $$1, List<Optional<dhi>> $$2) {
      return new dib($$0, $$1, $$2, Optional.empty());
   }

   public static dib a(Map<Character, dhi> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static dib a(Map<Character, dhi> $$0, List<String> $$1) {
      dib.a $$2 = new dib.a($$0, $$1);
      return (dib)a($$2).getOrThrow();
   }

   private static DataResult<dib> a(dib.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      List<Optional<dhi>> $$4 = new ArrayList<>($$2 * $$3);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new dib($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(dha $$0, boolean $$1) {
   ...
   public List<Optional<dhi>> c() {
      return this.g;
   }

   public record a(Map<Character, dhi> b, List<String> c) {
      ...
      public static final MapCodec<dib.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(bbi.b(e, dhi.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, dib.a::new)
      );

      public Map<Character, dhi> a() {
         return this.b;
      }
