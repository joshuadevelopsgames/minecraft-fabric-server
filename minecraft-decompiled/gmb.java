public class gmb extends gnh<hju> {
   public static final float a = 1.8849558F;
   public static final gqw b = gqw.scaling(0.5F);
   private final gqn c;
   private final gqn d;
   private final gqn e;
   private final gqn f;
   ...
   public static gqt a() {
      ...
      gqx $$1 = $$0.a();
      gqx $$2 = $$1.a(
         "body", gqs.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), gqp.a(0.0F, 20.0F, 5.0F)
      );
      gqr $$3 = new gqr(0.001F);
      gqx $$4 = $$2.a("head", gqs.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), gqp.a(0.0F, 0.0F, -9.0F));
      gqs $$5 = gqs.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      gqs $$6 = gqs.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      gqs $$7 = gqs.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, gqp.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, gqp.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, gqp.a(4.0F, 0.0F, -1.0F));
      gqs $$8 = gqs.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      gqs $$9 = gqs.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, gqp.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, gqp.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, gqp.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, gqp.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", gqs.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), gqp.a(0.0F, 0.0F, 1.0F));
   ...
   public void a(hju $$0) {
      ...
      this.i.f = this.i.f + $$0.ad * (float) (Math.PI / 180.0);
      this.a($$0.v, $$0.ae, Math.min($$4, $$2));
      this.c($$0.v, Math.min($$5, $$2));
      this.b($$0.v, Math.min($$4, $$3));
      this.a($$0.v, Math.min($$5, $$3));
      this.a($$1);
      this.b($$6);
   }
   ...
   private void b(float $$0, float $$1) {
      if (!($$1 <= 1.0E-5F)) {
         ...
         this.j.f += $$6;
         this.c.f += $$6;
         float $$7 = (0.6F - 0.08F * ($$3 * $$3 + 2.0F * bcb.a($$2))) * $$1;
         this.k.e += $$7;
         this.l.f -= $$7;
         this.m.f += $$7;
   ...
   private void a(float $$0, float $$1, float $$2) {
      if (!($$2 <= 1.0E-5F)) {
         ...
         this.l.f += $$7;
         this.m.f -= $$7;
         this.c.f = this.c.f + 0.3F * bcb.b($$3 * 0.9F) * $$2;
