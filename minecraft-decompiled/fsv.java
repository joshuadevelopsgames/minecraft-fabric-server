...
public class fsv {
   ...
   public static List<fsv.a> a(String $$0, fsv.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fsv.a> a(String $$0, List<fsv.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fsv.a> a(List<String> $$0, List<fsv.b> $$1) {
      int $$2 = 0;
      List<fsv.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fsv.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fsv.b a(String $$0, String $$1) {
         return new fsv.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fsv.b a(String $$0) {
         return new fsv.b($$0);
      }
   }
}
