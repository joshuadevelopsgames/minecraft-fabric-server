public class guy extends gvt {
   private final gvo a;

   guy(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gvo $$7) {
      ...
      this.t = (int)Math.max($$10 * 2.5F, 1.0F);
      this.n = false;
      this.b($$7);
   }
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cut $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dE();
            if (this.h > $$1) {
   ...
   public static class a implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new guy($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gut $$8 = new guy($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
