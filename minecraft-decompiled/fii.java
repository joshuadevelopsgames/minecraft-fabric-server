...
public class fii {
   ...
   public fii(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<fij> $$1) throws IOException {
   ...
   public List<fij> a(Path $$0) throws IOException {
      List<fij> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<fij> a(Path $$0, boolean $$1) throws IOException {
      List<fij> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<fij> $$1) throws IOException {
