...
public class apg {
   ...
   public static void a(CommandDispatcher<ek> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)el.b("perf").requires(el.a(4)))
   ...
   private static void a(ek $$0, Path $$1, MinecraftServer $$2) {
      ...
      try (bbl $$7 = new bbl(bvo.a.resolve($$4))) {
   ...
   private static void a(ek $$0, btr $$1) {
      if ($$1 != btn.a) {
         int $$2 = $$1.f();
         double $$3 = (double)$$1.g() / bdg.a;
         $$0.a(() -> xo.a("commands.perf.stopped", String.format(Locale.ROOT, "%.2f", $$3), $$2, String.format(Locale.ROOT, "%.2f", $$2 / $$3)), false);
      }
   }
}
