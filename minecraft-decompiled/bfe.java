...
public class bfe extends DataFix {
   ...
   private Typed<?> a(Typed<?> $$0, Map<String, String> $$1) {
      return $$0.update(DSL.remainderFinder(), $$1x -> {
         for (Entry<String, String> $$2 : $$1.entrySet()) {
            $$1x = $$1x.renameAndFixField($$2.getKey(), $$2.getValue(), bdt::a);
         }
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      return $$0.update("frames", $$0x -> $$0x.createList($$0x.asStream().map($$0xx -> {
         $$0xx = $$0xx.renameAndFixField("Pos", "pos", bdt::a);
   ...
   public TypeRewriteRule makeRule() {
      ...
      $$0.add(
         this.writeFixAndRead(
            "BlockPos format for map frames", this.getInputSchema().getType(blp.k), this.getOutputSchema().getType(blp.k), $$0x -> $$0x.update("data", this::a)
         )
      );
      ...
      $$0.add(
         this.fixTypeEverywhereTyped(
            ...
            $$1,
            bjk.a($$1, "minecraft:compass"::equals, $$0x -> $$0x.update(DSL.remainderFinder(), $$0xx -> $$0xx.update("LodestonePos", bdt::a)))
         )
      );
   ...
   private void a(List<TypeRewriteRule> $$0) {
      $$0.add(this.a(blp.E, "minecraft:bee", Map.of("HivePos", "hive_pos", "FlowerPos", "flower_pos")));
      $$0.add(this.a(blp.E, "minecraft:end_crystal", Map.of("BeamTarget", "beam_target")));
      $$0.add(this.a(blp.E, "minecraft:wandering_trader", Map.of("WanderTarget", "wander_target")));

      for (String $$1 : a) {
         $$0.add(this.a(blp.E, $$1, Map.of("PatrolTarget", "patrol_target")));
      }

      $$0.add(
         this.fixTypeEverywhereTyped(
            "BlockPos format in Leash for mobs",
            this.getInputSchema().getType(blp.E),
            $$0x -> $$0x.update(DSL.remainderFinder(), $$0xx -> $$0xx.renameAndFixField("Leash", "leash", bdt::a))
         )
      );
   }

   private void b(List<TypeRewriteRule> $$0) {
      $$0.add(this.a(blp.t, "minecraft:beehive", Map.of("FlowerPos", "flower_pos")));
      $$0.add(this.a(blp.t, "minecraft:end_gateway", Map.of("ExitPortal", "exit_portal")));
   }
