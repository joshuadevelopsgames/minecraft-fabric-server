...
public class brq extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return brq.a(new Dynamic($$0, $$1), brq.d, brq.a);
      }
   };

   public brq(int $$0, Schema $$1) {
      super($$0, $$1);
   }

   protected static void a(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("inTile", blp.F.in($$0)));
   }

   protected static void b(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("DisplayTile", blp.F.in($$0)));
   }

   protected static void c(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("Items", DSL.list(blp.u.in($$0))));
   }

   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      Map<String, Supplier<TypeTemplate>> $$1 = Maps.newHashMap();
      $$0.register($$1, "Item", $$1x -> DSL.optionalFields("Item", blp.u.in($$0)));
      $$0.registerSimple($$1, "XPOrb");
      a($$0, $$1, "ThrownEgg");
      $$0.registerSimple($$1, "LeashKnot");
      $$0.registerSimple($$1, "Painting");
      $$0.register($$1, "Arrow", $$1x -> DSL.optionalFields("inTile", blp.F.in($$0)));
      $$0.register($$1, "TippedArrow", $$1x -> DSL.optionalFields("inTile", blp.F.in($$0)));
      $$0.register($$1, "SpectralArrow", $$1x -> DSL.optionalFields("inTile", blp.F.in($$0)));
      a($$0, $$1, "Snowball");
      a($$0, $$1, "Fireball");
      a($$0, $$1, "SmallFireball");
      a($$0, $$1, "ThrownEnderpearl");
      $$0.registerSimple($$1, "EyeOfEnderSignal");
      $$0.register($$1, "ThrownPotion", $$1x -> DSL.optionalFields("inTile", blp.F.in($$0), "Potion", blp.u.in($$0)));
      a($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", $$1x -> DSL.optionalFields("Item", blp.u.in($$0)));
      a($$0, $$1, "WitherSkull");
      $$0.registerSimple($$1, "PrimedTnt");
      $$0.register($$1, "FallingSand", $$1x -> DSL.optionalFields("Block", blp.F.in($$0), "TileEntityData", blp.t.in($$0)));
      $$0.register($$1, "FireworksRocketEntity", $$1x -> DSL.optionalFields("FireworksItem", blp.u.in($$0)));
      $$0.registerSimple($$1, "Boat");
      $$0.register($$1, "Minecart", () -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "Items", DSL.list(blp.u.in($$0))));
      b($$0, $$1, "MinecartRideable");
      $$0.register($$1, "MinecartChest", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "Items", DSL.list(blp.u.in($$0))));
      b($$0, $$1, "MinecartFurnace");
      b($$0, $$1, "MinecartTNT");
      $$0.register($$1, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", blp.F.in($$0), blp.I.in($$0)));
      $$0.register($$1, "MinecartHopper", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "Items", DSL.list(blp.u.in($$0))));
      $$0.register($$1, "MinecartCommandBlock", () -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "LastOutput", blp.A.in($$0)));
      ...
      $$0.register($$1, "Enderman", $$1x -> DSL.optionalFields("carried", blp.F.in($$0)));
      ...
      $$0.register($$1, "EntityHorse", $$1x -> DSL.optionalFields("Items", DSL.list(blp.u.in($$0)), "ArmorItem", blp.u.in($$0), "SaddleItem", blp.u.in($$0)));
      $$0.registerSimple($$1, "Rabbit");
      $$0.register(
         $$1, "Villager", $$1x -> DSL.optionalFields("Inventory", DSL.list(blp.u.in($$0)), "Offers", DSL.optionalFields("Recipes", DSL.list(blp.y.in($$0))))
      );
      $$0.registerSimple($$1, "EnderCrystal");
      $$0.register($$1, "AreaEffectCloud", $$1x -> DSL.optionalFields("Particle", blp.z.in($$0)));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "RecordPlayer", $$1x -> DSL.optionalFields("RecordItem", blp.u.in($$0)));
      c($$0, $$1, "Trap");
      c($$0, $$1, "Dropper");
      $$0.register($$1, "Sign", () -> a($$0));
      $$0.register($$1, "MobSpawner", $$1x -> blp.I.in($$0));
      $$0.registerSimple($$1, "Music");
      $$0.registerSimple($$1, "Piston");
      c($$0, $$1, "Cauldron");
      $$0.registerSimple($$1, "EnchantTable");
      $$0.registerSimple($$1, "Airportal");
      $$0.register($$1, "Control", () -> DSL.optionalFields("LastOutput", blp.A.in($$0)));
      $$0.registerSimple($$1, "Beacon");
      $$0.register($$1, "Skull", () -> DSL.optionalFields("custom_name", blp.A.in($$0)));
      $$0.registerSimple($$1, "DLDetector");
      c($$0, $$1, "Hopper");
      $$0.registerSimple($$1, "Comparator");
      $$0.register($$1, "FlowerPot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), blp.G.in($$0))));
      $$0.register($$1, "Banner", () -> DSL.optionalFields("CustomName", blp.A.in($$0)));
   ...
   public static TypeTemplate a(Schema $$0) {
      return DSL.optionalFields(
         new Pair[]{
            Pair.of("Text1", blp.A.in($$0)),
            Pair.of("Text2", blp.A.in($$0)),
            Pair.of("Text3", blp.A.in($$0)),
            Pair.of("Text4", blp.A.in($$0)),
            Pair.of("FilteredText1", blp.A.in($$0)),
            Pair.of("FilteredText2", blp.A.in($$0)),
            Pair.of("FilteredText3", blp.A.in($$0)),
            Pair.of("FilteredText4", blp.A.in($$0))
         }
      );
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, blp.c, () -> DSL.optionalFields("Inventory", DSL.list(blp.u.in($$0)), "EnderItems", DSL.list(blp.u.in($$0))));
      $$0.registerType(
         false,
         blp.d,
         () -> DSL.fields(
      ...
      $$0.registerType(true, blp.t, () -> DSL.optionalFields("components", blp.x.in($$0), DSL.taggedChoiceLazy("id", DSL.string(), $$2)));
      $$0.registerType(true, blp.D, () -> DSL.optionalFields("Riding", blp.D.in($$0), blp.E.in($$0)));
      $$0.registerType(false, blp.C, () -> DSL.constType(bnm.a()));
      $$0.registerType(
         true,
         blp.E,
         () -> DSL.and(blp.B.in($$0), DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", DSL.string(), $$1)))
      );
      $$0.registerType(
         true, blp.u, () -> DSL.hook(DSL.optionalFields("id", DSL.or(DSL.constType(DSL.intType()), blp.G.in($$0)), "tag", b($$0)), b, HookFunction.IDENTITY)
      );
      $$0.registerType(false, blp.f, DSL::remainder);
      $$0.registerType(false, blp.F, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(bnm.a())));
      $$0.registerType(false, blp.G, () -> DSL.constType(bnm.a()));
      $$0.registerType(false, blp.h, DSL::remainder);
      ...
      $$0.registerType(true, blp.B, () -> DSL.optional(DSL.field("Equipment", DSL.list(blp.u.in($$0)))));
   }

   public static TypeTemplate b(Schema $$0) {
      return DSL.optionalFields(
         new Pair[]{
            Pair.of("EntityTag", blp.D.in($$0)),
            Pair.of("BlockEntityTag", blp.t.in($$0)),
            Pair.of("CanDestroy", DSL.list(blp.F.in($$0))),
            Pair.of("CanPlaceOn", DSL.list(blp.F.in($$0))),
            Pair.of("Items", DSL.list(blp.u.in($$0))),
            Pair.of("ChargedProjectiles", DSL.list(blp.u.in($$0))),
            Pair.of("pages", DSL.list(blp.A.in($$0))),
            Pair.of("filtered_pages", DSL.compoundList(blp.A.in($$0))),
            Pair.of("display", DSL.optionalFields("Name", blp.A.in($$0), "Lore", DSL.list(blp.A.in($$0))))
         }
      );
   }
   ...
   protected static <T> T a(Dynamic<T> $$0, Map<String, String> $$1, Map<String, String> $$2) {
      return (T)$$0.update("tag", $$3 -> $$3.update("BlockEntityTag", $$2xx -> {
         String $$3x = $$0.get("id").asString().result().map(bnm::a).orElse("minecraft:air");
         ...
         if ($$2xx.get("id").result().isPresent()) {
            ...
            String $$3x = bnm.a($$0.get("id").asString(""));
            String $$4 = $$2.get($$3x);
