...
public class fuc implements Comparable<fuc> {
   private static final Map<String, fuc> h = Maps.newHashMap();
   private static final Map<fna.a, fuc> i = Maps.newHashMap();
   ...
   private final fna.a m;
   private final String n;
   private fna.a o;
   private boolean p;
   private int q;

   public static void a(fna.a $$0) {
      fuc $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(fna.a $$0, boolean $$1) {
      fuc $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (fuc $$0 : h.values()) {
         if ($$0.o.a() == fna.b.a && $$0.o.b() != fna.bv.b()) {
            $$0.a(fna.a(fue.R().aP().h(), $$0.o.b()));
         }
      }
   }
   ...
   public fuc(String $$0, int $$1, String $$2) {
      this($$0, fna.b.a, $$1, $$2);
   }

   public fuc(String $$0, fna.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(fna.a $$0) {
      this.o = $$0;
   }

   public int a(fuc $$0) {
      return this.n.equals($$0.n) ? htb.a(this.l).compareTo(htb.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(fuc $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(fna.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == fna.bv.b() ? this.o.a() == fna.b.b && this.o.b() == $$1 : this.o.a() == fna.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == fna.b.c && this.o.b() == $$0;
   }
