...
public abstract class ud {
   ...
   private static volatile ud e = c();
   ...
   private static ud c() {
      ...
      return new ud() {
         ...
         @Override
         public bbm a(xt $$0) {
            return $$1x -> $$0.a(($$1xx, $$2x) -> bcz.c($$2x, $$1xx, $$1) ? Optional.empty() : xt.a, yl.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = ud.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(bbq.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract bbm a(xt var1);

   public List<bbm> a(List<xt> $$0) {
