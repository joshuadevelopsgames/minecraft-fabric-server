...
public class fop {
   public static List<fqi> a(fop.a... $$0) {
      for (fop.a $$1 : $$0) {
         a($$1.j);
      }

      List<fqi> $$2 = Lists.newArrayList();

      for (fop.a $$3 : $$0) {
         $$2.add(new fqi($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fqi::a));
      return $$2;
   }
   ...
   public static List<fqi> a() {
      return a(fop.a.values());
   }
