...
public enum fjo implements bda {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bda.a<fjo> t = bda.a(fjo::values);
   public static final IntFunction<fjo> u = baq.a(fjo::a, values(), baq.a.a);
   private final int v;
   private final String w;

   private fjo(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
