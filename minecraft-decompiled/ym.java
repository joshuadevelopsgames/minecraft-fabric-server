...
public class ym {
   ...
   public List<bbm> a(int $$0, int $$1, boolean $$2) {
      if ($$1 == 0) {
         ...
         for (int $$6 = 1; $$6 < $$1; $$6++) {
            ...
            if (!$$8.equals($$4)) {
               ...
               $$3.add($$2 ? bbm.backward($$9, $$4, this.c) : bbm.forward($$9, $$4));
               $$4 = $$8;
               $$5 = $$7;
            }
         }
         ...
         if ($$5 < $$0 + $$1) {
            ...
            $$3.add($$2 ? bbm.backward($$10, $$4, this.c) : bbm.forward($$10, $$4));
         }
