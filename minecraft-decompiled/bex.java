...
public class bex extends bkj {
   public bex(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", blp.t, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(blp.t, "minecraft:jukebox");
