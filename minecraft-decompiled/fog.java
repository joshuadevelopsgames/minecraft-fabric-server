...
public interface fog {
   fog a(float var1, float var2, float var3);

   fog a(int var1, int var2, int var3, int var4);

   fog a(float var1, float var2);

   fog a(int var1, int var2);

   fog b(int var1, int var2);

   fog b(float var1, float var2, float var3);
   ...
   default fog a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default fog a(int $$0) {
      return this.a(baj.b($$0), baj.c($$0), baj.d($$0), baj.a($$0));
   }

   default fog d(int $$0) {
      return this.a(baj.c($$0, -1));
   }
   ...
   default void a(fod.a $$0, gyv $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(fod.a $$0, gyv $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      Vector3fc $$11 = $$1.d().s();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(fob.c.getVertexSize());
         ...
         for (int $$21 = 0; $$21 < $$15; $$21++) {
            ...
            float $$30;
            if ($$9) {
               float $$25 = $$19.get(12) & 255;
               float $$26 = $$19.get(13) & 255;
               float $$27 = $$19.get(14) & 255;
               $$28 = $$25 * $$2[$$21] * $$3;
               $$29 = $$26 * $$2[$$21] * $$4;
               $$30 = $$27 * $$2[$$21] * $$5;
            } else {
            ...
            int $$34 = baj.a($$16, (int)$$28, (int)$$29, (int)$$30);
            int $$35 = gxj.b($$7[$$21], $$17);
   ...
   default fog a(Vector3f $$0) {
      return this.a($$0.x(), $$0.y(), $$0.z());
   }

   default fog a(fod.a $$0, Vector3f $$1) {
      return this.a($$0, $$1.x(), $$1.y(), $$1.z());
   }

   default fog a(fod.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default fog a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a($$4.x(), $$4.y(), $$4.z());
   }

   default fog a(Matrix3x2f $$0, float $$1, float $$2, float $$3) {
      Vector2f $$4 = $$0.transformPosition($$1, $$2, new Vector2f());
      return this.a($$4.x(), $$4.y(), $$3);
   }

   default fog b(fod.a $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.a($$1, $$2, $$3, new Vector3f());
      return this.b($$4.x(), $$4.y(), $$4.z());
   }

   default fog b(fod.a $$0, Vector3f $$1) {
