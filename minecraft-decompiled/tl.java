...
public class tl implements tz {
   private final Document a;
   private final Element b;
   private final Stopwatch c;
   private final File d;

   public tl(File $$0) throws ParserConfigurationException {
      this.d = $$0;
   ...
   private Element a(sz $$0, String $$1) {
      ...
      $$2.setAttribute("time", String.valueOf($$0.l() / 1000.0));
   ...
   public void a() {
      this.c.stop();
      this.b.setAttribute("time", String.valueOf(this.c.elapsed(TimeUnit.MILLISECONDS) / 1000.0));
