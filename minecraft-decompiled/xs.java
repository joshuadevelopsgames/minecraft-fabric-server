...
public class xs {
   public static final Codec<xs> a = bda.a(xs.a::values).dispatch(xs::c, xs.a::a);
   public static final xs b = new xs(new BitSet(0), xs.a.b);
   public static final xs c = new xs(new BitSet(0), xs.a.a);
   public static final yl d = yl.a.a(o.i).a(new xu.e(xo.c("chat.filtered")));
   static final MapCodec<xs> e = MapCodec.unit(c);
   static final MapCodec<xs> f = MapCodec.unit(b);
   static final MapCodec<xs> g = bbi.z.xmap(xs::new, xs::d).fieldOf("value");
   ...
   public static void a(wg $$0, xs $$1) {
      $$0.a($$1.j);
      if ($$1.j == xs.a.c) {
         $$0.a($$1.i);
      }
