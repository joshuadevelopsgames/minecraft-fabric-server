...
public class bwa {
   ...
   public static <K, U, V> CompletableFuture<Map<K, V>> a(Map<K, U> $$0, BiFunction<K, U, V> $$1, int $$2, Executor $$3) {
      ...
      if ($$4 == 0) {
         ...
         bwa.d<K, U, V> $$8 = (bwa.d<K, U, V>)($$4 <= $$2 ? new bwa.c<>($$1, $$4) : new bwa.a<>($$1, $$4, $$2));
         return $$8.a($$0, $$3);
      }
   }
   ...
   static class a<K, U, V> extends bwa.d<K, U, V> {
      ...
      @Override
      protected CompletableFuture<?> a(bwa.b<K, U, V> $$0, int $$1, int $$2, Executor $$3) {
         int $$4 = $$2 - $$1;
      ...
      private static <K, U, V> Runnable a(Map<K, V> $$0, int $$1, int $$2, bwa.b<K, U, V> $$3) {
         return () -> {
            for (int $$4 = $$1; $$4 < $$2; $$4++) {
               $$3.a($$4);
            }
      ...
      @Override
      protected CompletableFuture<Map<K, V>> a(CompletableFuture<?> $$0, bwa.b<K, U, V> $$1) {
         Map<K, V> $$2 = this.c;
         return $$0.thenApply($$1x -> $$2);
      }
   }

   record b<K, U, V>(BiFunction<K, U, V> a, Object[] b, Object[] c) {
   ...
   static class c<K, U, V> extends bwa.d<K, U, V> {
   ...
   abstract static class d<K, U, V> {
      ...
      private int e;
      private final bwa.b<K, U, V> f;

      d(BiFunction<K, U, V> $$0, int $$1, int $$2) {
         this.f = new bwa.b<>($$0, $$1);
      ...
      protected abstract CompletableFuture<?> a(bwa.b<K, U, V> var1, int var2, int var3, Executor var4);

      protected abstract CompletableFuture<Map<K, V>> a(CompletableFuture<?> var1, bwa.b<K, U, V> var2);
   }
}
