...
public class ur {
   ...
   public static ur a() {
      return new ur(Long.MAX_VALUE, 512);
   }
   ...
   public void b(long $$0) {
      if ($$0 < 0L) {
         ...
         throw new us("Tried to read NBT tag that was too big; tried to allocate: " + this.c + " + " + $$0 + " bytes where max allowed: " + this.b);
      } else {
         this.c += $$0;
      }
   }
