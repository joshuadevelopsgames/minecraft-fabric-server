...
public class bax {
   ...
   public static SecretKey a() throws bay {
      try {
   ...
   public static KeyPair b() throws bay {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws bay {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, bax.a<T> $$3) throws bay {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws bay {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", bax::b);
   }

   public static PublicKey b(String $$0) throws bay {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", bax::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws bay {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws bay {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws bay {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws bay {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws bay {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws bay {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws bay {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws bay;
   }

   public record b(long b, byte[] c) {
      public static final bax.b a = new bax.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(wg $$0, bax.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
