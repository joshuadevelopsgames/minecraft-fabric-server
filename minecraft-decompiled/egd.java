...
public class egd {
   ...
   public egd(byte[] $$0) {
      ...
      this.f = 0;
      if ($$0.length != 2048) {
         throw (IllegalArgumentException)ag.b(new IllegalArgumentException("DataLayer should be 2048 bytes not: " + $$0.length));
      }
   }
   ...
   public egd b() {
      return this.d == null ? new egd(this.f) : new egd((byte[])this.d.clone());
   }
