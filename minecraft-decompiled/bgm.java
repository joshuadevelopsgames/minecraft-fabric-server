...
public class bgm extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$2 = DSL.fieldFinder("id", DSL.named(blp.G.typeName(), bnm.a()));
      OpticFinder<?> $$3 = $$1.findField("tag");
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(blp.E), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(blp.c), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
