...
public class bsb {
   ...
   private bsb(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bsb a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bsb($$0, $$1);
   }

   public bsb.d a() throws IOException {
      bsb.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bsb.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bsb.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bsb.c $$3 = bsb.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bsb.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bsb.a($$0, $$3);
            }
         }
   ...
   public bsb.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bsb.c> $$2 = this.a().c();
      ...
      bsb.e $$4 = new bsb.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public record a(Path a, bsb.c b) implements bsb.b {
      @Nullable
      @Override
   ...
   public record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bsb.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bsb.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bsb.b> {
      private final List<bsb.b> a;

      d(List<bsb.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bsb.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bsb.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bsb.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bsb.d a() {
         ListIterator<bsb.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bsb.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bsb.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bsb.b> b() {
         return this.a.stream();
      }

      public Set<bsb.c> c() {
         return this.a.stream().map(bsb.b::d).collect(Collectors.toSet());
      }
   }

   public record e(Path a, bsb.c b) implements bsb.b {
