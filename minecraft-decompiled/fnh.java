...
public final class fnh {
   ...
   public fnh(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static Optional<fnh> a(@Nullable String $$0) {
      if ($$0 == null) {
         ...
         try {
            ...
            if ($$1.matches()) {
               ...
               int $$10 = $$8 / 3;
               return Optional.of(new fnh($$2, $$3, $$10, $$10, $$10, $$5));
            }
