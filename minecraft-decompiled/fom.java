...
public enum fom {
   ...
   public static double a(long $$0, fom $$1) {
      return $$1 == a ? $$0 : $$0 / Math.pow(1024.0, $$1.ordinal());
   }
   ...
   public static String b(long $$0) {
      ...
      if ($$0 < 1024L) {
         ...
         return String.format(Locale.ROOT, "%.1f %sB", $$0 / Math.pow(1024.0, $$2), $$3);
      }
   }

   public static String b(long $$0, fom $$1) {
