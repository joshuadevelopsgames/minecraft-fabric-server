...
public class bob extends bnm {
               ...
               $$2.get("CriteriaName")
                  ...
                  .map($$0x -> {
                     ...
                     if ($$1x < 0) {
                        ...
                        try {
                           ame $$2x = ame.a($$0x.substring(0, $$1x), '.');
                           ame $$3 = ame.a($$0x.substring($$1x + 1), '.');
      ...
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         ...
         Optional<Dynamic<T>> $$3 = $$2.get("CriteriaType").get().result().flatMap($$1x -> {
            ...
            if ($$2x.isPresent() && $$3x.isPresent()) {
               String $$4 = $$2x.get();
               return $$4.equals("_special") ? Optional.of($$2.createString($$3x.get())) : Optional.of($$1x.createString(bob.b($$4) + ":" + bob.b($$3x.get())));
            } else {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(
         false, blp.K, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4), "DisplayName", blp.A.in($$0)), c, d)
      );
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", blp.G.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", blp.F.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", blp.C.in($$0));
