...
public enum h implements bda {
   ...
   private static final jh.a[] X = jh.a.values();
   private final Matrix3fc Y;
   private final String Z;
   @Nullable
   private Map<jh, jh> aa;
   ...
   public jh a(jh $$0) {
      if (this.aa == null) {
         this.aa = ag.a(jh.class, $$0x -> {
            jh.a $$1 = $$0x.o();
            jh.b $$2 = $$0x.f();
            jh.a $$3 = this.b($$1);
            jh.b $$4 = this.a($$3) ? $$2.c() : $$2;
            return jh.a($$3, $$4);
         });
      }
   ...
   public jh.a b(jh.a $$0) {
      return X[this.ae.a($$0.ordinal())];
   }

   public jj a(jj $$0) {
      return jj.a(this.a($$0.a()), this.a($$0.b()));
   }
