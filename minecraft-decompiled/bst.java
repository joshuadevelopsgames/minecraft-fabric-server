...
public final class bst {
   ...
   public void d() {
      for (int $$0 = this.f; $$0 > this.g; $$0 -= 2) {
         assert this.e[$$0] instanceof bsj;
   ...
   public <T> void a(bsj<T> $$0, @Nullable T $$1) {
      int $$2 = this.c($$0);
      if ($$2 != -1) {
         this.e[$$2] = $$1;
      } else {
   ...
   @Nullable
   public <T> T a(bsj<T> $$0) {
      int $$1 = this.c($$0);
      return (T)($$1 != -1 ? this.e[$$1] : null);
   }

   public <T> T b(bsj<T> $$0) {
      int $$1 = this.c($$0);
      if ($$1 == -1) {
   ...
   @Nullable
   @SafeVarargs
   public final <T> T b(bsj<? extends T>... $$0) {
      int $$1 = this.a($$0);
      return (T)($$1 != -1 ? this.e[$$1] : null);
   }

   @SafeVarargs
   public final <T> T c(bsj<? extends T>... $$0) {
      int $$1 = this.a($$0);
      if ($$1 == -1) {
   ...
   @VisibleForTesting
   public Map<bsj<?>, ?> f() {
      HashMap<bsj<?>, Object> $$0 = new HashMap<>();
