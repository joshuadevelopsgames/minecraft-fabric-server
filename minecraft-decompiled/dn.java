...
public class dn extends dl<dn.a> {
   ...
   public void a(auc $$0, eeb $$1) {
      this.a($$0, $$1x -> $$1x.a($$1));
   }

   public record a(Optional<bj> b, Optional<jl<dpz>> c, Optional<ds> d) implements dl.a {
      public static final Codec<dn.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                  bz.b.optionalFieldOf("player").forGetter(dn.a::a),
                  mm.e.r().optionalFieldOf("block").forGetter(dn.a::b),
      ...
      private static DataResult<dn.a> a(dn.a $$0) {
         return $$0.c
            .<DataResult<dn.a>>flatMap(
               $$1 -> $$0.d.<String>flatMap($$1x -> $$1x.a(((dpz)$$1.a()).l())).map($$1x -> DataResult.error(() -> "Block" + $$1 + " has no property " + $$1x))
            )
            .orElseGet(() -> DataResult.success($$0));
      }

      public static ar<dn.a> a(dpz $$0) {
