...
public class bre extends bnm {
   public bre(int $$0, Schema $$1) {
      super($$0, $$1);
   }

   public static SequencedMap<String, Supplier<TypeTemplate>> a(Schema $$0) {
      SequencedMap<String, Supplier<TypeTemplate>> $$1 = bqu.a($$0);
   ...
   private static TypeTemplate b(Schema $$0) {
      TypeTemplate $$1 = DSL.optionalFields("blocks", DSL.or(blp.F.in($$0), DSL.list(blp.F.in($$0))));
