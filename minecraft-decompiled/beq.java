...
public class beq extends DataFix {
   ...
   private static Dynamic<?> a(Dynamic<?> $$0, OptionalDynamic<?> $$1) {
      ...
      if ($$2 && $$3.isPresent()) {
         String $$4 = bnm.a($$3.get().asString("empty"));
         Optional<? extends Dynamic<?>> $$5 = $$0.get("below_zero_retrogen").result();
         if (!b.contains($$4)) {
            $$0 = a($$0, 384, -64);
         } else if ($$5.isPresent()) {
            Dynamic<?> $$6 = (Dynamic<?>)$$5.get();
            String $$7 = bnm.a($$6.get("target_status").asString("empty"));
            if (!b.contains($$7)) {
               $$0 = a($$0, 256, 0);
            }
         }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0, int $$1, int $$2) {
      return $$0.set(
         "blending_data",
         $$0.createMap(Map.of($$0.createString("min_section"), $$0.createInt(ke.a($$2)), $$0.createString("max_section"), $$0.createInt(ke.a($$2 + $$1))))
      );
   }
}
