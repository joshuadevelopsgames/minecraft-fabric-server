...
public class bfw extends DataFix {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$7x -> $$7x.updateTyped(
            ...
            $$6xx -> {
               ...
               Int2ObjectMap<Supplier<bfw.a>> $$9 = new Int2ObjectArrayMap();
                                       ...
                                       $$3xxxxx -> $$9.put(
                                          ...
                                          Suppliers.memoize(
                                             () -> {
                                                ...
                                                return new bfw.a($$2xxxxxx, $$3xxxxxx);
                                             }
                                          )
                                       )
                                    );
               ...
               if (!$$6xx.getOptionalTyped($$7).isPresent() && !$$7xx.get("fluid_ticks").result().isPresent()) {
                  ...
                  Dynamic<?> $$13 = this.a($$7xx, $$9, $$10, $$11, $$12, "LiquidsToBeTicked", bfw::b);
                  Dynamic<?> $$14 = this.a($$7xx, $$9, $$10, $$11, $$12, "ToBeTicked", bfw::a);
   ...
   private Dynamic<?> a(Dynamic<?> $$0, Int2ObjectMap<Supplier<bfw.a>> $$1, byte $$2, int $$3, int $$4, String $$5, Function<Dynamic<?>, String> $$6) {
      Stream<Dynamic<?>> $$7 = Stream.empty();
      List<? extends Dynamic<?>> $$8 = $$0.get($$5).asList(Function.identity());

      for (int $$9 = 0; $$9 < $$8.size(); $$9++) {
         int $$10 = $$9 + $$2;
         Supplier<bfw.a> $$11 = (Supplier<bfw.a>)$$1.get($$10);
   ...
   private Dynamic<?> a(Dynamic<?> $$0, @Nullable Supplier<bfw.a> $$1, int $$2, int $$3, int $$4, int $$5, Function<Dynamic<?>, String> $$6) {
      int $$7 = $$5 & 15;
      int $$8 = $$5 >>> 4 & 15;
      int $$9 = $$5 >>> 8 & 15;
   ...
   public static final class a {
      ...
      public a(List<? extends Dynamic<?>> $$0, long[] $$1) {
         this.b = $$0;
         this.c = $$1;
         this.d = Math.max(4, bft.a($$0.size()));
         this.e = (1L << this.d) - 1L;
