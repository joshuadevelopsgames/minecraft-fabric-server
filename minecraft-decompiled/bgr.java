...
public class bgr extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> $$4 = DSL.and(
         DSL.optional(DSL.field("inTile", DSL.named(blp.F.typeName(), DSL.or(DSL.intType(), bnm.a())))), DSL.remainderType()
      );
      Function<Typed<?>, Typed<?>> $$5 = $$1x -> $$1x.update($$4.finder(), DSL.remainderType(), Pair::getSecond);
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", $$0.getType(blp.E), $$1.getType(blp.E), $$3x -> {
   ...
   private Typed<?> a(Typed<?> $$0) {
      Type<Either<Pair<String, Either<Integer, String>>, Unit>> $$1 = DSL.optional(
         DSL.field("Block", DSL.named(blp.F.typeName(), DSL.or(DSL.intType(), bnm.a())))
      );
      Type<Either<Pair<String, Dynamic<?>>, Unit>> $$2 = DSL.optional(DSL.field("BlockState", DSL.named(blp.v.typeName(), DSL.remainderType())));
      Dynamic<?> $$3 = (Dynamic<?>)$$0.get(DSL.remainderFinder());
      return $$0.update($$1.finder(), $$2, $$1x -> {
         int $$2x = (Integer)$$1x.map($$0xx -> (Integer)((Either)$$0xx.getSecond()).map($$0xxx -> $$0xxx, bgr::a), $$1xx -> {
         ...
         return Either.left(Pair.of(blp.v.typeName(), bfh.b($$2x << 4 | $$3x)));
      }).set(DSL.remainderFinder(), $$3.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> a(Typed<?> $$0, String $$1, String $$2, String $$3) {
      Type<Pair<String, Either<Integer, String>>> $$4 = DSL.field($$1, DSL.named(blp.F.typeName(), DSL.or(DSL.intType(), bnm.a())));
      Type<Pair<String, Dynamic<?>>> $$5 = DSL.field($$3, DSL.named(blp.v.typeName(), DSL.remainderType()));
      Dynamic<?> $$6 = (Dynamic<?>)$$0.getOrCreate(DSL.remainderFinder());
      return $$0.update($$4.finder(), $$5, $$2x -> {
         int $$3x = (Integer)((Either)$$2x.getSecond()).map($$0xx -> $$0xx, bgr::a);
         int $$4x = $$6.get($$2).asInt(0) & 15;
         return Pair.of(blp.v.typeName(), bfh.b($$3x << 4 | $$4x));
