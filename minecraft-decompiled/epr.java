...
public class epr implements epm {
   public static final Codec<epr> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            mm.e.q().fieldOf("block").flatXmap(epr::a, DataResult::success).orElse((dvh)dqb.fy).forGetter($$0x -> $$0x.b),
            ...
            ka.a(mn.i).fieldOf("can_be_placed_on").forGetter($$0x -> $$0x.h)
         )
         .apply($$0, epr::new)
   );
   public final dvh b;
   ...
   private final ObjectArrayList<jh> i;

   private static DataResult<dvh> a(dpz $$0) {
      return $$0 instanceof dvh $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface spreadeable block");
   }

   public epr(dvh $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jp<dpz> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
      ...
      if ($$4) {
         jh.c.a.forEach(this.i::add);
      }
   }

   public List<jh> a(bck $$0, jh $$1) {
      return ag.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<jh> a(bck $$0) {
