...
public class exy extends eyn {
   public static final MapCodec<exy> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
            ...
            jh.a.e.fieldOf("axis").orElse(jh.a.b).forGetter($$0x -> $$0x.g)
         )
         .apply($$0, exy::new)
   );
   ...
   public exy(float $$0, float $$1, int $$2, int $$3, jh.a $$4) {
      if ($$2 >= $$3) {
   ...
   public boolean a(jb $$0, jb $$1, jb $$2, bck $$3) {
      jh $$4 = jh.a(jh.b.a, this.g);
      float $$5 = Math.abs(($$1.u() - $$2.u()) * $$4.j());
      float $$6 = Math.abs(($$1.v() - $$2.v()) * $$4.k());
      float $$7 = Math.abs(($$1.w() - $$2.w()) * $$4.l());
      int $$8 = (int)($$5 + $$6 + $$7);
      float $$9 = $$3.i();
      return $$9 <= bcb.b(this.b, this.d, bcb.f((float)$$8, (float)this.e, (float)this.f));
   }
