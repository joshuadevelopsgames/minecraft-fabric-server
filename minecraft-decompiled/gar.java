...
public class gar {
   ...
   public gar(Supplier<String> $$0, Consumer<String> $$1, Supplier<String> $$2, Consumer<String> $$3, Predicate<String> $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static Supplier<String> a(fue $$0) {
      return () -> b($$0);
   }

   public static String b(fue $$0) {
      return o.a($$0.p.a().replaceAll("\\r", ""));
   }

   public static Consumer<String> c(fue $$0) {
      return $$1 -> a($$0, $$1);
   }
   ...
   private int h(int $$0) {
      return bcb.a($$0, 0, this.a.get().length());
   }
   ...
   private void a(String $$0, String $$1) {
      ...
      this.f = bcb.a(this.f, 0, $$0.length());
   ...
   public void a(int $$0, boolean $$1, gar.a $$2) {
      switch ($$2) {
         case a:
            this.a($$0, $$1);
            break;
   ...
   public void b(int $$0, boolean $$1) {
      this.f = fuo.a(this.a.get(), $$0, this.f, true);
      this.c($$1);
   }

   public void a(int $$0, gar.a $$1) {
      switch ($$1) {
         case a:
            this.e($$0);
            break;
   ...
   public void d(int $$0) {
      int $$1 = fuo.a(this.a.get(), $$0, this.f, true);
      this.e($$1 - this.f);
   }
