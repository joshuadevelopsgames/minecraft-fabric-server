...
public class epp implements epm {
   public static final Codec<epp> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ...
            bwo.b(1, 60).fieldOf("column_radius").forGetter($$0x -> $$0x.c),
            bwm.a(0.0F, 20.0F).fieldOf("height_scale").forGetter($$0x -> $$0x.d),
            Codec.floatRange(0.1F, 1.0F).fieldOf("max_column_radius_to_cave_height_ratio").forGetter($$0x -> $$0x.e),
            bwm.a(0.1F, 10.0F).fieldOf("stalactite_bluntness").forGetter($$0x -> $$0x.f),
            bwm.a(0.1F, 10.0F).fieldOf("stalagmite_bluntness").forGetter($$0x -> $$0x.g),
            bwm.a(0.0F, 2.0F).fieldOf("wind_speed").forGetter($$0x -> $$0x.h),
   ...
   public epp(int $$0, bwo $$1, bwm $$2, float $$3, bwm $$4, bwm $$5, bwm $$6, int $$7, float $$8) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
