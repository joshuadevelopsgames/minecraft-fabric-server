...
public class flt implements flq {
   @Nullable
   private ByteBuffer b;
   @Nullable
   private FT_Face c;
   final float d;
   private final gal<flt.b> e = new gal<>(flt.b[]::new, flt.b[][]::new);

   public flt(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$12 = gay.a(FT_Vector.malloc($$11), $$9, $$10);
         ...
         while (true) {
            ...
            if (!$$7.contains($$14)) {
               this.e.a($$14, new flt.b($$15));
            }

            $$14 = (int)FreeType.FT_Get_Next_Char($$1, $$14, $$13);
         }
   ...
   private flp a(int $$0, FT_Face $$1, int $$2) {
      int $$3 = FreeType.FT_Load_Glyph($$1, $$2, 4194312);
      if ($$3 != 0) {
         gay.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
      ...
      if ($$4 == null) {
         ...
         float $$5 = gay.a($$4.advance());
         FT_Bitmap $$6 = $$4.bitmap();
         int $$7 = $$4.bitmap_left();
         int $$8 = $$4.bitmap_top();
         int $$9 = $$6.width();
         int $$10 = $$6.rows();
         return (flp)($$9 > 0 && $$10 > 0 ? new flt.a($$7, $$8, $$9, $$10, $$5, $$2) : () -> $$5 / this.d);
      }
   }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (gay.a) {
            gay.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
      ...
      public gas bake(Function<flr, gas> $$0) {
         return $$0.apply(new flr() {
            ...
            public void a(int $$0, int $$1, GpuTexture $$2) {
               FT_Face $$3 = flt.this.b();

               try (fnf $$4 = new fnf(fnf.a.d, a.this.b, a.this.c, false)) {
                  if ($$4.a($$3, a.this.g)) {
