...
public interface bbb<C, I extends bdh<C>> extends bdh<C> {
   ...
   bbb<C, I> a(bbb.d<I> var1);

   static <C, I extends bdh<C>> Codec<bbb<C, I>> a(Codec<I> $$0) {
      MutableObject<Codec<bbb<C, I>>> $$1 = new MutableObject();

      record a<C, I extends bdh<C>>(float a, bbb<C, I> b, float c) {
      }
      ...
      Codec<bbb.e<C, I>> $$3 = RecordCodecBuilder.create(
         $$2x -> $$2x.group(
               $$0.fieldOf("coordinate").forGetter(bbb.e::d),
               bbi.b($$2.listOf())
                  .fieldOf("points")
                  .forGetter(
                     $$0xx -> IntStream.range(0, $$0xx.c.length)
                        .mapToObj($$1xx -> new a($$0xx.e()[$$1xx], (bbb<C, I>)$$0xx.f().get($$1xx), $$0xx.g()[$$1xx]))
                        .toList()
                  )
            )
            .apply($$2x, ($$0xx, $$1xx) -> {
               float[] $$2xx = new float[$$1xx.size()];
               Builder<bbb<C, I>> $$3x = ImmutableList.builder();
               ...
               return bbb.e.a((I)$$0xx, $$2xx, $$3x.build(), $$4);
            })
      );
      $$1.setValue(
         Codec.either(Codec.FLOAT, $$3)
            .xmap(
               $$0x -> (bbb)$$0x.map(bbb.c::new, $$0xx -> $$0xx), $$0x -> $$0x instanceof bbb.c<C, I> $$1x ? Either.left($$1x.d()) : Either.right((bbb.e)$$0x)
            )
      );
      return (Codec<bbb<C, I>>)$$1.getValue();
   }

   static <C, I extends bdh<C>> bbb<C, I> a(float $$0) {
      return new bbb.c<>($$0);
   }

   static <C, I extends bdh<C>> bbb.b<C, I> a(I $$0) {
      return new bbb.b<>($$0);
   }

   static <C, I extends bdh<C>> bbb.b<C, I> a(I $$0, bdh<Float> $$1) {
      return new bbb.b<>($$0, $$1);
   }
   ...
   public static final class b<C, I extends bdh<C>> {
      ...
      private final List<bbb<C, I>> d = Lists.newArrayList();
      ...
      protected b(I $$0, bdh<Float> $$1) {
         this.a = $$0;
         this.b = $$1;
      }

      public bbb.b<C, I> a(float $$0, float $$1) {
         return this.a($$0, new bbb.c<>(this.b.a($$1)), 0.0F);
      }

      public bbb.b<C, I> a(float $$0, float $$1, float $$2) {
         return this.a($$0, new bbb.c<>(this.b.a($$1)), $$2);
      }

      public bbb.b<C, I> a(float $$0, bbb<C, I> $$1) {
         return this.a($$0, $$1, 0.0F);
      }

      private bbb.b<C, I> a(float $$0, bbb<C, I> $$1, float $$2) {
      ...
      public bbb<C, I> a() {
         if (this.c.isEmpty()) {
            ...
            return bbb.e.a(this.a, this.c.toFloatArray(), ImmutableList.copyOf(this.d), this.e.toFloatArray());
         }
      }
   }

   @bdl
   public record c<C, I extends bdh<C>>(float b) implements bbb<C, I> {
      @Override
      public float a(C $$0) {
         return this.b;
      }
   ...
   @bdl
   public record e<C, I extends bdh<C>>(I b, float[] c, List<bbb<C, I>> d, float[] e, float f, float g) implements bbb<C, I> {

      public e(I b, float[] c, List<bbb<C, I>> d, float[] e, float f, float g) {
         a(c, d, e);
         this.b = b;
         this.c = c;
         this.d = d;
      ...
      static <C, I extends bdh<C>> bbb.e<C, I> a(I $$0, float[] $$1, List<bbb<C, I>> $$2, float[] $$3) {
         a($$1, $$2, $$3);
         int $$4 = $$1.length - 1;
      ...
      private static <C, I extends bdh<C>> void a(float[] $$0, List<bbb<C, I>> $$1, float[] $$2) {
      ...
      public float a(C $$0) {
         ...
         if ($$2 < 0) {
            ...
            float $$5 = this.c[$$2 + 1];
            float $$6 = ($$1 - $$4) / ($$5 - $$4);
            bdh<C> $$7 = (bdh<C>)this.d.get($$2);
            bdh<C> $$8 = (bdh<C>)this.d.get($$2 + 1);
            float $$9 = this.e[$$2];
            float $$10 = this.e[$$2 + 1];
            float $$11 = $$7.a($$0);
            float $$12 = $$8.a($$0);
            ...
            return bcb.h($$6, $$11, $$12) + $$6 * (1.0F - $$6) * bcb.h($$6, $$13, $$14);
         }
      }

      private static int a(float[] $$0, float $$1) {
         return bcb.a(0, $$0.length, $$2 -> $$1 < $$0[$$2]) - 1;
      }
      ...
      public String a() {
         return "Spline{coordinate="
            ...
            + this.a(this.e)
            + ", values="
            + this.d.stream().map(bbb::a).collect(Collectors.joining(", ", "[", "]"))
            + "}";
      }
