...
public class baz {
   ...
   baz(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static baz.a a() {
      return new baz.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(baz::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public baz.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public baz a(Writer $$0) throws IOException {
         return new baz($$0, this.a);
      }
   }
}
