...
public class bcv<T> extends AbstractSet<T> {
   private static final int a = 10;
   private final Comparator<T> b;
   T[] c;
   int d;

   private bcv(int $$0, Comparator<T> $$1) {
      this.b = $$1;
      if ($$0 < 0) {
   ...
   public static <T extends Comparable<T>> bcv<T> a() {
      return a(10);
   }

   public static <T extends Comparable<T>> bcv<T> a(int $$0) {
      return new bcv<>($$0, Comparator.naturalOrder());
   }

   public static <T> bcv<T> a(Comparator<T> $$0) {
      return a($$0, 10);
   }

   public static <T> bcv<T> a(Comparator<T> $$0, int $$1) {
      return new bcv<>($$1, $$0);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof bcv<?> $$1 && this.b.equals($$1.b) ? this.d == $$1.d && Arrays.equals(this.c, $$1.c) : super.equals($$0);
      }
   }
   ...
   class a implements Iterator<T> {
      ...
      public boolean hasNext() {
         return this.b < bcv.this.d;
      }

      @Override
      public T next() {
         if (this.b >= bcv.this.d) {
            throw new NoSuchElementException();
         } else {
            this.c = this.b++;
            return bcv.this.c[this.c];
         }
      }
