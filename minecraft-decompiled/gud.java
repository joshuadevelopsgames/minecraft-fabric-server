...
public class gud {
   public static class a implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gud.b $$8 = new gud.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gvt {
      b(grk $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public void a(fog $$0, ftm $$1, float $$2) {
         this.e(0.6F - (this.s + $$2 - 1.0F) * 0.25F * 0.5F);
         super.a($$0, $$1, $$2);
      }

      @Override
      public float b(float $$0) {
         return 7.1F * bcb.a((this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends gvf {
      private boolean b;
      private boolean F;
      private final guv G;
      private float H;
      ...
      c(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, guv $$7, gvo $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gud.c $$0 = new gud.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gud.c $$8 = new gud.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fue.R().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gur {
      ...
      public e(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, guv $$7, List<dfj> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, aza.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gut $$12 = this.E.a(me.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a(baj.b($$11) / 255.0F, baj.c($$11) / 255.0F, baj.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               ayy $$14 = $$13 ? ayz.jF : ayz.jE;
               this.c.a(this.g, this.h, this.i, $$14, aza.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
         ...
         for (int $$9 = -$$1; $$9 <= $$1; $$9++) {
            for (int $$10 = -$$1; $$10 <= $$1; $$10++) {
               for (int $$11 = -$$1; $$11 <= $$1; $$11++) {
                  double $$12 = $$10 + (this.r.j() - this.r.j()) * 0.5;
                  double $$13 = $$9 + (this.r.j() - this.r.j()) * 0.5;
                  double $$14 = $$11 + (this.r.j() - this.r.j()) * 0.5;
      ...
      private void a(double $$0, double[][] $$1, IntList $$2, IntList $$3, boolean $$4, boolean $$5, boolean $$6) {
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            double $$12 = $$9 + $$11 * (float) Math.PI * $$10;
            double $$13 = $$7;
            double $$14 = $$8;
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = bcb.d($$18, $$13, $$16) * $$0;
                  double $$20 = bcb.d($$18, $$14, $$17) * $$0;
