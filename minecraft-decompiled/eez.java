...
public final class eez<T extends Enum<T> & bda> extends efe<T> {
   ...
   private eez(String $$0, Class<T> $$1, List<T> $$2) {
      super($$0, $$1);
      if ($$2.isEmpty()) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof eez<?> $$1 && super.equals($$0) ? this.a.equals($$1.a) : false;
      }
   }
   ...
   public static <T extends Enum<T> & bda> eez<T> a(String $$0, Class<T> $$1) {
      return a($$0, $$1, $$0x -> true);
   }

   public static <T extends Enum<T> & bda> eez<T> a(String $$0, Class<T> $$1, Predicate<T> $$2) {
      return a($$0, $$1, Arrays.<T>stream($$1.getEnumConstants()).filter($$2).collect(Collectors.toList()));
   }

   @SafeVarargs
   public static <T extends Enum<T> & bda> eez<T> a(String $$0, Class<T> $$1, T... $$2) {
      return a($$0, $$1, List.of($$2));
   }

   public static <T extends Enum<T> & bda> eez<T> a(String $$0, Class<T> $$1, List<T> $$2) {
