...
public class edx {
   ...
   private final jb e;
   private final jh f;
   private final List<jb> g = Lists.newArrayList();
   private final List<jb> h = Lists.newArrayList();
   private final jh i;

   public edx(dmu $$0, jb $$1, jh $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      eeb $$0 = this.b.a_(this.e);
      if (!edt.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == faq.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(eeb $$0) {
      return $$0.a(dqb.ix) || $$0.a(dqb.pP);
   }

   private static boolean a(eeb $$0, eeb $$1) {
      if ($$0.a(dqb.pP) && $$1.a(dqb.ix)) {
         return false;
      } else {
         return $$0.a(dqb.ix) && $$1.a(dqb.pP) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(jb $$0, jh $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!edt.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               eeb $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !edt.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!edt.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
