...
public class btl implements btq {
   ...
   private final Map<String, btl.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, bvc>> o = new ObjectArraySet();

   public btl(LongSupplier $$0, IntSupplier $$1, BooleanSupplier $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> btr.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         if ($$2 > a && !this.n.getAsBoolean()) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> btr.b(this.k)), LogUtils.defer(() -> $$2 / 1000000.0));
         }
   ...
   private btl.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new btl.a());
      }
   ...
   public void a(Supplier<String> $$0, int $$1) {
      this.f().e.addTo($$0.get(), $$1);
   }

   @Override
   public btr d() {
      return new bto(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }

   @Nullable
   @Override
   public btl.a c(String $$0) {
      return this.f.get($$0);
   }

   @Override
   public Set<Pair<String, bvc>> e() {
      return this.o;
   }
