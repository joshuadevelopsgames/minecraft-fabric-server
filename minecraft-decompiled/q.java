...
public class q {
   ...
   private final List<q.a> b = Lists.newArrayList();
   ...
   public static String a(dmw $$0, double $$1, double $$2, double $$3) {
      return String.format(Locale.ROOT, "%.2f,%.2f,%.2f - %s", $$1, $$2, $$3, a($$0, jb.a($$1, $$2, $$3)));
   }

   public static String a(dmw $$0, jb $$1) {
      return a($$0, $$1.u(), $$1.v(), $$1.w());
   }

   public static String a(dmw $$0, int $$1, int $$2, int $$3) {
   ...
   public q a(String $$0, r<String> $$1) {
      try {
         this.a($$0, $$1.call());
   ...
   public q a(String $$0, Object $$1) {
      this.b.add(new q.a($$0, $$1));
      return this;
   }
   ...
   public static void a(q $$0, dmw $$1, jb $$2, eeb $$3) {
      $$0.a("Block", $$3::toString);
      a($$0, $$1, $$2);
   }

   public static q a(q $$0, dmw $$1, jb $$2) {
