...
public abstract class bmf extends DataFix {
   private final String a;

   public bmf(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(blp.E);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(blp.E);
      Type<Pair<String, String>> $$2 = DSL.named(blp.C.typeName(), bnm.a());
      if (!Objects.equals(this.getOutputSchema().getType(blp.C), $$2)) {
