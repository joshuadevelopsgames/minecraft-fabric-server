...
public class yz implements xp {
   ...
   private static final Codec<Object> d = bbi.b.validate(yz::b);
   ...
   public static final MapCodec<yz> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final xp.a<yz> c = new xp.a<>(b, "translatable");
   private static final xt f = xt.e("%");
   private static final xt g = xt.e("null");
   ...
   @Nullable
   private ud k;
   private List<xt> l = ImmutableList.of();
   ...
   private static yz a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yz($$0, $$1.orElse(null), a($$2));
   }

   public yz(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xt> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (za var4) {
            this.l = ImmutableList.of(xt.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xt> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new za(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xt a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         Object $$1 = this.j[$$0];
         if ($$1 instanceof xo $$2) {
            return $$2;
         } else {
            return $$1 == null ? g : xt.e($$1.toString());
         }
      } else {
         throw new za(this, $$0);
      }
   ...
   public yc a(@Nullable ek $$0, @Nullable bzm $$1, int $$2) throws CommandSyntaxException {
      ...
      return yc.a(new yz(this.h, this.i, $$3));
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof yz $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j);
   }
