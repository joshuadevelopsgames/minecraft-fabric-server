...
public class hvx<T> implements hwb<T> {
   protected final Comparator<T> a;
   protected final hwa<T> b;

   public hvx(Function<T, Stream<ame>> $$0, List<T> $$1) {
   ...
   protected List<T> a(String $$0, String $$1) {
      List<T> $$2 = this.b.a($$0);
      List<T> $$3 = this.b.b($$1);
      return ImmutableList.copyOf(new hvy<T>($$2.iterator(), $$3.iterator(), this.a));
   }
}
