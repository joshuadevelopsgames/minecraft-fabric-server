...
public class doh {
   public static <T> List<doh.b> a(List<T> $$0, Function<T, List<jp<euc>>> $$1, boolean $$2) {
      Object2IntMap<euc> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, euc c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jp<euc>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jl<euc> $$12 : $$10.get($$11)) {
               euc $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && bbp.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<doh.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<euc> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new doh.b($$28));
      }
   ...
   public record b(List<euc> a, ToIntFunction<euc> b) {
      b(List<euc> $$0) {
         this($$0, ag.h($$0));
      }
   }
