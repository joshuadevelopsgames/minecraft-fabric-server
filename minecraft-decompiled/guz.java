public class guz extends gvt {
   private final double a;
   private final double b;
   private final double F;

   protected guz(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3);
      this.j = $$4;
      this.k = $$5;
      this.l = $$6;
   ...
   public void a() {
      ...
      if (this.s++ >= this.t) {
         ...
         this.g = this.a + this.j * var4;
         this.h = this.b + this.k * var4 + (1.0F - $$0);
         this.i = this.F + this.l * var4;
      }
   }
