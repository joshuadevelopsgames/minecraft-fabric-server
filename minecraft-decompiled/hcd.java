...
public class hcd implements hbz.a {
   private final fue a;
   ...
   public void a(fod $$0, gxn $$1, double $$2, double $$3, double $$4) {
      dmv $$5 = this.a.s;
      fog $$6 = $$1.getBuffer(gxz.y());
      jb $$7 = jb.a($$2, 0.0, $$4);

      for (int $$8 = -2; $$8 <= 2; $$8++) {
         for (int $$9 = -2; $$9 <= 2; $$9++) {
            efy $$10 = $$5.A($$7.b($$8 * 16, 0, $$9 * 16));

            for (Entry<eka.a, eka> $$11 : $$10.e()) {
               eka.a $$12 = $$11.getKey();
               dlz $$13 = $$10.f();
               ...
               for (int $$15 = 0; $$15 < 16; $$15++) {
                  for (int $$16 = 0; $$16 < 16; $$16++) {
                     int $$17 = ke.a($$13.h, $$15);
                     int $$18 = ke.a($$13.i, $$16);
                     float $$19 = (float)($$5.a($$12, $$17, $$18) + $$12.ordinal() * 0.09375F - $$3);
                     gyh.b(
                        $$0,
                        $$6,
                        $$17 + 0.25F - $$2,
