...
public class hqd implements hqg<String> {
   ...
   private static final MapCodec<hqd.a> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final hqg.a<hqd, String> c = hqg.a.a(f.flatXmap(hqd::a, $$0 -> DataResult.success($$0.g)), b);
   private final hqd.a g;
   private final DateFormat h;
   private long i;
   private String j = "";

   private hqd(hqd.a $$0, DateFormat $$1) {
      this.g = $$0;
      this.h = $$1;
   }

   public static hqd a(String $$0, String $$1, Optional<TimeZone> $$2) {
      return (hqd)a(new hqd.a($$0, $$1, $$2)).getOrThrow($$0x -> new IllegalStateException("Failed to validate format: " + $$0x));
   }

   private static DataResult<hqd> a(hqd.a $$0) {
      ...
      return DataResult.success(new hqd($$0, $$3));
   }
   ...
   record a(String a, String b, Optional<TimeZone> c) {
   }
}
