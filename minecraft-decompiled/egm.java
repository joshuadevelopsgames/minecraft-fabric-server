...
public class egm<T> implements ego<T> {
   ...
   private egm(jq<T> $$0, int $$1, egp<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private egm(jq<T> $$0, T[] $$1, egp<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public ego<T> a(egp<T> $$0) {
      return new egm<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
