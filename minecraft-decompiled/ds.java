...
public record ds(List<ds.c> c) {
   ...
   public static final zm<ByteBuf, ds> b = ds.c.a.a(zk.a()).a(ds::new, ds::a);

   public <S extends eed<?, S>> boolean a(eec<?, S> $$0, S $$1) {
      for (ds.c $$2 : this.c) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(eec<?, ?> $$0) {
      for (ds.c $$1 : this.c) {
   ...
   public static class a {
      ...
      public ds.a a(efe<?> $$0, String $$1) {
         this.a.add(new ds.c($$0.f(), new ds.b($$1)));
         return this;
      }

      public ds.a a(efe<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public ds.a a(efe<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & bda> ds.a a(efe<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   record b(String e) implements ds.e {
      public static final Codec<ds.b> a = Codec.STRING.xmap(ds.b::new, ds.b::a);
      public static final zm<ByteBuf, ds.b> b = zk.p.a(ds.b::new, ds.b::a);

      @Override
      public <T extends Comparable<T>> boolean a(eed<?, ?> $$0, efe<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   record c(String b, ds.e c) {
      public static final zm<ByteBuf, ds.c> a = zm.a(zk.p, ds.c::a, ds.e.d, ds.c::b, ds.c::new);
   ...
   record d(Optional<String> e, Optional<String> f) implements ds.e {
      ...
      public static final zm<ByteBuf, ds.d> b = zm.a(zk.a(zk.p), ds.d::a, zk.a(zk.p), ds.d::b, ds.d::new);
   ...
   interface e {
      ...
      zm<ByteBuf, ds.e> d = zk.a(ds.b.b, ds.d.b).a(Either::unwrap, $$0 -> {
         if ($$0 instanceof ds.b $$1) {
            return Either.left($$1);
         } else if ($$0 instanceof ds.d $$2) {
            return Either.right($$2);
      ...
      <T extends Comparable<T>> boolean a(eed<?, ?> var1, efe<T> var2);
   }
}
