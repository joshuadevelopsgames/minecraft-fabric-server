   ...
   private <TE> TypeRewriteRule a(Type<?> $$0, ListType<TE> $$1) {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhere(
            "InjectBedBlockEntityType", this.getInputSchema().findChoiceType(blp.t), this.getOutputSchema().findChoiceType(blp.t), $$0x -> $$0xx -> $$0xx
         ),
         this.fixTypeEverywhereTyped(
            "BedBlockEntityInjecter",
            this.getOutputSchema().getType(blp.d),
            $$3x -> {
