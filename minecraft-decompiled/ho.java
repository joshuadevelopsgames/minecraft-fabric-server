...
public class ho<T> implements AutoCloseable {
   ...
   private static <T extends em<T>> hq a(ho<T> $$0, eh $$1) {
      if ($$0.k == 0) {
   ...
   public static <T extends em<T>> void a(ho<T> $$0, id<T> $$1, T $$2, eh $$3) {
      $$0.a(new hk<>(a($$0, $$3), new hv<>($$1, $$2.p(), false).bind($$2)));
   }

   public static <T extends em<T>> void a(ho<T> $$0, String $$1, ContextChain<T> $$2, T $$3, eh $$4) {
