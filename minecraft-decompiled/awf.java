...
public class awf implements awb {
   ...
   private final Map<awd, List<Path>> h;

   awf(awa $$0, avt $$1, Set<String> $$2, List<Path> $$3, Map<awd, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(awd $$0, ame $$1, Consumer<Path> $$2) {
      w.e($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(awd $$0, String $$1, String $$2, awb.a $$3) {
      w.e($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<ame, axg<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(awb.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      awe.a($$1, $$4, $$3, $$0);
   }
   ...
   public axg<InputStream> a(awd $$0, ame $$1) {
      return (axg<InputStream>)w.e($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = w.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && awe.a($$5)) {
               return axg.create($$5);
            }
         }
   ...
   public <T> T a(awo<T> $$0) {
      axg<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public axr d() {
      return $$0 -> Optional.ofNullable(this.a(awd.a, $$0)).map($$0x -> new axm(this, $$0x));
   }
}
