...
public class flh {
   ...
   static flh a() {
      int[] $$0 = new int[1];
      AL10.alGenSources($$0);
      return fll.a("Allocate new source") ? null : new flh($$0[0]);
   }
      ...
      if (this.g != null) {
         try {
            for (int $$1 = 0; $$1 < $$0; $$1++) {
               ...
               if ($$2 != null) {
                  new flm($$2, this.g.a()).c().ifPresent($$0x -> AL10.alSourceQueueBuffers(this.d, new int[]{$$0x}));
               }
            }
   ...
   private int l() {
      ...
      if ($$0 > 0) {
         ...
         fll.a("Unqueue buffers");
         AL10.alDeleteBuffers($$1);
         fll.a("Remove processed buffers");
      }
