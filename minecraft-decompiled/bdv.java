...
public class bdv {
   ...
   public bdv(int $$0, int $$1) {
      this($$0, $$1, new long[bcb.d($$1 * $$0, 64) / 64]);
   }

   public bdv(int $$0, int $$1, long[] $$2) {
      Validate.inclusiveBetween(1L, 32L, $$0);
      this.e = $$1;
      this.c = $$0;
      this.b = $$2;
      this.d = (1L << $$0) - 1L;
      int $$3 = bcb.d($$1 * $$0, 64) / 64;
      if ($$2.length != $$3) {
   ...
   public void a(int $$0, int $$1) {
      ...
      int $$5 = $$2 ^ $$3 << 6;
      this.b[$$3] = this.b[$$3] & ~(this.d << $$5) | ($$1 & this.d) << $$5;
      if ($$3 != $$4) {
         int $$6 = 64 - $$5;
         int $$7 = this.c - $$6;
         this.b[$$4] = this.b[$$4] >>> $$7 << $$7 | ($$1 & this.d) >> $$6;
      }
   }
