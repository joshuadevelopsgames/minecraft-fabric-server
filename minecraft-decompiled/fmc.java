...
public class fmc {
   ...
   private final Queue<fmc.a> c = EvictingQueue.create(10);
   @Nullable
   private volatile fmc.a d;
   ...
   @Nullable
   public static fmc a(int $$0, boolean $$1, Set<String> $$2) {
      if ($$0 <= 0) {
         return null;
      } else {
         GLCapabilities $$3 = GL.getCapabilities();
         if ($$3.GL_KHR_debug && fme.b) {
            fmc $$4 = new fmc();
            $$2.add("GL_KHR_debug");
            GL11.glEnable(37600);
            if ($$1) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create($$4::a), fmw::a), 0L);
            return $$4;
         } else if ($$3.GL_ARB_debug_output && fme.d) {
            fmc $$7 = new fmc();
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create($$7::a), fmw::a), 0L);
            return $$7;
         } else {
            return null;
         }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fmc.a(this.b) + ", type=" + fmc.b(this.c) + ", severity=" + fmc.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
