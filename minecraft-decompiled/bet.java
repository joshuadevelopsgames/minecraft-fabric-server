...
public class bet extends bkj {
   public bet(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", blp.t, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(blp.t, "minecraft:piston");
