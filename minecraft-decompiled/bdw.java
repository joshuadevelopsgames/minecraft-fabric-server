...
public class bdw extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(blp.E), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bdw::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bdw::a);
      return this.a($$0, "minecraft:trident", bdw::a);
   }
