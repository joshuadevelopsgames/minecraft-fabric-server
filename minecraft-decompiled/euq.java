...
public class euq {
   ...
   public static final Codec<euq> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ag.a($$0, 6).map($$0x -> new euq($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public euq(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
      ...
      this.h = $$5;
      if ($$3 < $$0 || $$4 < $$1 || $$5 < $$2) {
         ag.b("Invalid bounding box data, inverted bounds for: " + this);
         this.c = Math.min($$0, $$3);
         this.d = Math.min($$1, $$4);
         this.e = Math.min($$2, $$5);
         this.f = Math.max($$0, $$3);
   ...
   public static euq a() {
      return new euq(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static euq a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jh $$9) {
      switch ($$9) {
         case d:
         default:
            return new euq($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new euq($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new euq($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new euq($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<dlz> b() {
      ...
      int $$2 = ke.a(this.k());
      int $$3 = ke.a(this.m());
      return dlz.a(new dlz($$0, $$1), new dlz($$2, $$3));
   }

   public boolean a(euq $$0) {
   ...
   public static Optional<euq> a(Iterable<jb> $$0) {
      Iterator<jb> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         euq $$2 = new euq($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<euq> b(Iterable<euq> $$0) {
      Iterator<euq> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         euq $$2 = $$1.next();
         euq $$3 = new euq($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   @Deprecated
   public euq a(int $$0, int $$1, int $$2) {
      this.c += $$0;
      this.d += $$1;
      this.e += $$2;
      this.f += $$0;
   ...
   public euq b(int $$0, int $$1, int $$2) {
      return new euq(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public euq c(int $$0, int $$1, int $$2) {
      return new euq(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }

   public boolean b(kg $$0) {
