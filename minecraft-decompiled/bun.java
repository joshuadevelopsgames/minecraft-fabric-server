...
public class bun {
   ...
   private static void a(buv $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(buq $$0, JsonObject $$1) {
   ...
   private JsonElement b(List<Pair<egz, bva<bup>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> ((bva)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ag.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<egz, bva<bup>> $$3 : $$0) {
         bva<bup> $$4 = (bva<bup>)$$3.getSecond();
         JsonObject $$5 = ag.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((egz)$$3.getFirst()).toString());
         $$5.addProperty("count", $$4.d());
         $$5.addProperty("durationNanosTotal", $$4.f().toNanos());
         $$5.addProperty("durationNanosAvg", $$4.f().toNanos() / $$4.d());
         JsonObject $$6 = ag.a(new JsonObject(), $$1x -> $$5.add("durationNanosPercentiles", $$1x));
         $$4.e().forEach(($$1x, $$2x) -> $$6.addProperty("p" + $$1x, $$2x));
         Function<bup, JsonElement> $$7 = $$0x -> {
   ...
   private JsonElement c(List<buy> $$0) {
      if ($$0.isEmpty()) {
         return JsonNull.INSTANCE;
      } else {
         JsonObject $$1 = new JsonObject();
         double[] $$2 = $$0.stream().mapToDouble($$0x -> $$0x.b().toNanos() / 1000000.0).toArray();
         ...
         Map<Integer, Double> $$4 = buc.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bul $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bun::a));
      $$1.add("chunksWritten", this.a($$0.m(), bun::a));
      return $$1;
   }

   private JsonElement a(bus.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bul $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bun::a));
      $$1.add("received", this.a($$0.k(), bun::a));
      return $$1;
   }

   private <T> JsonElement a(buu<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bur> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bur>, ToDoubleFunction<bur>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bur::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bur::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bur::c));
      return $$1;
   }
}
