...
public final class gtc {
   ...
   private static final gtc c = new gtc(HostAndPort.fromParts("server.invalid", 25565));

   public gtc(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gtc(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gtc a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gtc($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gtc ? this.b.equals(((gtc)$$0).b) : false;
      }
   }
