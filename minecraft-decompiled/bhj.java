...
public class bhj extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("EntityProjectileOwner", $$0.getType(blp.E), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:egg", this::c);
      $$0 = this.a($$0, "minecraft:ender_pearl", this::c);
      $$0 = this.a($$0, "minecraft:experience_bottle", this::c);
      $$0 = this.a($$0, "minecraft:snowball", this::c);
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(blp.E, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(blp.E, $$1);
