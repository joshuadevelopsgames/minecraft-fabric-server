...
public class exi {
   ...
   static class a implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         return $$0.c[jh.f.d()] && !$$0.b[jh.f.d()].d;
      }

      @Override
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         $$1.d = true;
         $$1.b[jh.f.d()].d = true;
         return new exi.k($$0, $$1);
      }
   }

   static class b implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         if ($$0.c[jh.f.d()] && !$$0.b[jh.f.d()].d && $$0.c[jh.b.d()] && !$$0.b[jh.b.d()].d) {
            exi.v $$1 = $$0.b[jh.f.d()];
            return $$1.c[jh.b.d()] && !$$1.b[jh.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         ...
         $$1.b[jh.f.d()].d = true;
         $$1.b[jh.b.d()].d = true;
         $$1.b[jh.f.d()].b[jh.b.d()].d = true;
         return new exi.l($$0, $$1);
      }
   }

   static class c implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         return $$0.c[jh.b.d()] && !$$0.b[jh.b.d()].d;
      }
      ...
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         $$1.d = true;
         $$1.b[jh.b.d()].d = true;
         return new exi.m($$0, $$1);
      }
   }

   static class d implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         if ($$0.c[jh.c.d()] && !$$0.b[jh.c.d()].d && $$0.c[jh.b.d()] && !$$0.b[jh.b.d()].d) {
            exi.v $$1 = $$0.b[jh.c.d()];
            return $$1.c[jh.b.d()] && !$$1.b[jh.b.d()].d;
         } else {
            return false;
      ...
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         ...
         $$1.b[jh.c.d()].d = true;
         $$1.b[jh.b.d()].d = true;
         $$1.b[jh.c.d()].b[jh.b.d()].d = true;
         return new exi.n($$0, $$1);
      }
   }

   static class e implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         return $$0.c[jh.c.d()] && !$$0.b[jh.c.d()].d;
      }

      @Override
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         exi.v $$3 = $$1;
         if (!$$1.c[jh.c.d()] || $$1.b[jh.c.d()].d) {
            $$3 = $$1.b[jh.d.d()];
         }

         $$3.d = true;
         $$3.b[jh.c.d()].d = true;
         return new exi.o($$0, $$3);
      }
   }

   static class f implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         return true;
      }
      ...
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         $$1.d = true;
         return new exi.s($$0, $$1, $$2);
      }
   }

   static class g implements exi.i {
      @Override
      public boolean a(exi.v $$0) {
         return !$$0.c[jh.e.d()] && !$$0.c[jh.f.d()] && !$$0.c[jh.c.d()] && !$$0.c[jh.d.d()] && !$$0.c[jh.b.d()];
      }

      @Override
      public exi.r a(jh $$0, exi.v $$1, bck $$2) {
         $$1.d = true;
         return new exi.t($$0, $$1);
      }
   }

   public static class h extends exi.r {
      ...
      private exi.v G;
      private exi.v H;
      private final List<exi.r> I = Lists.newArrayList();

      public h(bck $$0, int $$1, int $$2, jh $$3) {
         super(evp.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<exi.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new exi.p($$3, this.G));
         this.I.add(new exi.j($$3, this.H));
         List<exi.i> $$5 = Lists.newArrayList();
         $$5.add(new exi.b());
         $$5.add(new exi.d());
         $$5.add(new exi.e());
         $$5.add(new exi.a());
         ...
         euq $$10 = euq.a(this.b(1, 1, 1), this.b(23, 8, 21));
         euq $$11 = euq.a(this.b(34, 1, 1), this.b(56, 8, 21));
         euq $$12 = euq.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new exi.u($$3, $$10, $$13++));
         this.I.add(new exi.u($$3, $$11, $$13++));
         this.I.add(new exi.q($$3, $$12));
      }
      ...
      private List<exi.v> b(bck $$0) {
         exi.v[] $$1 = new exi.v[75];
         ...
         exi.v $$23 = new exi.v(1003);
         exi.v $$24 = new exi.v(1001);
         exi.v $$25 = new exi.v(1002);
         $$1[v].a(jh.b, $$23);
         $$1[w].a(jh.d, $$24);
         $$1[x].a(jh.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jh.f.d()].d = true;
         this.H.b[jh.c.d()].d = true;
         this.H.b[jh.f.d()].b[jh.c.d()].d = true;
         this.H.b[jh.b.d()].d = true;
         this.H.b[jh.f.d()].b[jh.b.d()].d = true;
         this.H.b[jh.c.d()].b[jh.b.d()].d = true;
         this.H.b[jh.f.d()].b[jh.c.d()].b[jh.b.d()].d = true;
         ObjectArrayList<exi.v> $$26 = new ObjectArrayList();
      ...
      public void a(dnt $$0, dnq $$1, efz $$2, bck $$3, euq $$4, dlz $$5, jb $$6) {
         int $$7 = Math.max($$0.Q(), 64) - this.f.i();
      ...
      private void a(boolean $$0, int $$1, dnt $$2, bck $$3, euq $$4) {
         int $$5 = 24;
      ...
      private void a(dnt $$0, bck $$1, euq $$2) {
      ...
      private void b(dnt $$0, bck $$1, euq $$2) {
      ...
      private void c(dnt $$0, bck $$1, euq $$2) {
      ...
      private void d(dnt $$0, bck $$1, euq $$2) {
      ...
      private void e(dnt $$0, bck $$1, euq $$2) {
      ...
      private void f(dnt $$0, bck $$1, euq $$2) {
   ...
   interface i {
      boolean a(exi.v var1);

      exi.r a(jh var1, exi.v var2, bck var3);
   }

   public static class j extends exi.r {
      public j(jh $$0, exi.v $$1) {
         super(evp.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dnt $$0, dnq $$1, efz $$2, bck $$3, euq $$4, dlz $$5, jb $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dqb.cr.m(), dqb.cr.m(), false);
   ...
   public static class k extends exi.r {
      public k(jh $$0, exi.v $$1) {
         super(evp.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dnt $$0, dnq $$1, efz $$2, bck $$3, euq $$4, dlz $$5, jb $$6) {
         exi.v $$7 = this.B.b[jh.f.d()];
         exi.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jh.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jh.a.d()]);
         }
   ...
   public static class l extends exi.r {
      public l(jh $$0, exi.v $$1) {
         super(evp.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends exi.r {
      public m(jh $$0, exi.v $$1) {
         super(evp.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dnt $$0, dnq $$1, efz $$2, bck $$3, euq $$4, dlz $$5, jb $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jh.a.d()]);
         }

         exi.v $$7 = this.B.b[jh.b.d()];
         if ($$7.b[jh.b.d()] == null) {
   ...
   public static class n extends exi.r {
      public n(jh $$0, exi.v $$1) {
         super(evp.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dnt $$0, dnq $$1, efz $$2, bck $$3, euq $$4, dlz $$5, jb $$6) {
         exi.v $$7 = this.B.b[jh.c.d()];
         exi.v $$8 = this.B;
         exi.v $$9 = $$7.b[jh.b.d()];
         exi.v $$10 = $$8.b[jh.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jh.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jh.a.d()]);
         }
   ...
   public static class o extends exi.r {
      public o(jh $$0, exi.v $$1) {
         super(evp.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends exi.r {
      public p(jh $$0, exi.v $$1) {
         super(evp.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends exi.r {
      public q(jh $$0, euq $$1) {
         super(evp.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends evc {
      protected static final eeb b = dqb.iB.m();
      protected static final eeb c = dqb.iC.m();
      protected static final eeb d = dqb.iD.m();
      protected static final eeb h = c;
      protected static final eeb i = dqb.iK.m();
      protected static final boolean j = true;
      protected static final eeb k = dqb.J.m();
      protected static final Set<dpz> l = ImmutableSet.builder().add(dqb.ee).add(dqb.je).add(dqb.nD).add(k.b()).build();
      ...
      public r(evp $$0, jh $$1, int $$2, euq $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(evp $$0, int $$1, jh $$2, exi.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static euq a(jh $$0, exi.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         euq $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dnt $$0, euq $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  eeb $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.Q() && $$11 != k) {
      ...
      protected void a(dnt $$0, euq $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dnt $$0, euq $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, eeb $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(euq $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dnt $$0, euq $$1, int $$2, int $$3, int $$4) {
         jb $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            crk $$6 = bzv.N.a($$0.a(), bzu.d);
            if ($$6 != null) {
               $$6.d($$6.fa());
               $$6.b($$5.u() + 0.5, $$5.v(), $$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dx()), bzu.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends exi.r {
      private int a;

      public s(jh $$0, exi.v $$1, bck $$2) {
         super(evp.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dnt $$0, dnq $$1, efz $$2, bck $$3, euq $$4, dlz $$5, jb $$6) {
         ...
         if (this.B.b[jh.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jh.a.d()] && !this.B.c[jh.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends exi.r {
      public t(jh $$0, exi.v $$1) {
         super(evp.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends exi.r {
      private int a;

      public u(jh $$0, euq $$1, int $$2) {
         super(evp.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
