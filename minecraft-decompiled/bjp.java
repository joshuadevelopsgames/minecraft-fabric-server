...
public class bjp extends bkj {
   public bjp(Schema $$0, boolean $$1) {
      super($$0, $$1, "JigsawPropertiesFix", blp.t, "minecraft:jigsaw");
   }
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bjp::a);
   }
}
