...
public class bho extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = $$0.getTypeRaw(blp.D);
      Type<?> $$3 = $$1.getTypeRaw(blp.D);
      Type<?> $$4 = $$0.getTypeRaw(blp.E);
   ...
   private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule a(Schema $$0, Schema $$1, Type<OldEntityTree> $$2, Type<NewEntityTree> $$3, Type<Entity> $$4) {
      Type<Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>>> $$5 = DSL.named(blp.D.typeName(), DSL.and(DSL.optional(DSL.field("Riding", $$2)), $$4));
      Type<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>> $$6 = DSL.named(
         blp.D.typeName(), DSL.and(DSL.optional(DSL.field("Passengers", DSL.list($$3))), $$4)
      );
      Type<?> $$7 = $$0.getType(blp.D);
      Type<?> $$8 = $$1.getType(blp.D);
      if (!Objects.equals($$7, $$5)) {
         ...
         Type<?> $$12 = $$0.getType(blp.c);
         Type<?> $$13 = $$1.getType(blp.c);
            ...
            this.fixTypeEverywhere(
               ...
               $$5x -> $$6x -> {
                  ...
                  while (true) {
                     ...
                     $$7x = Optional.of(Pair.of(blp.D.typeName(), Pair.of($$9x, ((Pair)$$8x.getSecond()).getSecond())));
