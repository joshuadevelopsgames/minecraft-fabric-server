...
public class bnf extends DataFix {
   ...
   private static final ImmutableMap<String, bnf.a> j = ImmutableMap.builder()
      .put("minecraft:village", new bnf.a(32, 8, 10387312))
      .put("minecraft:desert_pyramid", new bnf.a(32, 8, 14357617))
      .put("minecraft:igloo", new bnf.a(32, 8, 14357618))
      .put("minecraft:jungle_pyramid", new bnf.a(32, 8, 14357619))
      .put("minecraft:swamp_hut", new bnf.a(32, 8, 14357620))
      .put("minecraft:pillager_outpost", new bnf.a(32, 8, 165745296))
      .put("minecraft:monument", new bnf.a(32, 5, 10387313))
      .put("minecraft:endcity", new bnf.a(20, 11, 10387313))
      .put("minecraft:mansion", new bnf.a(80, 20, 10387319))
      .build();
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("WorldGenSettings building", this.getInputSchema().getType(blp.P), $$0 -> $$0.update(DSL.remainderFinder(), bnf::a));
   }
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> a(DynamicOps<T> $$0, OptionalDynamic<T> $$1) {
      ...
      Map<String, bnf.a> $$6 = Maps.newHashMap();
      if ($$1.result().isEmpty()) {
         $$5.setTrue();
         $$6.put("minecraft:village", (bnf.a)j.get("minecraft:village"));
      }
               ...
               switch ($$9) {
                  ...
                  case "separation":
                     if ("oceanmonument".equals($$8)) {
                        bnf.a $$11 = $$6.getOrDefault("minecraft:monument", (bnf.a)j.get("minecraft:monument"));
                        int $$12 = a($$10, $$11.c, 1);
                        $$6.put("minecraft:monument", new bnf.a($$12, $$11.c, $$11.d));
                     }
      ...
      $$7.put(
         ...
         $$1.createMap(
            $$6.entrySet().stream().collect(Collectors.toMap($$1x -> $$1.createString((String)$$1x.getKey()), $$1x -> ((bnf.a)$$1x.getValue()).a($$0)))
         )
      );
      if ($$5.isTrue()) {
         $$7.put(
   ...
   private static void a(Map<String, bnf.a> $$0, String $$1, String $$2, int $$3) {
      bnf.a $$4 = $$0.getOrDefault($$1, (bnf.a)j.get($$1));
      int $$5 = a($$2, $$4.b, $$3);
      $$0.put($$1, new bnf.a($$5, $$4.c, $$4.d));
   }

   static final class a {
      public static final Codec<bnf.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
