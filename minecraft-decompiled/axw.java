...
public abstract class axw<T> extends ayf<T> {
   ...
   public axw(@Nullable T $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0);
   ...
   protected axw(@Nullable T $$0, JsonObject $$1) {
      super($$0);
