...
public abstract class ezx {
   ...
   protected ezx(int $$0, int $$1, final int $$2) {
      if ($$0 >= 254) {
   ...
   private void a(long $$0, long $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if (!this.a($$1)) {
         $$2 = bcb.a($$2, 0, this.f - 1);
         $$3 = bcb.a($$3, 0, this.f - 1);
         boolean $$6 = $$4 == 255;
         if ($$6) {
            $$4 = $$3;
         }
         ...
         if ($$5) {
            ...
            $$7 = bcb.a(this.a($$1, $$0, $$2), 0, this.f - 1);
         }
   ...
   protected final void b(long $$0, long $$1, int $$2, boolean $$3) {
      ...
      int $$5 = bcb.a(this.b($$0, $$1, $$2), 0, this.f - 1);
      if ($$3) {
   ...
   protected final int b(int $$0) {
      if (this.b.b()) {
         ...
         while (!this.b.b() && $$0 > 0) {
            $$0--;
            long $$1 = this.b.a();
            int $$2 = bcb.a(this.c($$1), 0, this.f - 1);
