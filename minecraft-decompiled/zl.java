...
public class zl<B extends ByteBuf, V, T> implements zm<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<zl.c<B, V, T>> c;
   private final Object2IntMap<T> d;

   zl(Function<V, ? extends T> $$0, List<zl.c<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public V a(B $$0) {
      ...
      if ($$1 >= 0 && $$1 < this.c.size()) {
         zl.c<B, V, T> $$2 = this.c.get($$1);

         try {
            return (V)$$2.a.decode($$0);
         } catch (Exception var5) {
            if (var5 instanceof zl.b) {
               throw var5;
            } else {
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         xf.a($$0, $$3);
         zl.c<B, V, T> $$4 = this.c.get($$3);

         try {
            zm<? super B, V> $$5 = (zm<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
         } catch (Exception var7) {
            if (var7 instanceof zl.b) {
               throw var7;
            } else {
   ...
   public static <B extends ByteBuf, V, T> zl.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new zl.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<zl.c<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public zl.a<B, V, T> a(T $$0, zm<? super B, ? extends V> $$1) {
         this.a.add(new zl.c<>($$1, $$0));
         return this;
      }
      ...
      public zl<B, V, T> a() {
         ...
         return new zl<>(this.b, List.copyOf(this.a), $$0);
      }
   }
   ...
   record c<B, V, T>(zm<? super B, ? extends V> a, T b) {
   }
}
