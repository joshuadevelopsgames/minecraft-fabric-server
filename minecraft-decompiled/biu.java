...
public class biu extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped(
            "InlineBlockPosFormatFix - player", this.getInputSchema().getType(blp.c), $$0x -> $$0x.update(DSL.remainderFinder(), this::a)
         ),
         this.fixTypeEverywhereTyped(
   ...
   private OpticFinder<?> a(String $$0) {
      return DSL.namedChoice($$0, this.getInputSchema().getChoiceType(blp.E, $$0));
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0) {
      ...
      if ($$1.isPresent() && $$2.isPresent() && $$3.isPresent()) {
         Dynamic<?> $$4 = $$0.createMap(Map.of($$0.createString("pos"), bdt.a($$0, $$1.get().intValue(), $$2.get().intValue(), $$3.get().intValue())));
   ...
   private Dynamic<?> b(Dynamic<?> $$0) {
      return bdt.a($$0, "SleepingX", "SleepingY", "SleepingZ", "sleeping_pos");
   }

   private Dynamic<?> c(Dynamic<?> $$0) {
      return bdt.a($$0.renameField("LifeTicks", "life_ticks"), "BoundX", "BoundY", "BoundZ", "bound_pos");
   }

   private Dynamic<?> d(Dynamic<?> $$0) {
      return bdt.a($$0.renameField("Size", "size"), "AX", "AY", "AZ", "anchor_pos");
   }

   private Dynamic<?> e(Dynamic<?> $$0) {
      $$0 = $$0.remove("TravelPosX").remove("TravelPosY").remove("TravelPosZ");
      $$0 = bdt.a($$0, "HomePosX", "HomePosY", "HomePosZ", "home_pos");
      return $$0.renameField("HasEgg", "has_egg");
   }

   private Dynamic<?> f(Dynamic<?> $$0) {
      return bdt.a($$0, "TileX", "TileY", "TileZ", "block_pos");
   }
}
