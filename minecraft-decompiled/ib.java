...
public interface ib<T> {
   ...
   id<T> a(@Nullable ui var1, CommandDispatcher<T> var2) throws en;
   ...
   static <T extends em<T>> ib<T> a(ame $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      ic<T> $$4 = new ic<>();
   ...
   static <T extends em<T>> hs<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hu.c<>($$2.getString(), $$4.get());
      }
   }
}
