...
public class grs extends SimpleChannelInboundHandler<ByteBuf> {
   private static final Splitter a = Splitter.on('\u0000').limit(6);
   private final gtc b;
   private final grs.a c;

   public grs(gtc $$0, grs.a $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   protected void a(ChannelHandlerContext $$0, ByteBuf $$1) {
      ...
      if ($$2 == 255) {
         ...
         if ("§1".equals($$4.get(0))) {
            int $$5 = bcb.a($$4.get(1), 0);
            String $$6 = $$4.get(2);
            String $$7 = $$4.get(3);
            int $$8 = bcb.a($$4.get(4), -1);
            int $$9 = bcb.a($$4.get(5), -1);
