...
public class gy {
   ...
   public dcv a(int $$0, boolean $$1) throws CommandSyntaxException {
      dcv $$2 = new dcv(this.b, $$0);
      $$2.b(this.c);
      if ($$1 && $$0 > $$2.k()) {
   ...
   private String b(jn.a $$0) {
      DynamicOps<vi> $$1 = $$0.a(uw.a);
   ...
   private String b() {
      return this.b.e().map(amd::a).orElseGet(() -> "unknown[" + this.b + "]").toString();
   }
}
