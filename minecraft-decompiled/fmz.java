...
public enum fmz {
   ...
   private fmz(final String... $$0) {
      this.c = $$0;
   }

   public List<axg<InputStream>> a(awb $$0) throws IOException {
      return List.of(
   ...
   public axg<InputStream> b(awb $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private axg<InputStream> a(awb $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      axg<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
