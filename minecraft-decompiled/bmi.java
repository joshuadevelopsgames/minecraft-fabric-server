...
public class bmi extends DataFix {
   private final String a;
   private final Map<String, String> b;

   public bmi(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(blp.K);
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bnm.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(blp.h);
      Type<?> $$1 = this.getInputSchema().getType(blp.h);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bnm.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
