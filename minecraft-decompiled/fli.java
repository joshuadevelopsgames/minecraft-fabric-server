...
public class fli {
   ...
   @Nullable
   private String g;
   private static final fli.a h = new fli.a() {
      @Nullable
      @Override
      public flh a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fll.a(this.d, "Get capabilities")) {
         ...
         if (fll.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fll.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fll.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public flh a(fli.c $$0) {
      return ($$0 == fli.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fli.a {
      private final int a;
      private final Set<flh> b = Sets.newIdentityHashSet();
      ...
      public flh a() {
         if (this.b.size() >= this.a) {
            if (ac.aZ) {
               fli.a.warn("Maximum sound pool size {} reached", this.a);
            }
