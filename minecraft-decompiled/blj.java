...
public class blj extends DataFix {
   public blj(Schema $$0) {
      super($$0, true);
   }
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Fix Arrow stored weapon", $$0, $$1, bdt.a(this.a("minecraft:arrow"), this.a("minecraft:spectral_arrow")));
   }

   private Function<Typed<?>, Typed<?>> a(String $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(blp.E, $$0);
      Type<?> $$2 = this.getOutputSchema().getChoiceType(blp.E, $$0);
      return a($$0, $$1, $$2);
   }
