...
public class anj {
   ...
   public anj(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<anj.a> b(Scanner $$0) {
      amd<dmu> $$1 = (amd<dmu>)ans.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new anj.a($$1, new fis($$2, $$3, $$4), new fir($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<auc> $$1 = this.e.ag().t();
         if (!$$1.isEmpty()) {
            auc $$2 = $$1.get(0);
            aub $$3 = this.e.J();
            ek $$4 = new ek($$2.z(), fis.a($$3.ab()), fir.a, $$3, 4, "", xn.a, this.e, $$2);
            el $$5 = this.e.aG();
            $$5.a($$4, $$0);
         }
      });
   ...
   record a(amd<dmu> a, fis b, fir c) {
   }
}
