...
public class bcm {
   public static final Codec<bcm> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(bbi.s.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), bbi.s.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
         .apply($$0, bcm::new)
   );
   ...
   private final Predicate<ame> f;

   private bcm(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
