...
public class btx implements btt {
   ...
   private final Map<String, btx.a> e = new HashMap<>();
   ...
   public void a(String $$0) {
      ...
      if (ac.aZ) {
         Optional<StackFrame> $$4 = c.walk(
            $$0x -> $$0x.filter($$0xx -> $$0xx.getDeclaringClass() != btx.class && $$0xx.getDeclaringClass() != btt.a.class).findFirst()
         );
         if ($$4.isPresent()) {
            StackFrame $$5 = $$4.get();
            $$1 = $$5.getMethodName();
   ...
   public void a(String $$0, int $$1) {
      this.e.computeIfAbsent($$0, $$1x -> new btx.a(this.f + " " + $$0)).b($$1);
   }
