...
public class wd extends SimpleChannelInboundHandler<zw<?>> {
   ...
   private static final wu<ajx> j = ajw.b;
   private final zx k;
   private volatile boolean l = true;
   private final Queue<Consumer<wd>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
   private SocketAddress o;
   @Nullable
   private volatile ws p;
   @Nullable
   private volatile ws q;
   @Nullable
   private wf r;
   private boolean s;
   private boolean t;
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               ...
               if ($$2) {
                  ...
                  if (this.g() == zx.b) {
                     zw<?> $$7 = (zw<?>)(this.l ? new akd($$3) : new aai($$3));
                     this.a($$7, wt.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zw<?> $$1) {
      if (this.n.isOpen()) {
         ws $$2 = this.q;
         if ($$2 == null) {
   ...
   private static <T extends ws> void a(zw<T> $$0, ws $$1) {
      $$0.a((T)$$1);
   }

   private void b(wu<?> $$0, ws $$1) {
   ...
   public <T extends ws> void a(wu<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(ws $$0) {
      ...
      } else if (this.k == zx.a && $$0.O_() == zx.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public void a(String $$0, int $$1, akz $$2) {
      this.a($$0, $$1, alf.b, alf.d, $$2, ajt.a);
   }

   public void a(String $$0, int $$1, ajz $$2) {
      this.a($$0, $$1, akg.b, akg.d, $$2, ajt.b);
   }

   public <S extends wy, C extends wa> void a(String $$0, int $$1, wu<S> $$2, wu<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? ajt.c : ajt.b);
   }

   private <S extends wy, C extends wa> void a(String $$0, int $$1, wu<S> $$2, wu<C> $$3, C $$4, ajt $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<wd>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new aju(ac.b().d(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(zw<?> $$0, @Nullable ChannelFutureListener $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zw<?> $$0, @Nullable ChannelFutureListener $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zw<?> $$0, @Nullable ChannelFutureListener $$1, boolean $$2) {
      if ($$1 != null) {
         ChannelFuture $$3 = $$2 ? this.n.writeAndFlush($$0) : this.n.write($$0);
         $$3.addListener($$1);
      } else if ($$2) {
         this.n.writeAndFlush($$0, this.n.voidPromise());
      } else {
         this.n.write($$0, this.n.voidPromise());
      }
   }
   ...
   protected void c() {
      this.x = bcb.h(0.75F, this.v, this.x);
      this.w = bcb.h(0.75F, this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static wd a(InetSocketAddress $$0, boolean $$1, @Nullable bru $$2) {
      wd $$3 = new wd(zx.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final wd $$2) {
   ...
   public static void a(ChannelPipeline $$0, zx $$1, boolean $$2, @Nullable vw $$3) {
      zx $$4 = $$1.a();
      boolean $$5 = $$1 == zx.a;
      boolean $$6 = $$4 == zx.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wq<ajx>(j) : new xd.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wr<ajx>(j) : new xd.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new wm() : new xi());
   }

   private static ChannelInboundHandler a(@Nullable vw $$0, boolean $$1) {
      if (!$$1) {
         return new xh($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new wn($$0) : new wl());
      }
   }

   public static void a(ChannelPipeline $$0, zx $$1) {
      a($$0, $$1, true, null);
   }

   public static wd a(SocketAddress $$0) {
      final wd $$1 = new wd(zx.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new vy($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new vz($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof wb $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new wb($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof wc $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new wc($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof wb) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof wc) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            ws $$0 = this.k();
            ws $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               wf $$2 = Objects.requireNonNullElseGet(this.l(), () -> new wf(xo.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
