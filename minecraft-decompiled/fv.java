...
public class fv implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> xo.b("slot.only_single_allowed", $$0));

   public static fv a() {
      return new fv();
   }

   public static int a(CommandContext<ek> $$0, String $$1) {
