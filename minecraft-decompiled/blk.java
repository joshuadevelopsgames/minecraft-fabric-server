...
public class blk extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         "RaidRenamesDataFix", this.getInputSchema().getType(blp.m), $$0 -> $$0.update(DSL.remainderFinder(), $$0x -> $$0x.update("data", blk::a))
      );
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Raids", "raids", $$0x -> $$0x.createList($$0x.asStream().map(blk::b)))
         .renameField("Tick", "tick")
         .renameField("NextAvailableID", "next_id");
   }

   private static Dynamic<?> b(Dynamic<?> $$0) {
      return bdt.a($$0, "CX", "CY", "CZ", "center")
         .renameField("Id", "id")
