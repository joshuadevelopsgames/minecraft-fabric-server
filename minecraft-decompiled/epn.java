...
public class epn implements epm {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<epn> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ejx.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
            ejz.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
            ejy.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
            ...
            bwo.b(1, 20).fieldOf("outer_wall_distance").orElse(bwu.a(4, 5)).forGetter($$0x -> $$0x.i),
            bwo.b(1, 20).fieldOf("distribution_points").orElse(bwu.a(3, 4)).forGetter($$0x -> $$0x.j),
            bwo.b(0, 10).fieldOf("point_offset").orElse(bwu.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public epn(ejx $$0, ejz $$1, ejy $$2, double $$3, double $$4, boolean $$5, bwo $$6, bwo $$7, bwo $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
