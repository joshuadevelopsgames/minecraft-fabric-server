...
public class xq {
   ...
   public static final zm<wx, xo> b = zk.d(a);
   public static final zm<wx, Optional<xo>> c = b.a(zk::a);
   public static final zm<wx, xo> d = zk.c(a);
   public static final zm<wx, Optional<xo>> e = d.a(zk::a);
   public static final zm<ByteBuf, xo> f = zk.a(a);

   public static Codec<xo> a(final int $$0) {
      return new Codec<xo>() {
         public <T> DataResult<Pair<xo, T>> decode(DynamicOps<T> $$0x, T $$1) {
            return xq.a
               .decode($$0, $$1)
               .flatMap(
                  $$2 -> this.a($$0, (xo)$$2.getFirst())
                     ? DataResult.error(() -> "Component was too large: greater than max size " + $$0)
                     : DataResult.success($$2)
               );
         }

         public <T> DataResult<T> a(xo $$0x, DynamicOps<T> $$1, T $$2) {
            return xq.a.encodeStart($$1, $$0);
         }

         private <T> boolean a(DynamicOps<T> $$0x, xo $$1) {
            DataResult<JsonElement> $$2 = xq.a.encodeStart(a($$0), $$1);
            return $$2.isSuccess() && bbq.a((JsonElement)$$2.getOrThrow(), $$0);
         }

         private static <T> DynamicOps<JsonElement> a(DynamicOps<T> $$0x) {
            return (DynamicOps<JsonElement>)($$0 instanceof amc<T> $$1 ? $$1.a(JsonOps.INSTANCE) : JsonOps.INSTANCE);
         }
      };
   }
   ...
   public static <T extends bda, E> MapCodec<E> a(T[] $$0, Function<T, MapCodec<? extends E>> $$1, Function<E, T> $$2, String $$3) {
      MapCodec<E> $$4 = new xq.a<>(Stream.<T>of($$0).map($$1).toList(), $$2x -> (MapEncoder<? extends E>)$$1.apply($$2.apply((E)$$2x)));
      Codec<T> $$5 = bda.b((Supplier<T[]>)(() -> $$0));
   ...
   private static Codec<xo> a(Codec<xo> $$0) {
      ...
      Codec<xo> $$3 = RecordCodecBuilder.create(
         $$2x -> $$2x.group($$2.forGetter(xo::b), bbi.b($$0.listOf()).optionalFieldOf("extra", List.of()).forGetter(xo::c), yl.b.a.forGetter(xo::a))
            .apply($$2x, yc::new)
      );
      return Codec.either(Codec.either(Codec.STRING, bbi.b($$0.listOf())), $$3)
