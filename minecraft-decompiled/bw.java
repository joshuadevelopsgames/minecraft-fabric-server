...
public record bw(Optional<cn> b, Optional<cn> c, Optional<cn> d, Optional<cn> e, Optional<cn> f, Optional<cn> g, Optional<cn> h) {
   ...
   public static bw a(jm<dcr> $$0, jm<eao> $$1) {
      return bw.a.a().a(cn.a.a().a($$0, dcz.ws).a(bo.a.a().a(kk.a(cwj.a($$1).a(), kq.am, kq.h)).b())).b();
   }

   public boolean a(@Nullable bzm $$0) {
      if ($$0 instanceof cam $$1) {
         if (this.b.isPresent() && !this.b.get().a($$1.a(bzw.f))) {
            return false;
         } else if (this.c.isPresent() && !this.c.get().a($$1.a(bzw.e))) {
            return false;
         } else if (this.d.isPresent() && !this.d.get().a($$1.a(bzw.d))) {
            return false;
         } else if (this.e.isPresent() && !this.e.get().a($$1.a(bzw.c))) {
            return false;
         } else if (this.f.isPresent() && !this.f.get().a($$1.a(bzw.g))) {
            return false;
         } else {
            return this.g.isPresent() && !this.g.get().a($$1.a(bzw.a)) ? false : !this.h.isPresent() || this.h.get().a($$1.a(bzw.b));
         }
      } else {
         return false;
      }
