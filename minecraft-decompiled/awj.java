...
class awj implements Path {
   private static final BasicFileAttributes a = new awh() {
      @Override
   ...
   private static final BasicFileAttributes b = new awh() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<awj> c = Comparator.comparing(awj::n);
   ...
   public awj(awl $$0, String $$1, @Nullable awj $$2, awm $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private awj a(@Nullable awj $$0, String $$1) {
      return new awj(this.e, $$1, $$0, awm.b);
   }
   ...
   awj a(String $$0) {
      if (a(this.i)) {
         return new awj(this.e, $$0, this, this.i);
      } else if (this.i instanceof awm.a $$1) {
         awj $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new awj(this.e, $$0, this, awm.a);
      } else if (this.i instanceof awm.b) {
         return new awj(this.e, $$0, this, awm.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(awm $$0) {
      return $$0 == awm.a || $$0 == awm.b;
   }
   ...
   private awj c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof awj $$1 && $$1.e == this.e) {
         return $$1;
      } else {
   ...
   @Nullable
   public Path h() {
      return this.i instanceof awm.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public awm.a i() {
      return this.i instanceof awm.a $$0 ? $$0 : null;
   }
