...
public class cg extends dl<cg.a> {
   ...
   public void a(auc $$0, dcv $$1, cvk $$2, Collection<dcv> $$3) {
      fdj $$4 = bz.b($$0, (bzm)($$2.i() != null ? $$2.i() : $$2));
      this.a($$0, $$3x -> $$3x.a($$1, $$4, $$3));
   }

   public record a(Optional<bj> b, Optional<cn> c, Optional<bj> d, Optional<cn> e) implements dl.a {
      ...
      public boolean a(dcv $$0, fdj $$1, Collection<dcv> $$2) {
         if (this.c.isPresent() && !this.c.get().a($$0)) {
            ...
            if (this.e.isPresent()) {
               boolean $$3 = false;
               bzm $$4 = $$1.c(fgd.a);
               if ($$4 instanceof cqz $$5 && this.e.get().a($$5.e())) {
                  $$3 = true;
               }
