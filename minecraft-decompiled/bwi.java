...
public class bwi extends bwm {
   public static final MapCodec<bwi> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bwi a(float $$0, float $$1, float $$2, float $$3) {
      return new bwi($$0, $$1, $$2, $$3);
   }

   private bwi(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(bck $$0, float $$1, float $$2, float $$3, float $$4) {
      return bcb.a(bcb.c($$0, $$1, $$2), $$3, $$4);
   }
