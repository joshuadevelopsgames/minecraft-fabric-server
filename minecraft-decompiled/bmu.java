...
public class bmu extends bkj {
   private static final Logger c = LogUtils.getLogger();

   public bmu(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", blp.t, "minecraft:trial_spawner");
   }

   public Dynamic<?> a(Dynamic<vi> $$0) {
      Optional<Dynamic<vi>> $$1 = $$0.get("normal_config").result();
      if ($$1.isEmpty()) {
         return $$0;
      } else {
         Optional<Dynamic<vi>> $$2 = $$0.get("ominous_config").result();
         if ($$2.isEmpty()) {
            return $$0;
         } else {
            ame $$3 = bmu.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.a($$0x.convert(uw.a));
         return $$2.convert($$1);
      });
   }

   static final class a {
      public static final Map<Pair<Dynamic<vi>, Dynamic<vi>>, ame> a = new HashMap<>();

      private a() {
      }

      private static void a(ame $$0, String $$1, String $$2) {
         try {
            ui $$3 = a($$1);
            ui $$4 = a($$2);
            ui $$5 = $$3.l().a($$4);
      ...
      private static Dynamic<vi> a(ui $$0) {
         return new Dynamic(uw.a, $$0);
      }

      private static ui a(String $$0) {
         try {
            return vj.a($$0);
      ...
      static {
         ...
         a(
            ame.b("trial_chamber/melee/husk"),
         ...
         a(
            ame.b("trial_chamber/melee/spider"),
         ...
         a(
            ame.b("trial_chamber/melee/zombie"),
         ...
         a(
            ame.b("trial_chamber/ranged/poison_skeleton"),
         ...
         a(
            ame.b("trial_chamber/ranged/skeleton"),
         ...
         a(
            ame.b("trial_chamber/ranged/stray"),
         ...
         a(
            ame.b("trial_chamber/slow_ranged/poison_skeleton"),
         ...
         a(
            ame.b("trial_chamber/slow_ranged/skeleton"),
         ...
         a(
            ame.b("trial_chamber/slow_ranged/stray"),
         ...
         a(
            ame.b("trial_chamber/small_melee/baby_zombie"),
         ...
         a(
            ame.b("trial_chamber/small_melee/cave_spider"),
         ...
         a(
            ame.b("trial_chamber/small_melee/silverfish"),
         ...
         a(
            ame.b("trial_chamber/small_melee/slime"),
