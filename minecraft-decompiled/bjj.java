...
public class bjj extends DataFix {
   ...
   public bjj(Schema $$0, boolean $$1, String $$2) {
      super($$0, $$1);
      this.a = $$2;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + this.getOutputSchema().getVersionKey(), $$0, $$4x -> {
         ...
         if ($$5.isPresent() && Objects.equals($$5.get().getSecond(), this.a)) {
            ...
            if ($$8.isPresent()) {
               return $$4x.set($$1, Pair.of(blp.G.typeName(), b.getOrDefault($$8.get(), "minecraft:pig_spawn_egg")));
            }
         }
