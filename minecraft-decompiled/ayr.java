...
public class ayr extends ayq {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, ayr.a> s;
   private final aym t;
   private long u;
   private final amv v;

   private ayr(amv $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == ayn.c($$2, 7, $$0.getLength());
      }
   }
