...
public abstract class ezz<M extends ezw<M>> {
   private final dnd i;
   protected final egl a;
   ...
   protected final Long2ObjectMap<egd> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected ezz(dnd $$0, egl $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected egd a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected egd a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected egd c(long $$0) {
      egd $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = ke.e($$0);
      egd $$2 = this.a($$1, true);
      return $$2.a(ke.b(jb.a($$0)), ke.b(jb.b($$0)), ke.b(jb.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(ke.b(jb.a($$0)), ke.b(jb.b($$0)), ke.b(jb.c($$0)), $$1);
      ke.a($$0, this.f::add);
   }
   ...
   protected void f(long $$0) {
      ...
      for (int $$4 = -1; $$4 <= 1; $$4++) {
         for (int $$5 = -1; $$5 <= 1; $$5++) {
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               this.f.add(ke.b($$1 + $$5, $$2 + $$6, $$3 + $$4));
            }
         }
      }
   }

   protected egd g(long $$0) {
      egd $$1 = (egd)this.g.get($$0);
      return $$1 != null ? $$1 : new egd();
   }
   ...
   protected void a(fac<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            egd $$2 = (egd)this.g.remove($$1);
            egd $$3 = this.d.d($$1);
            if (this.k.contains(ke.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<egd>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<egd> $$6 = (Entry<egd>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               egd $$8 = (egd)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable egd $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = ke.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, ezz.a.a($$9, ezz.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public ezz.b l(long $$0) {
      return ezz.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static ezz.b c(byte $$0) {
         if ($$0 == 0) {
            return ezz.b.a;
         } else {
            return a($$0) ? ezz.b.c : ezz.b.b;
         }
      }
   }
