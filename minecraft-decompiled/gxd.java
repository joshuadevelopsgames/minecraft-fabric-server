...
public class gxd extends axt<gxd.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final ame b = ame.b("gpu_warnlist.json");
   ...
   protected gxd.a a(axo $$0, btt $$1) {
      ...
      return new gxd.a($$2, $$3, $$4);
   }

   protected void a(gxd.a $$0, axo $$1, btt $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(axo $$0, btt $$1) {
      try {
         JsonObject var4;
         try (
            bty $$2 = $$1.d("parse_json");
            Reader $$3 = $$0.openAsReader(b);
         ) {
            var4 = bcy.a($$3).getAsJsonObject();
         }

         return var4;
      } catch (JsonSyntaxException | IOException var10) {
         a.warn("Failed to load GPU warnlist", var10);
         return null;
      }
   }
