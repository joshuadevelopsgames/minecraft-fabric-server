...
public abstract class avk implements AutoCloseable {
   ...
   protected avk(URL $$0, avk.b $$1, avk.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? bbq.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static avk a(arj $$0) {
      String $$1 = $$0.R;
      if (bdb.h($$1)) {
         return null;
      } else {
   ...
   protected CompletableFuture<auu> a(GameProfile $$0, String $$1, avk.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(auu.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract auu a(String var1, avk.a var2, JsonObject var3);

   protected xs a(String $$0, JsonArray $$1, avk.a $$2) {
      if ($$1.isEmpty()) {
         return xs.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xs.b;
      } else {
         xs $$3 = new xs($$0.length());
   ...
   private JsonObject b(JsonObject $$0, URL $$1) throws IOException {
      ...
      try (InputStream $$3 = $$2.getInputStream()) {
         ...
         try {
            var5 = bbw.a(new InputStreamReader($$3, StandardCharsets.UTF_8)).getAsJsonObject();
         } finally {
            this.a($$3);
         }
      }
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new avk.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      avk.a a = ($$0, $$1) -> false;
      avk.a b = ($$0, $$1) -> $$0.length() == $$1;

      static avk.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static avk.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements avl {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bvy $$2 = new bvy(avk.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a_;
      }

      @Override
      public CompletableFuture<List<auu>> a(List<String> $$0) {
         List<CompletableFuture<auu>> $$1 = $$0.stream().map($$0x -> avk.this.a(this.b, $$0x, avk.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return ag.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<auu> a(String $$0) {
         return avk.this.a(this.b, $$0, avk.this.f, this.c);
      }
   }
