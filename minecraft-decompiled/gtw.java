public class gtw<T extends mf> extends gvt {
   private final gvo a;

   protected gtw(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, T $$7, gvo $$8) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.B = 0.96F;
      this.C = true;
      this.a = $$8;
      ...
      this.t = (int)Math.max($$9 * $$7.d(), 1.0F);
      this.b($$8);
   }
