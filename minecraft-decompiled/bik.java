      ...
      return $$0.update(
         ...
         $$0x -> {
            ...
            $$0x = $$0x.update(
               "Attributes",
               $$1x -> $$1x.createList(
                  $$1x.asStream().map($$1xx -> "minecraft:generic.max_health".equals(bnm.a($$1xx.get("Name").asString(""))) ? $$1xx.update("Base", $$1xxx -> {
