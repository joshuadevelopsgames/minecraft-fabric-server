...
public class awe extends avs {
   ...
   public axg<InputStream> a(String... $$0) {
      ...
      return Files.exists($$1) ? axg.create($$1) : null;
   }
   ...
   @Nullable
   public static axg<InputStream> a(ame $$0, Path $$1) {
      return (axg<InputStream>)w.e($$0.a()).mapOrElse($$1x -> {
         Path $$2 = w.a($$1, $$1x);
         return b($$2);
      }, $$1x -> {
   ...
   @Nullable
   private static axg<InputStream> b(Path $$0) {
      return Files.exists($$0) && a($$0) ? axg.create($$0) : null;
   }
   ...
   public static void a(String $$0, Path $$1, List<String> $$2, awb.a $$3) {
      Path $$4 = w.a($$1, $$2);

      try (Stream<Path> $$5 = Files.find($$4, Integer.MAX_VALUE, awe::a)) {
         $$5.forEach($$3x -> {
   ...
   private static boolean a(Path $$0, BasicFileAttributes $$1) {
      return !ac.aZ ? $$1.isRegularFile() : $$1.isRegularFile() && !StringUtils.equalsIgnoreCase($$0.getFileName().toString(), ".ds_store");
   }
   ...
   public static class a implements aww.c {
      ...
      @Override
      public awb a(awa $$0) {
         return new awe($$0, this.a);
      }

      @Override
      public awb a(awa $$0, aww.a $$1) {
         awb $$2 = this.a($$0);
         List<String> $$3 = $$1.d();
         if ($$3.isEmpty()) {
            return $$2;
         } else {
            List<awb> $$4 = new ArrayList<>($$3.size());
