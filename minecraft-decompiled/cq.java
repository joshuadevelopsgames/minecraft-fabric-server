...
public class cq extends dl<cq.a> {
   ...
   public void a(auc $$0, bzm $$1, byb $$2) {
      fdj $$3 = bz.b($$0, $$1);
      this.a($$0, $$3x -> $$3x.a($$0, $$3, $$2));
   }

   public record a(Optional<bj> b, Optional<bj> c, Optional<bn> d) implements dl.a {
      ...
      public static ar<cq.a> c() {
         return aq.aa.a(new cq.a(Optional.empty(), Optional.empty(), Optional.empty()));
      }
      ...
      public boolean a(auc $$0, fdj $$1, byb $$2) {
