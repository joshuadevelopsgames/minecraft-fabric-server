...
public class ful {
   ...
   public void a(ful.b $$0, List<awb> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ful.c($$0, $$1.stream().map(awb::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ful.c(ful.b.c, ImmutableList.of());
      }

      this.b.c = new ful.a($$0);
   }
   ...
   static class c {
      private final ful.b a;
      private final List<String> b;
      @Nullable
      ful.a c;
      boolean d;

      c(ful.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
