...
public class fnw {
   ...
   static class b {
      static final Optional<fnw> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static fnw a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fnw();
      }
   }
}
