...
public abstract class bfg extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$1 = DSL.named(blp.F.typeName(), bnm.a());
      if (!Objects.equals($$0, $$1)) {
         ...
         TypeRewriteRule $$3 = this.fixTypeEverywhereTyped(
            this.a + " for block_state", this.getInputSchema().getType(blp.v), $$0x -> $$0x.update(DSL.remainderFinder(), this::a)
         );
         TypeRewriteRule $$4 = this.fixTypeEverywhereTyped(
            this.a + " for flat_block_state",
            this.getInputSchema().getType(blp.w),
            $$0x -> $$0x.update(
