...
public class ve implements vm {
   ...
   public ve(String $$0, int $$1, List<String> $$2) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
   }

   public String a(vi $$0) {
      $$0.a(this);
      return this.p;
   }
   ...
   public void a(uo $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$1.append(new ve($$2, this.n + 1, this.o).a($$0.c($$3)));
            if ($$3 != $$0.size() - 1) {
   ...
   public void a(ui $$0) {
      if ($$0.j()) {
         ...
         while ($$4.hasNext()) {
            ...
            vi $$6 = $$0.a($$5);
            this.b($$5);
            $$1.append(Strings.repeat($$2, this.n + 1)).append(a($$5)).append(d).append(" ").append(new ve($$2, this.n + 1, this.o).a($$6));
            this.b();
            if ($$4.hasNext()) {
               $$1.append(e).append($$2.isEmpty() ? " " : "\n");
            }
   ...
   protected static String a(String $$0) {
      return c.matcher($$0).matches() ? $$0 : vg.b($$0);
   }
