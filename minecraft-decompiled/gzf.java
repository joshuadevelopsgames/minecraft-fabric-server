...
public record gzf(Vector3fc b, Vector3fc c, Vector3fc d) {
   public static final gzf a = new gzf(new Vector3f(), new Vector3f(), new Vector3f(1.0F, 1.0F, 1.0F));

   public void a(boolean $$0, fod.a $$1) {
      if (this == a) {
         $$1.a(-0.5F, -0.5F, -0.5F);
      } else {
         float $$2;
   ...
   protected static class a implements JsonDeserializer<gzf> {
      ...
      public gzf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.a($$3, "rotation", c);
         Vector3f $$5 = this.a($$3, "translation", d);
         $$5.mul(0.0625F);
         $$5.set(bcb.a($$5.x, -5.0F, 5.0F), bcb.a($$5.y, -5.0F, 5.0F), bcb.a($$5.z, -5.0F, 5.0F));
         Vector3f $$6 = this.a($$3, "scale", e);
         $$6.set(bcb.a($$6.x, -4.0F, 4.0F), bcb.a($$6.y, -4.0F, 4.0F), bcb.a($$6.z, -4.0F, 4.0F));
         return new gzf($$4, $$5, $$6);
      }
