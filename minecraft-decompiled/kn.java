...
public interface kn extends Iterable<ks<?>>, kl {
   ...
   static Codec<kn> a(Codec<kp<?>> $$0) {
      return b(Codec.dispatchedMap($$0, kp::c));
   }

   static Codec<kn> b(Codec<Map<kp<?>, Object>> $$0) {
      return $$0.flatComapMap(kn.a::a, $$0x -> {
         int $$1 = $$0x.d();
         if ($$1 == 0) {
   ...
   static kn a(final kn $$0, final kn $$1) {
      return new kn() {
         @Nullable
         @Override
         public <T> T a(kp<? extends T> $$0x) {
            T $$1x = $$1.a($$0);
            return $$1x != null ? $$1x : $$0.a($$0);
         }
   ...
   default kn a(final Predicate<kp<?>> $$0) {
      return new kn() {
         @Nullable
         @Override
         public <T> T a(kp<? extends T> $$0x) {
            return $$0.test($$0) ? kn.this.a($$0) : null;
         }

         @Override
         public Set<kp<?>> b() {
            return Sets.filter(kn.this.b(), $$0::test);
         }
      };
   }
   ...
   public static class a {
      ...
      public <T> kn.a a(kp<T> $$0, @Nullable T $$1) {
         this.b($$0, $$1);
         return this;
      }
      ...
      private static kn a(Map<kp<?>, Object> $$0) {
         if ($$0.isEmpty()) {
            return kn.a;
         } else {
            return $$0.size() < 8 ? new kn.a.a(new Reference2ObjectArrayMap($$0)) : new kn.a.a(new Reference2ObjectOpenHashMap($$0));
         }
      }

      record a(Reference2ObjectMap<kp<?>, Object> c) implements kn {
         @Nullable
         @Override
         public <T> T a(kp<? extends T> $$0) {
