...
public record gyf(Map<String, String> c, Set<String> d) {
   public static final gyf a = new gyf(Map.of(), Set.of());
   public static final Codec<gyf> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gyf::d),
            Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gyf::e)
         )
         .apply($$0, gyf::new)
   );

   public static gyf.a a() {
      return new gyf.a();
   }
   ...
   public gyf a(gyf $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gyf($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gyf.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gyf.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gyf.a a(String $$0, int $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gyf.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gyf a() {
         return new gyf(this.a.build(), this.b.build());
      }
   }
}
