...
public class bnc extends DataFix {
   ...
   public bnc(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("WallPropertyFix", this.getInputSchema().getType(blp.v), $$0 -> $$0.update(DSL.remainderFinder(), bnc::a));
   }
   ...
   private static <T> Dynamic<T> a(Dynamic<T> $$0, String $$1) {
      return $$0.update($$1, $$0x -> (Dynamic)DataFixUtils.orElse($$0x.asString().result().map(bnc::a).map($$0x::createString), $$0x));
   }
