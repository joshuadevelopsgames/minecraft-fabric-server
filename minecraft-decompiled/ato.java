...
public abstract class ato {
   ...
   static final int c = ate.a(atp.d);
   final Long2ObjectMap<ObjectSet<auc>> d = new Long2ObjectOpenHashMap();
   private final ats e;
   private final aue f;
   final dnr g;
   private final ato.a h = new ato.a(8);
   private final ato.b i = new ato.b(32);
   protected final Set<atd> b = new ReferenceOpenHashSet();
   final aug j;
   final LongSet k = new LongOpenHashSet();
   final Executor l;
   private int m = 10;

   protected ato(dnr $$0, Executor $$1, Executor $$2) {
      this.g = $$0;
      this.e = new ats(this, $$0);
      this.f = new aue($$0);
      bwe<Runnable> $$3 = bwe.a("player ticket throttler", $$2);
      this.j = new aug($$3, $$1, 4);
      this.l = $$2;
   }
   ...
   @Nullable
   protected abstract atd b(long var1);

   @Nullable
   protected abstract atd a(long var1, int var3, @Nullable atd var4, int var5);

   public boolean a(atf $$0) {
      this.h.a();
      this.f.a();
      this.i.a();
      ...
      if (!this.b.isEmpty()) {
         ...
         if (!this.k.isEmpty()) {
            ...
            while ($$5.hasNext()) {
               long $$6 = $$5.nextLong();
               if (this.g.a($$6).stream().anyMatch($$0x -> $$0x.a() == aui.d)) {
                  atd $$7 = $$0.a($$6);
                  if ($$7 == null) {
                     throw new IllegalStateException();
                  }

                  CompletableFuture<atg<egi>> $$8 = $$7.b();
                  $$8.thenAccept($$1x -> this.l.execute(() -> this.j.a($$6, () -> {}, false)));
               }
            }
   ...
   public void a(ke $$0, auc $$1) {
      dlz $$2 = $$0.r();
      long $$3 = $$2.a();
      ((ObjectSet)this.d.computeIfAbsent($$3, $$0x -> new ObjectOpenHashSet())).add($$1);
      this.h.b($$3, 0, true);
      this.i.b($$3, 0, true);
      this.g.a(new auh(aui.e, this.e()), $$2);
   }

   public void b(ke $$0, auc $$1) {
      dlz $$2 = $$0.r();
      long $$3 = $$2.a();
      ObjectSet<auc> $$4 = (ObjectSet<auc>)this.d.get($$3);
      $$4.remove($$1);
      if ($$4.isEmpty()) {
         this.d.remove($$3);
         this.h.b($$3, Integer.MAX_VALUE, false);
         this.i.b($$3, Integer.MAX_VALUE, false);
         this.g.b(new auh(aui.e, this.e()), $$2);
      }
   }

   private int e() {
      return Math.max(0, ate.a(atp.d) - this.m);
   }

   public boolean c(long $$0) {
      return ate.d(this.f.c($$0));
   }

   public boolean d(long $$0) {
      return ate.e(this.f.c($$0));
   }
   ...
   class a extends atj {
      ...
      private boolean f(long $$0) {
         ObjectSet<auc> $$1 = (ObjectSet<auc>)ato.this.d.get($$0);
   ...
   class b extends ato.a {
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            auh $$4 = new auh(aui.d, ato.c);
            if ($$3) {
               ato.this.j.a(() -> ato.this.l.execute(() -> {
                  if (this.c(this.c($$0))) {
                     ato.this.g.a($$0, $$4);
                     ato.this.k.add($$0);
                  } else {
                     ato.this.j.a($$0, () -> {}, false);
                  }
               }), $$0, () -> $$1);
            } else {
               ato.this.j.a($$0, () -> ato.this.l.execute(() -> ato.this.g.b($$0, $$4)), true);
            }
         }
      }
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  ato.this.j.onLevelChange(new dlz($$1), () -> this.h.get($$1), $$3, $$1x -> {
