...
public class axj extends axu<axj.a> {
   private static final Logger a = LogUtils.getLogger();
   private final Stopwatch b = Stopwatch.createUnstarted();

   public static axk a(axo $$0, List<axi> $$1, Executor $$2, Executor $$3, CompletableFuture<bdk> $$4) {
      axj $$5 = new axj($$1);
      $$5.b($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5x) -> {
         ...
         return $$10.thenApplyAsync($$5xx -> {
            ...
            return new axj.a($$3x.getName(), $$6, $$7, $$8, $$9);
         }, $$3);
      }, $$4);
      return $$5;
   }

   private axj(List<axi> $$0) {
      super($$0);
      this.b.start();
   }

   @Override
   protected CompletableFuture<List<axj.a>> a(Executor $$0, Executor $$1, axo $$2, List<axi> $$3, axu.a<axj.a> $$4, CompletableFuture<?> $$5) {
   ...
   private List<axj.a> a(List<axj.a> $$0) {
      this.b.stop();
      long $$1 = 0L;
