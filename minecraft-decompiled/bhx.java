...
public class bhx extends bdz {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bhx::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bhx::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bhx::k);
         $$0 = this.a($$0, "minecraft:fox", bhx::j);
         $$0 = this.a($$0, "minecraft:item", bhx::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bhx::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bhx::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bhx::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bhx::e);
         return this.a($$0, "minecraft:piglin", bhx::d);
      });
   }
