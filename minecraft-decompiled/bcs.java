...
public class bcs implements bao {
   ...
   public bcs(int $$0, int $$1) {
      this($$0, $$1, (long[])null);
   }

   public bcs(int $$0, int $$1, @Nullable long[] $$2) {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new bcs.a("Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4);
         }
   ...
   private int b(int $$0) {
      ...
      return (int)($$0 * $$1 + $$2 >> 32 >> this.i);
   }

   @Override
   public int a(int $$0, int $$1) {
      Validate.inclusiveBetween(0L, this.e - 1, $$0);
      Validate.inclusiveBetween(0L, this.d, $$1);
      int $$2 = this.b($$0);
      long $$3 = this.b[$$2];
      int $$4 = ($$0 - $$2 * this.f) * this.c;
      int $$5 = (int)($$3 >> $$4 & this.d);
      this.b[$$2] = $$3 & ~(this.d << $$4) | ($$1 & this.d) << $$4;
      return $$5;
   }
   ...
   @Override
   public bao d() {
      return new bcs(this.c, this.e, (long[])this.b.clone());
   }
