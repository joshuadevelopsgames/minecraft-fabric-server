...
public class bcb {
   ...
   private static final float[] p = ag.a(new float[65536], $$0x -> {
      for (int $$1x = 0; $$1x < $$0x.length; $$1x++) {
         $$0x[$$1x] = (float)Math.sin($$1x * Math.PI * 2.0 / 65536.0);
      }
   });
   private static final bck q = bck.b();
   ...
   public static int a(bck $$0, int $$1, int $$2) {
      return $$1 >= $$2 ? $$1 : $$0.a($$2 - $$1 + 1) + $$1;
   }

   public static float a(bck $$0, float $$1, float $$2) {
      return $$1 >= $$2 ? $$1 : $$0.i() * ($$2 - $$1) + $$1;
   }

   public static double a(bck $$0, double $$1, double $$2) {
   ...
   public static byte g(float $$0) {
      return (byte)d($$0 * 256.0F / 360.0F);
   }
   ...
   public static int f(int $$0) {
      $$0 = e($$0) ? $$0 : c($$0);
      return r[(int)($$0 * 125613361L >> 27) & 31];
   }
   ...
   public static boolean a(fis $$0, fis $$1, fin $$2) {
      double $$3 = ($$2.a + $$2.d) * 0.5;
      double $$4 = ($$2.d - $$2.a) * 0.5;
      double $$5 = $$0.d - $$3;
      if (Math.abs($$5) > $$4 && $$5 * $$1.d >= 0.0) {
         return false;
      } else {
         double $$6 = ($$2.b + $$2.e) * 0.5;
         double $$7 = ($$2.e - $$2.b) * 0.5;
         double $$8 = $$0.e - $$6;
         if (Math.abs($$8) > $$7 && $$8 * $$1.e >= 0.0) {
            return false;
         } else {
            double $$9 = ($$2.c + $$2.f) * 0.5;
            double $$10 = ($$2.f - $$2.c) * 0.5;
            double $$11 = $$0.f - $$9;
            if (Math.abs($$11) > $$10 && $$11 * $$1.f >= 0.0) {
               return false;
            } else {
               double $$12 = Math.abs($$1.d);
               double $$13 = Math.abs($$1.e);
               double $$14 = Math.abs($$1.f);
               double $$15 = $$1.e * $$11 - $$1.f * $$8;
   ...
   public static int a(float $$0, float $$1, float $$2, int $$3) {
      ...
      return baj.a($$3, a((int)($$9 * 255.0F), 0, 255), a((int)($$10 * 255.0F), 0, 255), a((int)($$11 * 255.0F), 0, 255));
   }
   ...
   public static fis a(double $$0, fis $$1, fis $$2) {
      return new fis(d($$0, $$1.d, $$2.d), d($$0, $$1.e, $$2.e), d($$0, $$1.f, $$2.f));
   }
   ...
   public static float c(float $$0, float $$1, float $$2, float $$3, float $$4) {
      return h(f($$0, $$1, $$2), $$3, $$4);
   }

   public static double l(double $$0) {
      return $$0 + (2.0 * bck.a((long)a($$0 * 3000.0)).j() - 1.0) * 1.0E-7 / 2.0;
   }
   ...
   public static int b(bck $$0, int $$1, int $$2) {
      return $$0.a($$2 - $$1 + 1) + $$1;
   }

   public static float b(bck $$0, float $$1, float $$2) {
      return $$0.i() * ($$2 - $$1) + $$1;
   }

   public static float c(bck $$0, float $$1, float $$2) {
   ...
   public static float f(float $$0, float $$1) {
      return (float)Math.sqrt(e((double)$$0, (double)$$1));
   }
   ...
   public static float m(float $$0) {
      return -(b((float) Math.PI * $$0) - 1.0F) / 2.0F;
   }
