...
public class bel extends bkj {
   ...
   public bel(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", blp.t, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bel::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bel::b)));
   }
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      $$0 = $$0.set("color", $$0.createString(bdt.a($$0.get("Color").asInt(0))));
