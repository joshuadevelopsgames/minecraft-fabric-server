...
public class elb implements bck {
   ...
   public static final Codec<elb> b = ela.a.xmap($$0 -> new elb($$0), $$0 -> $$0.e);
   private ela e;
   private final ekc f = new ekc(this);

   public elb(long $$0) {
      this.e = new ela(ekp.c($$0));
   }
   ...
   @Override
   public ekn e() {
      return new elb.a(this.e.a(), this.e.a());
   }
   ...
   @Override
   public double j() {
      return this.c(53) * 1.110223E-16F;
   }
   ...
   public static class a implements ekn {
      ...
      public bck a(int $$0, int $$1, int $$2) {
         long $$3 = bcb.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new elb($$4, this.b);
      }

      @Override
      public bck a(String $$0) {
         ekp.a $$1 = ekp.a($$0);
         return new elb($$1.a(this.a, this.b));
      }

      @Override
      public bck a(long $$0) {
         return new elb($$0 ^ this.a, $$0 ^ this.b);
      }
