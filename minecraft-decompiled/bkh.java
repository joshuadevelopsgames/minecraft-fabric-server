...
public class bkh extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getOutputSchema().getType(blp.I);
      return this.fixTypeEverywhereTyped("MobSpawnerEntityIdentifiersFix", this.getInputSchema().getType(blp.I), $$0, $$1 -> {
