...
public class fag extends LongLinkedOpenHashSet {
   private final fag.a a;

   public fag(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new fag.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = bcb.g(60000000);
      private static final int b = bcb.g(60000000);
