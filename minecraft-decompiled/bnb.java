...
public class bnb extends DataFix {
   public bnb(Schema $$0) {
      super($$0, false);
   }

   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(blp.y);
      OpticFinder<?> $$1 = $$0.findField("buy");
      OpticFinder<?> $$2 = $$0.findField("buyB");
      OpticFinder<?> $$3 = $$0.findField("sell");
      OpticFinder<Pair<String, String>> $$4 = DSL.fieldFinder("id", DSL.named(blp.G.typeName(), bnm.a()));
