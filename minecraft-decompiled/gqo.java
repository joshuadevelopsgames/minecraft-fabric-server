public class gqo {
   ...
   public static final String af = "inner_body";
   public static final String ag = "hat_rim";
   public static final String ah = "goggles";
   public static final String ai = "jacket";
   public static final String aj = "harness";
   public static final String ak = "top_gills";
   public static final String al = "left_gills";
   public static final String am = "right_gills";
   public static final String an = "root";
   public static final String ao = "croaking_body";
   public static final String ap = "tongue";
   public static final String aq = "tongue_r1";
   public static final String ar = "left_hand";
   public static final String as = "right_hand";
   public static final String at = "left_foot";
   public static final String au = "right_foot";
   public static final String av = "eyes";
   public static final String aw = "right_tendril";
   public static final String ax = "left_tendril";
   public static final String ay = "right_ribcage";
   public static final String az = "left_ribcage";
   public static final String aA = "wind_body";
   public static final String aB = "wind_top";
   public static final String aC = "wind_mid";
   public static final String aD = "wind_bottom";
   public static final String aE = "rods";
   public static final String aF = "mushrooms";
   public static final String aG = "bone";
   public static final String aH = "left_paddle";
   public static final String aI = "right_paddle";
   public static final String aJ = "bottom";
   public static final String aK = "chest_bottom";
   public static final String aL = "chest_lid";
   public static final String aM = "chest_lock";
