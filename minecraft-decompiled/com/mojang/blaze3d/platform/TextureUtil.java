...
public class TextureUtil {
   ...
   public static void writeAsPNG(Path $$0, String $$1, GpuTexture $$2, int $$3, IntUnaryOperator $$4) {
      ...
      Runnable $$9 = () -> {
         try (GpuBuffer.MappedView $$7x = $$8.mapBuffer($$7, true, false)) {
            int $$8x = 0;

            for (int $$9x = 0; $$9x <= $$3; $$9x++) {
               int $$10x = $$2.getWidth($$9x);
               int $$11x = $$2.getHeight($$9x);

               try (fnf $$12x = new fnf($$10x, $$11x, false)) {
                  for (int $$13 = 0; $$13 < $$11x; $$13++) {
                     for (int $$14 = 0; $$14 < $$10x; $$14++) {
                        int $$15 = $$7x.data().getInt($$8x + ($$14 + $$13 * $$10x) * $$2.getFormat().pixelSize());
               ...
               $$8x += $$2.getFormat().pixelSize() * $$10x * $$11x;
            }
         }
