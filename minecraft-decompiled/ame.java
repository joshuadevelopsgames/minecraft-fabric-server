...
public final class ame implements Comparable<ame> {
   public static final Codec<ame> a = Codec.STRING.comapFlatMap(ame::d, ame::toString).stable();
   public static final zm<ByteBuf, ame> b = zk.p.a(ame::a, ame::toString);
   ...
   private static ame d(String $$0, String $$1) {
      return new ame(e($$0, $$1), f($$0, $$1));
   }

   public static ame a(String $$0, String $$1) {
      return d($$0, $$1);
   }
   ...
   public static ame b(String $$0) {
      return new ame("minecraft", f("minecraft", $$0));
   }

   @Nullable
   public static ame c(String $$0) {
      return b($$0, ':');
   }

   @Nullable
   public static ame b(String $$0, String $$1) {
      return j($$0) && i($$1) ? new ame($$0, $$1) : null;
   }

   public static ame a(String $$0, char $$1) {
      int $$2 = $$0.indexOf($$1);
      if ($$2 >= 0) {
   ...
   @Nullable
   public static ame b(String $$0, char $$1) {
      int $$2 = $$0.indexOf($$1);
      if ($$2 >= 0) {
         String $$3 = $$0.substring($$2 + 1);
         if (!i($$3)) {
            ...
            String $$4 = $$0.substring(0, $$2);
            return j($$4) ? new ame($$4, $$3) : null;
         } else {
            return new ame("minecraft", $$3);
         }
      } else {
         return i($$0) ? new ame("minecraft", $$0) : null;
      }
   }

   public static DataResult<ame> d(String $$0) {
      try {
   ...
   public ame e(String $$0) {
      return new ame(this.h, f(this.h, $$0));
   }

   public ame a(UnaryOperator<String> $$0) {
      return this.e($$0.apply(this.i));
   }

   public ame f(String $$0) {
      return this.e($$0 + this.i);
   }

   public ame g(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof ame $$1) ? false : this.h.equals($$1.h) && this.i.equals($$1.i);
      }
   }
   ...
   public static ame a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
      String $$2 = c($$0);
   ...
   public static ame b(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
      String $$2 = c($$0);
      if ($$2.isEmpty()) {
         throw c.createWithContext($$0);
