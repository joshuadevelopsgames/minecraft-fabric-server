...
public record yj(int b, UUID c, UUID d) {
   public static final Codec<yj> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(bbi.o.fieldOf("index").forGetter(yj::b), kf.a.fieldOf("sender").forGetter(yj::c), kf.a.fieldOf("session_id").forGetter(yj::d))
         .apply($$0, yj::new)
   );
   ...
   public void a(bcp.a $$0) throws SignatureException {
      $$0.update(kf.b(this.c));
      $$0.update(kf.b(this.d));
