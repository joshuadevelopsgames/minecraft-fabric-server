...
public class ay extends dl<ay.a> {
   ...
   public void a(auc $$0, eeb $$1, dcv $$2, int $$3) {
      this.a($$0, $$3x -> $$3x.a($$1, $$2, $$3));
   }

   public record a(Optional<bj> b, Optional<jl<dpz>> c, Optional<cn> d, cx.d e) implements dl.a {
      public static final Codec<ay.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
               bz.b.optionalFieldOf("player").forGetter(ay.a::a),
               mm.e.r().optionalFieldOf("block").forGetter(ay.a::b),
      ...
      public static ar<ay.a> a(dpz $$0, cn.a $$1, cx.d $$2) {
         return aq.L.a(new ay.a(Optional.empty(), Optional.of($$0.p()), Optional.of($$1.b()), $$2));
      }

      public boolean a(eeb $$0, dcv $$1, int $$2) {
