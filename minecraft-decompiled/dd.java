...
public class dd extends dl<dd.a> {
   ...
   public void a(auc $$0, dcv $$1, bzm $$2) {
      fdj $$3 = bz.b($$0, $$2);
      this.a($$0, $$2x -> $$2x.a($$1, $$3));
   }

   public record a(Optional<bj> b, Optional<cn> c, Optional<bj> d) implements dl.a {
      ...
      public static ar<dd.a> b(Optional<bj> $$0, cn.a $$1, Optional<bj> $$2) {
         return aq.U.a(new dd.a($$0, Optional.of($$1.b()), $$2));
      }

      public static ar<dd.a> a(cn.a $$0, Optional<bj> $$1) {
         return aq.U.a(new dd.a(Optional.empty(), Optional.of($$0.b()), $$1));
      }

      public static ar<dd.a> b(cn.a $$0, Optional<bj> $$1) {
         return a(Optional.empty(), $$0, $$1);
      }

      public boolean a(dcv $$0, fdj $$1) {
