...
public class w {
   ...
   public static String d(String $$0) {
      return FilenameUtils.normalize($$0).replace(File.separator, "/");
   }

   public static DataResult<List<String>> e(String $$0) {
      int $$1 = $$0.indexOf(47);
      if ($$1 == -1) {
         return switch ($$0) {
            case "", ".", ".." -> DataResult.error(() -> "Invalid path '" + $$0 + "'");
            default -> !f($$0) ? DataResult.error(() -> "Invalid path '" + $$0 + "'") : DataResult.success(List.of($$0));
         };
      } else {
