...
public interface bf<T, P extends Predicate<T>> extends Predicate<Iterable<T>> {
   ...
   public record a<T, P extends Predicate<T>>(P a, cx.d b) {
      public static <T, P extends Predicate<T>> Codec<bf.a<T, P>> a(Codec<P> $$0) {
         return RecordCodecBuilder.create(
            $$1 -> $$1.group($$0.fieldOf("test").forGetter(bf.a::a), cx.d.d.fieldOf("count").forGetter(bf.a::b)).apply($$1, bf.a::new)
         );
      }
   ...
   public record b<T, P extends Predicate<T>>(List<bf.a<T, P>> a) implements bf<T, P> {
      public boolean a(Iterable<T> $$0) {
   ...
   public record c<T, P extends Predicate<T>>(bf.a<T, P> a) implements bf<T, P> {
      public boolean a(Iterable<T> $$0) {
         return this.a.a($$0);
      }
