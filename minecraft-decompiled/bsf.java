...
public final class bsf implements DynamicMBean {
   private static final Logger a = LogUtils.getLogger();
   private final MinecraftServer b;
   private final MBeanInfo c;
   private final Map<String, bsf.a> d = Stream.of(
         new bsf.a("tickTimes", this::b, "Historical tick times (ms)", long[].class),
         new bsf.a("averageTickTime", this::a, "Current average tick time (ms)", long.class)
      )
      .collect(Collectors.toMap($$0x -> $$0x.a, Function.identity()));

   private bsf(MinecraftServer $$0) {
      this.b = $$0;
      MBeanAttributeInfo[] $$1 = this.d.values().stream().map(bsf.a::a).toArray(MBeanAttributeInfo[]::new);
      this.c = new MBeanInfo(bsf.class.getSimpleName(), "metrics for dedicated server", $$1, null, null, new MBeanNotificationInfo[0]);
   }

   public static void a(MinecraftServer $$0) {
      try {
         ManagementFactory.getPlatformMBeanServer().registerMBean(new bsf($$0), new ObjectName("net.minecraft.server:type=Server"));
