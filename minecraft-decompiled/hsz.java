...
public class hsz extends ud {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private hsz(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static hsz a(axo $$0, List<String> $$1, boolean $$2) {
      ...
      uc.a().a($$3);
      return new hsz(Map.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<axm> $$1, Map<String, String> $$2) {
      for (axm $$3 : $$1) {
