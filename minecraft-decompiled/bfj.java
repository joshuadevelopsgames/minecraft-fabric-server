...
public class bfj extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getInputSchema().getType(blp.E);
      Type<?> $$2 = this.getOutputSchema().getType(blp.E);
      return this.fixTypeEverywhereTyped("BoatSplitFix", $$1, $$2, $$2x -> {
         ...
         if ($$3.isPresent() && c($$3.get())) {
            ...
            String $$6;
            if (b($$3.get())) {
               $$6 = $$5.map(bfj::e).orElse("minecraft:oak_chest_boat");
            } else {
               $$6 = $$5.map(bfj::d).orElse("minecraft:oak_boat");
            }

            return bdt.a($$2, $$2x).update(DSL.remainderFinder(), $$0xx -> $$0xx.remove("Type")).set($$0, $$6);
         } else {
            return bdt.a($$2, $$2x);
         }
      });
