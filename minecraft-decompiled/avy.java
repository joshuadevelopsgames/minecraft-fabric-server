...
public class avy extends avs {
   ...
   private final avy.b d;
   private final String e;

   avy(awa $$0, avy.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(awd $$0, ame $$1) {
   ...
   @Nullable
   private axg<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : axg.create($$1, $$2);
      }
   }
   ...
   public static class a implements aww.c {
      ...
      @Override
      public awb a(awa $$0) {
         avy.b $$1 = new avy.b(this.a);
         return new avy($$0, $$1, "");
      }

      @Override
      public awb a(awa $$0, aww.a $$1) {
         avy.b $$2 = new avy.b(this.a);
         awb $$3 = new avy($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<awb> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  avy.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
