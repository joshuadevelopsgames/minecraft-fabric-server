...
public class bws extends bwm {
   public static final MapCodec<bws> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bws a(float $$0, float $$1, float $$2) {
      return new bws($$0, $$1, $$2);
   }

   private bws(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
