...
public record de(cx.d d, ci e, List<de.e<?>> f, Object2BooleanMap<amd<dhm<?>>> g, Map<ame, de.c> h, Optional<bz> i, Optional<ck> j) implements ca {
   ...
   public static final MapCodec<de> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
            ...
            bbi.f(dhm.b).optionalFieldOf("recipes", Object2BooleanMaps.emptyMap()).forGetter(de::e),
            Codec.unboundedMap(ame.a, de.c.b).optionalFieldOf("advancements", Map.of()).forGetter(de::f),
   ...
   public boolean a(bzm $$0, aub $$1, @Nullable fis $$2) {
      if (!($$0 instanceof auc $$3)) {
         return false;
      } else if (!this.d.d($$3.cB)) {
         return false;
         ...
         while (var13.hasNext()) {
            Entry<amd<dhm<?>>> $$8 = (Entry<amd<dhm<?>>>)var13.next();
            if ($$7.b((amd<dhm<?>>)$$8.getKey()) != $$8.getBooleanValue()) {
               return false;
            }
         }
         ...
         if (!this.h.isEmpty()) {
            ...
            for (java.util.Map.Entry<ame, de.c> $$11 : this.h.entrySet()) {
         ...
         if (this.i.isPresent()) {
            fis $$13 = $$3.bI();
            fis $$14 = $$3.h(1.0F);
            fis $$15 = $$13.b($$14.d * 100.0, $$14.e * 100.0, $$14.f * 100.0);
            fip $$16 = cvq.a($$3.y(), $$3, $$13, $$15, new fin($$13, $$15).g(1.0), $$0x -> !$$0x.am(), 0.0F);
            if ($$16 == null || $$16.d() != fiq.a.c) {
               return false;
            }
   ...
   public Object2BooleanMap<amd<dhm<?>>> e() {
      return this.g;
   }

   public Map<ame, de.c> f() {
      return this.h;
   }
   ...
   record a(Object2BooleanMap<String> c) implements de.c {
      public static final Codec<de.a> a = bbi.f(Codec.STRING).xmap(de.a::new, de.a::a);
   ...
   record b(boolean c) implements de.c {
   ...
   public static class d {
      ...
      private final Object2BooleanMap<amd<dhm<?>>> d = new Object2BooleanOpenHashMap();
      private final Map<ame, de.c> e = Maps.newHashMap();
      ...
      public <T> de.d a(azi<T> $$0, jl.c<T> $$1, cx.d $$2) {
         this.c.add(new de.e<>($$0, $$1, $$2));
         return this;
      }

      public de.d a(amd<dhm<?>> $$0, boolean $$1) {
         this.d.put($$0, $$1);
         return this;
      }
      ...
      public de.d a(ame $$0, boolean $$1) {
         this.e.put($$0, new de.b($$1));
         return this;
      }

      public de.d a(ame $$0, Map<String, Boolean> $$1) {
   ...
   record e<T>(azi<T> b, jl<T> c, cx.d d, Supplier<azg<T>> e) {
      public static final Codec<de.e<?>> a = mm.v.q().dispatch(de.e::a, de.e::a);

      public e(azi<T> $$0, jl<T> $$1, cx.d $$2) {
         this($$0, $$1, $$2, Suppliers.memoize(() -> $$0.b($$1.a())));
      }

      private static <T> MapCodec<de.e<T>> a(azi<T> $$0) {
