...
public class bls extends bkk {
   public bls(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", blp.t, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bnm.a($$0.get("id").asString("minecraft:air"));
