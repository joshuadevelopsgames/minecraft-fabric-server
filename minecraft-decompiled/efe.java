...
public abstract class efe<T extends Comparable<T>> {
   ...
   private final Codec<efe.a<T>> e = this.d.xmap(this::c, efe.a::b);

   protected efe(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public efe.a<T> c(T $$0) {
      return new efe.a<>(this, $$0);
   }

   public efe.a<T> a(eed<?, ?> $$0) {
      return new efe.a<>(this, $$0.c(this));
   }

   public Stream<efe.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof efe<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends eed<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public record a<T extends Comparable<T>>(efe<T> a, T b) {
      public a(efe<T> a, T b) {
         if (!a.a().contains(b)) {
