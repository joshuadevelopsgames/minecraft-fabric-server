...
public class al implements Comparable<al> {
   ...
   private static final Codec<Instant> c = bbi.a(b).xmap(Instant::from, $$0 -> $$0.atZone(ZoneId.systemDefault()));
   ...
   public static al b(wg $$0) {
      Map<String, as> $$1 = $$0.a(wg::p, as::b);
      return new al($$1);
   }
   ...
   public xo d() {
      if (this.e.isEmpty()) {
         ...
         if ($$0 <= 1) {
            ...
            int $$1 = this.h();
            return xo.a("advancements.progress", $$1, $$0);
         }
      }
   }
