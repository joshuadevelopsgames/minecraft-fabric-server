public class guh extends gvt {
   static final bck a = bck.a();
   private final gvo b;

   guh(grk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gvo $$7) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.B = 0.96F;
      this.C = true;
      this.b = $$7;
   ...
   public static class a implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         guh $$8 = new guh($$1, $$2, $$3, $$4, 0.0, 0.0, 0.0, this.b);
         $$8.a(1.0F, 0.9F, 1.0F);
   ...
   public static class b implements guw<mi> {
      ...
      public gut a(mi $$0, grk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         guh $$8 = new guh($$1, $$2, $$3, $$4, 0.5 - guh.a.j(), $$6, 0.5 - guh.a.j(), this.a);
         if ($$1.A.h()) {
            $$8.a(0.6F, 1.0F, 0.8F);
         } else {
            $$8.a(0.08F, 0.4F, 0.4F);
   ...
   public static class e implements guw<mi> {
      private final double a = 0.01;
      private final gvo b;
