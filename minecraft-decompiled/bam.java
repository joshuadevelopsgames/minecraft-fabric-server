...
public class bam<T> extends AbstractList<T> implements bby<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return bam.this.get(this.b--);
      }

      @Override
      public void remove() {
         bam.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements bby<T> {
      private final bam<T> b;

      public b(final bam<T> $$0) {
         this.b = $$0;
      }
