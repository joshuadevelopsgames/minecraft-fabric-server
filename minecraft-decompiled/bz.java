...
public record bz(
   ...
   public static final Codec<bz> a = Codec.recursive(
      ...
      $$0 -> RecordCodecBuilder.create(
         $$1 -> $$1.group(
               ...
               bbi.p.optionalFieldOf("periodic_tick").forGetter(bz::j),
   ...
   public static bj a(bz $$0) {
      fgs $$1 = fgv.a(fdj.b.a, $$0).build();
      return new bj(List.of($$1));
   }

   public boolean a(auc $$0, @Nullable bzm $$1) {
      return this.a($$0.y(), $$0.dv(), $$1);
   }

   public boolean a(aub $$0, @Nullable fis $$1, @Nullable bzm $$2) {
      if ($$2 == null) {
         return false;
      } else if (this.c.isPresent() && !this.c.get().a($$2.ap())) {
         return false;
      } else {
         if ($$1 == null) {
            if (this.d.isPresent()) {
         ...
         if (this.e.isPresent()) {
            fis $$3 = $$2.ae();
            fis $$4 = $$3.c(20.0);
            if (!this.e.get().a($$4.d, $$4.e, $$4.f, $$2.am)) {
               return false;
            }
         }
         ...
         if (this.f.b.isPresent() && !this.f.b.get().a($$0, $$2.dC(), $$2.dE(), $$2.dI())) {
            ...
            if (this.f.c.isPresent()) {
               fis $$5 = fis.b($$2.aU());
               if (!$$2.aK() || !this.f.c.get().a($$0, $$5.a(), $$5.b(), $$5.c())) {
                  return false;
               }
            }
            ...
            if (this.g.isPresent() && !this.g.get().a($$2)) {
               ...
               return false;
            } else if (this.o.isPresent() && !this.o.get().a($$0, $$1, $$2 instanceof cao ? ((cao)$$2).e() : null)) {
               return false;
            } else if (this.l.isPresent() && $$2.as % this.l.get() != 0) {
               return false;
            } else {
               if (this.p.isPresent()) {
                  fjz $$7 = $$2.cu();
   ...
   public static fdj b(auc $$0, bzm $$1) {
      fdm $$2 = new fdm.a($$0.y()).a(fgd.a, $$1).a(fgd.f, $$0.dv()).a(fgc.n);
      return new fdj.a($$2).a(Optional.empty());
   }
   ...
   public static class a {
      ...
      public bz.a a(jm<bzv<?>> $$0, bzv<?> $$1) {
         this.a = Optional.of(cc.a($$0, $$1));
         return this;
      }

      public bz.a a(jm<bzv<?>> $$0, bae<bzv<?>> $$1) {
         this.a = Optional.of(cc.a($$0, $$1));
         return this;
      }
   ...
   public record b(Optional<cv> b, Optional<cv> c, Optional<cv> d) {
