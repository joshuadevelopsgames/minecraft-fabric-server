...
public class ehk implements ehh, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bwb c;
   private final ehp d;
   private final SequencedMap<dlz, ehk.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected ehk(ehr $$0, Path $$1, boolean $$2) {
      this.d = new ehp($$0, $$1, $$2);
      this.c = new bwb(ehk.b.values().length, ag.i(), "IOWorker-" + $$0.c());
   }

   public boolean a(dlz $$0, int $$1) {
      dlz $$2 = new dlz($$0.h - $$1, $$0.i - $$1);
      dlz $$3 = new dlz($$0.h + $$1, $$0.i + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         dlz $$3 = dlz.b($$0, $$1);
         BitSet $$4 = new BitSet();
         dlz.a($$2, $$3).forEach($$1xx -> {
            vp $$2x = new vp(new vr(un.a, "DataVersion"), new vr(ui.b, "blending_data"));
            ...
            if ($$2x.d() instanceof ui $$5 && this.a($$5)) {
   ...
   public CompletableFuture<Void> a(dlz $$0, Supplier<ui> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         ui $$2 = $$1.get();
         ehk.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new ehk.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<ui>> a(dlz $$0) {
      return this.a((ehk.c<Optional<ui>>)(() -> {
         ehk.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((ehk.c<Void>)(() -> {
         try {
            this.d.a();
            return null;
   ...
   @Override
   public CompletableFuture<Void> a(dlz $$0, vf $$1) {
      return this.a((ehk.c<Void>)(() -> {
         try {
            ehk.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(ehk.c<T> $$0) {
      return this.c.a(ehk.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dlz, ehk.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bwd.c(ehk.b.b.ordinal(), this::b));
   }

   private void a(dlz $$0, ehk.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(ehk.b.c.ordinal(), $$0 -> $$0.complete(bdk.a)).join();
   }
