...
public class ezo {
   ...
   private final ezo.a g;

   @Deprecated
   public static ezo a(bck $$0, ezo.a $$1) {
      return new ezo($$0, $$1, false);
   }

   public static ezo a(bck $$0, int $$1, double... $$2) {
      return b($$0, new ezo.a($$1, new DoubleArrayList($$2)));
   }

   public static ezo b(bck $$0, ezo.a $$1) {
      return new ezo($$0, $$1, true);
   }

   private ezo(bck $$0, ezo.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public record a(int c, DoubleList d) {
      public static final Codec<ezo.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ezo.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ezo.a::b))
            .apply($$0, ezo.a::new)
      );
      public static final Codec<jl<ezo.a>> b = ama.a(mn.bd, a);
