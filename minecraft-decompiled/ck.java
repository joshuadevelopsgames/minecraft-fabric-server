...
public record ck(
   ...
   public static final Codec<ck> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            Codec.BOOL.optionalFieldOf("forward").forGetter(ck::a),
            Codec.BOOL.optionalFieldOf("backward").forGetter(ck::b),
            Codec.BOOL.optionalFieldOf("left").forGetter(ck::c),
            Codec.BOOL.optionalFieldOf("right").forGetter(ck::d),
            Codec.BOOL.optionalFieldOf("jump").forGetter(ck::e),
            Codec.BOOL.optionalFieldOf("sneak").forGetter(ck::f),
            Codec.BOOL.optionalFieldOf("sprint").forGetter(ck::g)
         )
         .apply($$0, ck::new)
   );
