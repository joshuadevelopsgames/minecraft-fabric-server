...
public class epj implements epm {
   public static final Codec<epj> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ...
            bwo.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
            bwo.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
            ...
            bwo.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
            bwm.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
            bwm.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public epj(int $$0, bwo $$1, bwo $$2, int $$3, int $$4, bwo $$5, bwm $$6, bwm $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
