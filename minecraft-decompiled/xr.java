...
public class xr {
   ...
   public static final xo b = xo.b(", ").a(o.h);
   ...
   public static Optional<yc> a(@Nullable ek $$0, Optional<xo> $$1, @Nullable bzm $$2, int $$3) throws CommandSyntaxException {
      return $$1.isPresent() ? Optional.of(a($$0, $$1.get(), $$2, $$3)) : Optional.empty();
   }

   public static yc a(@Nullable ek $$0, xo $$1, @Nullable bzm $$2, int $$3) throws CommandSyntaxException {
      if ($$3 > 100) {
         return $$1.f();
      } else {
         yc $$4 = $$1.b().a($$0, $$2, $$3 + 1);
   ...
   private static yl a(@Nullable ek $$0, yl $$1, @Nullable bzm $$2, int $$3) throws CommandSyntaxException {
      if ($$1.j() instanceof xu.e var5) {
         xu.e var10000 = var5;
   ...
   public static xo a(Message $$0) {
      return (xo)($$0 instanceof xo $$1 ? $$1 : xo.b($$0.getString()));
   }
   ...
   public static yc a(String $$0) {
      return a((xo)xo.b($$0).a($$1 -> $$1.a(o.k).a(new xm.c($$0)).a(new xu.e(xo.c("chat.copy.click"))).a($$0)));
   }
}
