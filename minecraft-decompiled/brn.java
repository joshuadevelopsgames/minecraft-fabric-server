...
public class brn extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return brq.a(new Dynamic($$0, $$1), brn.a, brq.a);
      }
   };

   public brn(int $$0, Schema $$1) {
      super($$0, $$1);
   }

   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), blp.t.typeName()) ? super.getChoiceType($$0, bnm.a($$1)) : super.getChoiceType($$0, $$1);
   }

   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      Map<String, Supplier<TypeTemplate>> $$1 = super.registerBlockEntities($$0);
      bew.a.forEach(($$1x, $$2) -> $$1.put($$2, Objects.requireNonNull($$1.remove($$1x), () -> "Didn't find " + $$1x + " in schema")));
      return $$1;
   }

   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      super.registerTypes($$0, $$1, $$2);
      $$0.registerType(true, blp.t, () -> DSL.optionalFields("components", blp.x.in($$0), DSL.taggedChoiceLazy("id", bnm.a(), $$2)));
