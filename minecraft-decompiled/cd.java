...
public class cd extends dl<cd.a> {
   ...
   public void a(auc $$0, fis $$1, @Nullable bzm $$2) {
      fis $$3 = $$0.dv();
      fdj $$4 = $$2 != null ? bz.b($$0, $$2) : null;
      this.a($$0, $$4x -> $$4x.a($$0.y(), $$1, $$3, $$4));
   }

   public record a(Optional<bj> b, Optional<cv> c, Optional<bq> d, Optional<bj> e) implements dl.a {
      ...
      public static ar<cd.a> a(bq $$0, bz.a $$1) {
         return aq.af.a(new cd.a(Optional.empty(), Optional.empty(), Optional.of($$0), Optional.of(bz.a($$1))));
      }
      ...
      public boolean a(aub $$0, fis $$1, fis $$2, @Nullable fdj $$3) {
