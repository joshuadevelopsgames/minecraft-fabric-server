...
public class grc implements grx {
   ...
   private CompletableFuture<Optional<cuw>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public grc(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cuw::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cuw>> a(Optional<cuw> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (bay | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cuw.a.parse(JsonOps.INSTANCE, bcy.a($$0)).result();
            }
   ...
   private void a(@Nullable cuw $$0) {
      ...
      if ($$0 != null) {
         if (ac.aZ) {
            cuw.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cuw a(UserApiService $$0) throws bay, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cux.a $$2 = a($$1);
         return new cuw(bax.a($$1.keyPair().privateKey()), new cux($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cux.a a(KeyPairResponse $$0) throws bay {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = bax.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new cux.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new bay(var5);
         }
      } else {
         throw new bay(new MissingException("Missing public key"));
      }
   }
}
