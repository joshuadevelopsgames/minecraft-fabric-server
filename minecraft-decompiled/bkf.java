...
public class bkf extends DataFix {
         ...
         ImmutableMap.of(
            ...
            a(
               ...
               DSL.taggedChoiceType(
                  ...
                  ImmutableMap.of(
                     "minecraft:fixed",
                     a("biome", $$0.getType(blp.N)),
                     "minecraft:multi_noise",
                     DSL.list(a("biome", $$0.getType(blp.N))),
                     "minecraft:checkerboard",
                     a("biomes", DSL.list($$0.getType(blp.N))),
               ...
               "settings",
               DSL.or(DSL.string(), a("default_block", $$0.getType(blp.F), "default_fluid", $$0.getType(blp.F)))
            )
         )
      );
      CompoundListType<String, ?> $$2 = DSL.compoundList(bnm.a(), a("generator", $$1));
      Type<?> $$3 = DSL.and($$2, DSL.remainderType());
      Type<?> $$4 = $$0.getType(blp.P);
   ...
   protected static Type<? extends Pair<? extends Either<? extends Pair<? extends Either<?, Unit>, ? extends Pair<? extends Either<? extends List<? extends Pair<? extends Either<?, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>>, Unit>, Dynamic<?>>> a(
      ...
      return b("settings", a("biome", $$0.getType(blp.N), "layers", DSL.list(b("block", $$0.getType(blp.F)))));
   }

   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      long $$1 = $$0.get("seed").asLong(0L);
      return new Dynamic($$0.getOps(), bnf.a($$0, $$1, bnf.a($$0, $$1), false));
   }
}
