...
public class aor {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xo.c("commands.help.failed"));

   public static void a(CommandDispatcher<ek> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)el.b("help").executes($$1 -> {
               Map<CommandNode<ek>, String> $$2 = $$0.getSmartUsage($$0.getRoot(), (ek)$$1.getSource());

               for (String $$3 : $$2.values()) {
                  ((ek)$$1.getSource()).a(() -> xo.b("/" + $$3), false);
               }
                     ...
                     $$1 -> {
                        ...
                        if ($$2.getContext().getNodes().isEmpty()) {
                           ...
                           for (String $$4 : $$3.values()) {
                              ((ek)$$1.getSource()).a(() -> xo.b("/" + $$2.getReader().getString() + " " + $$4), false);
                           }
