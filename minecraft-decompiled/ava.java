...
public class ava {
   ...
   public void a(auc $$0, dlz $$1) {
      if (!this.f.remove($$1.a()) && $$0.bO()) {
         $$0.g.b(new adw($$1));
      }
   }
   ...
   private static void a(avf $$0, aub $$1, egi $$2) {
      $$0.b(new aec($$2, $$1.C_(), null, null));
      dlz $$3 = $$2.f();
      ahj.a($$1, $$3);
   }

   private List<egi> a(atf $$0, dlz $$1) {
      int $$2 = bcb.d(this.i);
      List<egi> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN($$0) ? 0.01F : bcb.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
