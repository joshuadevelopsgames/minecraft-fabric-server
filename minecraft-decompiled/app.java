...
public class app {
   public static <T extends em<T>> void a(CommandDispatcher<T> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)LiteralArgumentBuilder.literal("return")
                     .requires(el.a(2)))
                  .then(RequiredArgumentBuilder.argument("value", IntegerArgumentType.integer()).executes(new app.c())))
               .then(LiteralArgumentBuilder.literal("fail").executes(new app.a())))
            .then(LiteralArgumentBuilder.literal("run").forward($$0.getRoot(), new app.b(), false))
      );
   }

   static class a<T extends em<T>> implements hl.a<T> {
   ...
   static class b<T extends em<T>> implements hm.a<T> {
   ...
   static class c<T extends em<T>> implements hl.a<T> {
      public void a(T $$0, ContextChain<T> $$1, hj $$2, hp<T> $$3) {
