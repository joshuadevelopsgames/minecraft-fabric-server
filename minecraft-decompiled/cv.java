...
public record cv(
   ...
   public static final Codec<cv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
            ...
            ka.a(mn.aK).optionalFieldOf("biomes").forGetter(cv::b),
            ka.a(mn.bj).optionalFieldOf("structures").forGetter(cv::c),
            amd.a(mn.bu).optionalFieldOf("dimension").forGetter(cv::d),
   ...
   public boolean a(aub $$0, double $$1, double $$2, double $$3) {
      if (this.b.isPresent() && !this.b.get().a($$1, $$2, $$3)) {
         ...
         jb $$4 = jb.a($$1, $$2, $$3);
         boolean $$5 = $$0.p($$4);
         if (!this.c.isPresent() || $$5 && this.c.get().a($$0.v($$4))) {
            if (!this.d.isPresent() || $$5 && $$0.b().a($$4, this.d.get()).b()) {
               if (!this.f.isPresent() || $$5 && this.f.get() == dqp.a($$0, $$4)) {
   ...
   public Optional<jp<dnx>> b() {
      return this.c;
   }

   public Optional<jp<euy>> c() {
      return this.d;
   }

   public Optional<amd<dmu>> d() {
      return this.e;
   }
   ...
   public static class a {
      ...
      private cx.c b;
      private cx.c c;
      private Optional<jp<dnx>> d;
      private Optional<jp<euy>> e;
      private Optional<amd<dmu>> f;
      ...
      public static cv.a a(jl<dnx> $$0) {
         return a().a(jp.a($$0));
      }

      public static cv.a a(amd<dmu> $$0) {
         return a().b($$0);
      }

      public static cv.a b(jl<euy> $$0) {
         return a().b(jp.a($$0));
      }
      ...
      public cv.a a(jp<dnx> $$0) {
         this.d = Optional.of($$0);
         return this;
      }

      public cv.a b(jp<euy> $$0) {
         this.e = Optional.of($$0);
         return this;
      }

      public cv.a b(amd<dmu> $$0) {
