...
public class bhh extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(blp.E, "Painting");
      OpticFinder<?> $$1 = DSL.namedChoice("Painting", $$0);
      Type<?> $$2 = this.getInputSchema().getChoiceType(blp.E, "ItemFrame");
      OpticFinder<?> $$3 = DSL.namedChoice("ItemFrame", $$2);
      Type<?> $$4 = this.getInputSchema().getType(blp.E);
