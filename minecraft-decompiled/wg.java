...
public class wg extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vi> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, ur.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vi> $$0, Codec<T> $$1, ur $$2) {
      vi $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> wg a(DynamicOps<vi> $$0, Codec<T> $$1, T $$2) {
      vi $$3 = (vi)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = bbw.a(this.p());
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zn<? super wg, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zo<? super wg, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zn<? super wg, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zn<? super wg, K> $$1, zn<? super wg, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zn<? super wg, K> $$0, zn<? super wg, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zo<? super wg, K> $$1, zo<? super wg, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zo<? super wg, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zn<? super wg, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   public <L, R> void a(Either<L, R> $$0, zo<? super wg, L> $$1, zo<? super wg, R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.encode(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(zn<? super wg, L> $$0, zn<? super wg, R> $$1) {
      return this.readBoolean() ? Either.left($$0.decode(this)) : Either.right($$1.decode(this));
   }

   @Nullable
   public <T> T c(zn<? super wg, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zn<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zo<? super wg, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zo<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static jb c(ByteBuf $$0) {
      return jb.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, jb $$1) {
      $$0.writeLong($$1.a());
   }

   public dlz f() {
      return new dlz(this.readLong());
   }
   ...
   public static dlz d(ByteBuf $$0) {
      return new dlz($$0.readLong());
   }

   public static void a(ByteBuf $$0, dlz $$1) {
      $$0.writeLong($$1.a());
   }

   public ke g() {
      return ke.a(this.readLong());
   }
   ...
   public static fis g(ByteBuf $$0) {
      return new fis($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, fis $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public <T> wg a(ToIntFunction<T> $$0, T $$1) {
   ...
   public wg a(@Nullable vi $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vi $$1) {
      if ($$1 == null) {
         $$1 = uk.b;
      }

      try {
         uv.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static ui i(ByteBuf $$0) {
      vi $$1 = a($$0, ur.a(2097152L));
      if ($$1 != null && !($$1 instanceof ui)) {
   ...
   @Nullable
   public static vi a(ByteBuf $$0, ur $$1) {
      try {
         vi $$2 = uv.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public wg a(String $$0, int $$1) {
      xe.a(this.d, $$0, $$1);
      return this;
   }

   public ame q() {
      return ame.a(this.d(32767));
   }
   ...
   public <T> amd<T> a(amd<? extends jy<T>> $$0) {
      ame $$1 = this.q();
      return amd.a($$0, $$1);
   }
   ...
   public void a(fio $$0) {
      ...
      this.a($$0.c());
      fis $$2 = $$0.g();
      this.a((float)($$2.d - $$1.u()));
      this.a((float)($$2.e - $$1.v()));
      this.a((float)($$2.f - $$1.w()));
      this.a($$0.e());
      this.a($$0.f());
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, bcb.e($$1, 8)));
      }
   }
   ...
   public wg a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wg a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public wg a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wg a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wg a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wg a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public wg a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public wg b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public wg c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public wg d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public wg e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public wg f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public wg g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public wg h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public wg a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public wg b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public wg i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public wg a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public wg a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public wg b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wg b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public wg b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wg b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public wg b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public wg b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public wg k(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wg c(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public wg a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wg a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public wg a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public wg a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public wg a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public wg l(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public wg d(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public wg b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public wg b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public wg b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
