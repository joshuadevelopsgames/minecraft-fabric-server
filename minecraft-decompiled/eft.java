...
public class eft {
   ...
   private double j;
   int k = 29999984;
   private eft.a l = new eft.e(5.999997E7F);
   public static final eft.d d = new eft.d(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(dlz $$0) {
      return this.a($$0.d(), $$0.e()) && this.a($$0.f(), $$0.g());
   }
   ...
   public jb b(double $$0, double $$1, double $$2) {
      return jb.a((jv)this.c($$0, $$1, $$2));
   }
   ...
   public fis c(double $$0, double $$1, double $$2) {
      return new fis(bcb.a($$0, this.e(), this.g() - 1.0E-5F), $$1, bcb.a($$2, this.f(), this.h() - 1.0E-5F));
   }

   public double a(bzm $$0) {
      return this.b($$0.dC(), $$0.dI());
   }
   ...
   public List<eft.b> c(double $$0, double $$1) {
      eft.b[] $$2 = new eft.b[]{
         new eft.b(jh.c, $$1 - this.f()), new eft.b(jh.d, this.h() - $$1), new eft.b(jh.e, $$0 - this.e()), new eft.b(jh.f, this.g() - $$0)
      };
      return Arrays.stream($$2).sorted(Comparator.comparingDouble($$0x -> $$0x.b)).toList();
   }

   public boolean a(bzm $$0, fin $$1) {
      double $$2 = Math.max(bcb.a($$1.b(), $$1.d()), 1.0);
      return this.a($$0) < $$2 * 2.0 && this.a($$0.dC(), $$0.dI(), $$2);
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (eft.a)($$0 == $$1 ? new eft.e($$1) : new eft.c($$0, $$1, $$2));
   ...
   public record b(jh a, double b) {
   }

   class c implements eft.a {
      ...
      @Override
      public double a() {
         return bcb.a(eft.this.a() - this.e() / 2.0, (double)(-eft.this.k), (double)eft.this.k);
      }

      @Override
      public double c() {
         return bcb.a(eft.this.b() - this.e() / 2.0, (double)(-eft.this.k), (double)eft.this.k);
      }
      ...
      @Override
      public double e() {
         double $$0 = (ag.c() - this.e) / this.f;
         return $$0 < 1.0 ? bcb.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public efs i() {
         return this.c < this.b ? efs.b : efs.a;
      }
      ...
      @Override
      public eft.a l() {
         return (eft.a)(this.g() <= 0L ? eft.this.new e(this.c) : this);
      }
      ...
      public fjm m() {
         return fjj.a(
            fjj.c,
            fjj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fiw.e
         );
      }
   }
   ...
   public static class d {
      ...
      public static eft.d a(DynamicLike<?> $$0, eft.d $$1) {
         double $$2 = bcb.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = bcb.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new eft.d($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class e implements eft.a {
      ...
      private void n() {
         this.c = bcb.a(eft.this.a() - this.b / 2.0, (double)(-eft.this.k), (double)eft.this.k);
         this.d = bcb.a(eft.this.b() - this.b / 2.0, (double)(-eft.this.k), (double)eft.this.k);
         this.e = bcb.a(eft.this.a() + this.b / 2.0, (double)(-eft.this.k), (double)eft.this.k);
         this.f = bcb.a(eft.this.b() + this.b / 2.0, (double)(-eft.this.k), (double)eft.this.k);
         this.g = fjj.a(
            fjj.c,
            fjj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fiw.e
