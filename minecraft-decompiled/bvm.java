...
public class bvm implements bvf {
   ...
   public static Set<bvd> a() {
      Builder<bvd> $$0 = ImmutableSet.builder();

      try {
         bvm.a $$1 = new bvm.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bvd.a("cpu#" + $$1x, bvc.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bvd.a("heap MiB", bvc.e, () -> ae.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bve.a.a());
      return $$0.build();
   }
   ...
   public static bvd a(final LongSupplier $$0) {
      ...
      bvd.d $$3 = new bvd.d(2.0F);
      return bvd.a("ticktime", bvc.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
