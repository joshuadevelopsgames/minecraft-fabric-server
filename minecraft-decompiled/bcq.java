...
public interface bcq {
   ...
   boolean validate(bcp var1, byte[] var2);

   default boolean a(byte[] $$0, byte[] $$1) {
      return this.validate($$1x -> $$1x.update($$0), $$1);
   }

   private static boolean a(bcp $$0, byte[] $$1, Signature $$2) throws SignatureException {
      $$0.update($$2::update);
      return $$2.verify($$1);
   }

   static bcq a(PublicKey $$0, String $$1) {
      return ($$2, $$3) -> {
         try {
   ...
   @Nullable
   static bcq a(ServicesKeySet $$0, ServicesKeyType $$1) {
