...
public class bro extends bnm {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return brq.a(new Dynamic($$0, $$1), brn.a, bro.c);
      }
   };

   public bro(int $$0, Schema $$1) {
      super($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:arrow", $$1x -> DSL.optionalFields("inTile", blp.F.in($$0)));
      a($$0, $$1, "minecraft:bat");
      a($$0, $$1, "minecraft:blaze");
      $$0.registerSimple($$1, "minecraft:boat");
      a($$0, $$1, "minecraft:cave_spider");
      $$0.register($$1, "minecraft:chest_minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "Items", DSL.list(blp.u.in($$0))));
      a($$0, $$1, "minecraft:chicken");
      $$0.register($$1, "minecraft:commandblock_minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "LastOutput", blp.A.in($$0)));
      a($$0, $$1, "minecraft:cow");
      ...
      $$0.register($$1, "minecraft:enderman", $$1x -> DSL.optionalFields("carried", blp.F.in($$0)));
      a($$0, $$1, "minecraft:endermite");
      b($$0, $$1, "minecraft:ender_pearl");
      $$0.registerSimple($$1, "minecraft:eye_of_ender_signal");
      $$0.register($$1, "minecraft:falling_block", $$1x -> DSL.optionalFields("Block", blp.F.in($$0), "TileEntityData", blp.t.in($$0)));
      b($$0, $$1, "minecraft:fireball");
      $$0.register($$1, "minecraft:fireworks_rocket", $$1x -> DSL.optionalFields("FireworksItem", blp.u.in($$0)));
      $$0.register($$1, "minecraft:furnace_minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0)));
      a($$0, $$1, "minecraft:ghast");
      a($$0, $$1, "minecraft:giant");
      a($$0, $$1, "minecraft:guardian");
      $$0.register($$1, "minecraft:hopper_minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0), "Items", DSL.list(blp.u.in($$0))));
      ...
      $$0.register($$1, "minecraft:minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0)));
      ...
      $$0.register($$1, "minecraft:potion", $$1x -> DSL.optionalFields("Potion", blp.u.in($$0), "inTile", blp.F.in($$0)));
      ...
      $$0.register($$1, "minecraft:spawner_minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0), blp.I.in($$0)));
      $$0.register($$1, "minecraft:spectral_arrow", $$1x -> DSL.optionalFields("inTile", blp.F.in($$0)));
      a($$0, $$1, "minecraft:spider");
      a($$0, $$1, "minecraft:squid");
      a($$0, $$1, "minecraft:stray");
      $$0.registerSimple($$1, "minecraft:tnt");
      $$0.register($$1, "minecraft:tnt_minecart", $$1x -> DSL.optionalFields("DisplayTile", blp.F.in($$0)));
      $$0.register(
         $$1,
         "minecraft:villager",
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(
         true, blp.E, () -> DSL.and(blp.B.in($$0), DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", a(), $$1)))
      );
      $$0.registerType(true, blp.u, () -> DSL.hook(DSL.optionalFields("id", blp.G.in($$0), "tag", brq.b($$0)), b, HookFunction.IDENTITY));
   }
}
