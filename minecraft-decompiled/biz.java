...
public class biz extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(blp.G.typeName(), bnm.a()));
      Type<Pair<String, String>> $$1 = DSL.named(blp.G.typeName(), bnm.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(blp.u),
         this.getOutputSchema().getType(blp.u),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(blp.G.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
