      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)bdg.a),
               String.format(Locale.ROOT, "%.2f", this.d.aP().g() / (float)bdg.c)
            );
            ...
            $$4.a("Random tick rate", () -> this.d.aZ().o().b(dmq.p).toString());
            $$4.a("Level stats", () -> Streams.stream(this.d.L()).map($$0x -> $$0x.aj().a() + ": " + $$0x.H()).collect(Collectors.joining(",\n")));
            amg.a("Crash report:\n" + $$3.a(z.a));
