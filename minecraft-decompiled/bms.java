...
public class bms extends DataFix {
   private static final Logger a = LogUtils.getLogger();
   private static final int b = 4096;
   private static final short c = 12;

   public bms(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getOutputSchema().getType(blp.d);
      ...
      if (!($$1.findFieldType("TileEntities") instanceof ListType<?> $$3)) {
         ...
         Type<?> $$5 = this.getInputSchema().getType(blp.d);
         ...
         if (!($$8 instanceof ListType)) {
            ...
            return TypeRewriteRule.seq(
               new beb(this.getOutputSchema(), "AddTrappedChestFix", blp.t).makeRule(),
               this.fixTypeEverywhereTyped("Trapped Chest fix", $$5, $$4x -> $$4x.updateTyped($$6, $$3xx -> {
                  ...
                  if ($$4xx.isEmpty()) {
                     ...
                     for (Typed<?> $$7x : $$5x) {
                        bms.a $$8x = new bms.a($$7x, this.getInputSchema());
                        if (!$$8x.b()) {
                     ...
                     TaggedChoiceType<String> $$14 = this.getInputSchema().findChoiceType(blp.t);
                     return $$3xx.updateTyped($$4, $$4xxx -> $$4xxx.updateTyped($$14.finder(), $$4xxxx -> {
                        ...
                        return $$6x.contains(bjs.a($$6xx, $$7xx, $$8xx)) ? $$4xxxx.update($$14.finder(), $$0xxxxx -> $$0xxxxx.mapFirst($$0xxxxxx -> {
