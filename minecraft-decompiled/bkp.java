...
public class bkp extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      TaggedChoiceType<?> $$2 = this.getInputSchema().findChoiceType(blp.t);
      ...
      OpticFinder<Pair<String, String>> $$7 = DSL.typeFinder(this.getInputSchema().getType(blp.A));
      ...
      return $$0.updateTyped(
         ...
         $$2x -> {
            boolean $$3x = $$2x.getOptionalTyped($$2)
               ...
               .isPresent();
            return $$3x
               ? $$2x.updateTyped($$2, $$1xx -> $$1xx.set($$3, Pair.of(blp.A.typeName(), bdu.b("block.minecraft.ominous_banner"))))
