...
public class bjx extends DataFix {
   ...
   public bjx(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("LevelFlatGeneratorInfoFix", this.getInputSchema().getType(blp.a), $$0 -> $$0.update(DSL.remainderFinder(), this::a));
   }
      ...
      if ($$0.isEmpty()) {
         ...
         if ($$3 >= 0 && $$3 <= 3) {
            ...
            $$7.append(StreamSupport.<String>stream(d.split($$4).spliterator(), false).map($$2x -> {
               ...
               String $$10 = $$8x.get($$9);
               int $$11 = $$3 == 3 ? bgr.a("minecraft:" + $$10) : NumberUtils.toInt($$10, 0);
               int $$12 = $$9 + 1;
               int $$13 = $$8x.size() > $$12 ? NumberUtils.toInt($$8x.get($$12), 0) : 0;
               return ($$4x == 1 ? "" : $$4x + "*") + bfh.b($$11 << 4 | $$13).get("Name").asString("");
