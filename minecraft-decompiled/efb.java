...
public final class efb extends efe<Integer> {
   private final IntImmutableList a;
   private final int b;
   private final int c;

   private efb(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof efb $$1 && super.equals($$0) ? this.a.equals($$1.a) : false;
      }
   }
   ...
   public static efb a(String $$0, int $$1, int $$2) {
      return new efb($$0, $$1, $$2);
   }
