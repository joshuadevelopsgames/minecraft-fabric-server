...
public class xd {
   public static <T extends ws> xd.b a(wu<T> $$0) {
      return a(new wq<T>($$0));
   }

   private static xd.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends ws> xd.d b(wu<T> $$0) {
      return a(new wr<T>($$0));
   }

   private static xd.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof zw)) {
            $$0.fireChannelRead($$1);
         } else {
