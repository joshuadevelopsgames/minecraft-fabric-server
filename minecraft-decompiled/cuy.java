...
public class cuy<T> {
   ...
   public boolean a(List<? extends cuy.a<T>> $$0, int $$1, @Nullable cuy.b<T> $$2) {
      return new cuy.c($$0).a($$1, $$2);
   }

   public int b(List<? extends cuy.a<T>> $$0, int $$1, @Nullable cuy.b<T> $$2) {
      return new cuy.c($$0).b($$1, $$2);
   }
   ...
   List<T> a(Iterable<? extends cuy.a<T>> $$0) {
   ...
   private static <T> boolean a(Iterable<? extends cuy.a<T>> $$0, T $$1) {
      for (cuy.a<T> $$2 : $$0) {
         if ($$2.acceptsItem($$1)) {
            return true;
         }
   ...
   @VisibleForTesting
   public int a(List<? extends cuy.a<T>> $$0) {
   ...
   class c {
      private final List<? extends cuy.a<T>> c;
      private final int d;
      ...
      public c(final List<? extends cuy.a<T>> $$0) {
         this.c = $$0;
         this.d = $$0.size();
         this.e = cuy.this.a($$0);
         this.f = this.e.size();
      ...
      private void a() {
         for (int $$0 = 0; $$0 < this.d; $$0++) {
            cuy.a<T> $$1 = (cuy.a<T>)this.c.get($$0);
      ...
      public boolean a(int $$0, @Nullable cuy.b<T> $$1) {
         if ($$0 <= 0) {
            return true;
         } else {
            int $$2 = 0;
      ...
      public int b(int $$0, @Nullable cuy.b<T> $$1) {
         int $$2 = 0;
         int $$3 = Math.min($$0, cuy.this.a(this.c)) + 1;
