...
import net.minecraft.entity.passive.StriderEntity.GoBackToLavaGoal;
import net.minecraft.entity.passive.StriderEntity.Navigation;
...
public class StriderEntity extends AnimalEntity implements ItemSteerable {
   ...
   private static final EntityAttributeModifier SUFFOCATING_MODIFIER = new EntityAttributeModifier(
      SUFFOCATING_MODIFIER_ID, -0.34F, Operation.ADD_MULTIPLIED_BASE
   );
   ...
   public static net.minecraft.entity.attribute.DefaultAttributeContainer.Builder createStriderAttributes() {
   ...
   public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
      if (this.isBaby()) {
         ...
         if (random.nextInt(30) == 0) {
            ...
            if (mobEntity != null) {
               entityData = this.initializeRider(world, difficulty, mobEntity, new ZombieData(ZombieEntity.shouldBeBaby(random), false));
