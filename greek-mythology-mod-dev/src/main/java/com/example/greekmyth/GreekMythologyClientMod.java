...
// import com.example.greekmyth.client.render.MerchantPiglinRenderer; // DISABLED FOR 1.21.9
...
public class GreekMythologyClientMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // DISABLED FOR 1.21.9: EntityRendererRegistry.register(GreekEntityTypes.MERCHANT_PIGLIN, MerchantPiglinRenderer::new);
