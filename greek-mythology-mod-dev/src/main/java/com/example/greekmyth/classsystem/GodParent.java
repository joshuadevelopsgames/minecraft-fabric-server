...
/**
 * Represents the Olympian gods who can claim demigods as their children.
...
public enum GodParent {
    ...
    GodParent(String displayName, String title, String domains, boolean isBigThree, String symbol) {
